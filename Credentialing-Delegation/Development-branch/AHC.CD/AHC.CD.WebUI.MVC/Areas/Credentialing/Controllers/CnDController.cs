    ...
    public class CnDController : Controller
    {
        ...
        public async Task<ActionResult> Application(int id)
        {
            try
            {
                ...
                var CredentilingInfo = JsonConvert.SerializeObject(await applicationManager.GetCredentialingInfoByIdAsync(id),
                        new JsonSerializerSettings
                        {
                            DateTimeZoneHandling = DateTimeZoneHandling.Local
                        });
                ViewBag.CredentialingInfo = CredentilingInfo;
        ...
        public async Task<string> SaveWelcomeLetter(int profileid, int credLogId, string name, DateTime initialdate, string servicecommencedate)
        {
            ...
            try
            {
                ...
                data = await pdfManager.GenerateWelcomeLetterPDF(welcomeLetter, "WelcomeLetter", profileid.ToString(), credLogId);
