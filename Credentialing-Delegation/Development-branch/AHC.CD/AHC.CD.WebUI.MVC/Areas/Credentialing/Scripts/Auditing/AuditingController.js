...
//----------------------- ng app -------------------------
var initCredApp = angular.module('InitCredApp', ['mgcrea.ngStrap', "wysiwyg.module", 'colorpicker.module', 'ngTable']);
...
initCredApp.controller('singleProviderCtrl', ['$scope', '$http', '$timeout', '$filter', 'ngTableParams', 'messageAlertEngine', function ($scope, $http, $timeout, $filter, ngTableParams, messageAlertEngine) {
    ...
    $scope.AddOrSaveEmail = function (Form_Id, ProfileId) {
        ...
        for (var j in emailids) {
            if (emailids[j] != "") {
                if (regx1.test(emailids[j].toLowerCase())) {
                    $scope.errmsgforTo = false;
                }
        ...
        if ($("#" + Form_Id).valid() && checkVariable) {
            //if ($("#" + Form_Id).valid()) {
    ...
    $scope.pdfTemplateList = [
        ...
        {
            Name: "TRICARE_PRIME_CREDENTIALING_APPLICATION",
        ...
        },
        {
         ...
         {
             Name: "CLINICAL PSYCHOLOGIST PROVIDER APPLICATION",
             FileName: "Clinical_Psychologist_North_Provider_Application",
             IsCkecked: false,
             IsLoading: false
         },
         {
             Name: "CLINICAL SOCIAL WORKER PROVIDER APPLICATION",
             FileName: "Clinical_Social_Worker_North_Provider_Application",
             IsCkecked: false,
             IsLoading: false
         },
         {
             Name: "PHYSICIAN AND DENTIST PROVIDER APPLICATION",
             FileName: "Physician_and_Dentist_North_Provider_Application",
             IsCkecked: false,
             IsLoading: false
         },
         {
             Name: "PHYSICIAN ASSISTANT PROVIDER APPLICATION",
             FileName: "Physician_Assistant_North_Provider_Application",
             IsCkecked: false,
             IsLoading: false
         },
         {
             Name: "RN LPN NP PROVIDER APPLICATION",
             FileName: "RN_LPN_NP_North_Provider_Application",
             IsCkecked: false,
             IsLoading: false
         },
         {
         ...
         },
         {
             ...
             FileName: "Practice Questionnaire",
             IsCkecked: false,
             IsLoading: false
         }
    ];
