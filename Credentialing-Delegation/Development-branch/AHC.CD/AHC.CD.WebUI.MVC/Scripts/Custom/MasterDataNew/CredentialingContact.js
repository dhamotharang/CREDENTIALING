                ...
                success: function (data) {
                    try {
                        if (data.status == 'true') {
                            ...
                            var credIndex=$scope.CredentialingContacts.findIndex(id => id.MasterEmployeeID == data.credentialingContact.MasterEmployeeID);

                            $scope.CredentialingContacts[credIndex] = data.credentialingContact;
