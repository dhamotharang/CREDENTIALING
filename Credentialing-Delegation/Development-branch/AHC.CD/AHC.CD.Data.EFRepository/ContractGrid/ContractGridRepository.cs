    ...
    internal class ContractGridRepository : IContractGridRepository
    {
        ...
        public List<Entities.Credentialing.DTO.ContractGridDTO> GetAllContractGridInfoes(int profileid)
        {
            try
            {
                ...
                var result = contractrepo.GetAll(IncludeProperties).Where<Entities.Credentialing.LoadingInformation.ContractGrid>(a => a.CredentialingInfo.ProfileID == profileid).ToList();
