...
namespace AHC.CD.Business
{
    public interface IProfileManager
    {
        ...
        Task<List<ProfileDocument>> GetAllProfileDocuments(int ProfileId);
        ...
        Task<string> UpdateOtherDocumentAsync(int profileId, Entities.DocumentRepository.OtherDocument dataModelOtherDocument, DocumentDTO document);
