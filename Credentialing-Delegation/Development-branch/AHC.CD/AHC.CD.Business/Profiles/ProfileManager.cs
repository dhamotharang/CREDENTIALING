...
namespace AHC.CD.Business
{
    internal class ProfileManager : IProfileManager
    {
        ...
        public async Task<string> UpdateOtherDocumentAsync(int profileId, Entities.DocumentRepository.OtherDocument otherDocument, DocumentDTO document)
        {
            try
            {
        ...
        public async Task<List<ProfileDocument>> GetAllProfileDocuments(int ProfileId)
        {
            try
            {
