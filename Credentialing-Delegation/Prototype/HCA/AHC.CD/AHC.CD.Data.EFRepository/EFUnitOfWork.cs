using AHC.CD.Data.EFRepository.Profile;
...
namespace AHC.CD.Data.EFRepository
{
    ...
    public class EFUnitOfWork : IUnitOfWork
    {
        ...
        public Repository.Profile.IProfileRepository GetProfileRepository()
        {
            return new ProfileEFRepository();
        }


        public Repository.Profile.IContactDetailRepository GetContactDetailRepository()
        {
