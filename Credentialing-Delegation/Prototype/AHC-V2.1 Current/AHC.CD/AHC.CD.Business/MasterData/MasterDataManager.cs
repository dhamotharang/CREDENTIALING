...
namespace AHC.CD.Business.MasterData
{
    internal class MasterDataManager : IMasterDataManager
    {
        ...
        public async Task<IEnumerable<Entities.MasterData.Account.Staff.Employee>> GetAllBusinessContactPersonAsync()
        {
            try
            {
                //var data = await repositoryManager.GetAsync<Employee>(s => s.Status.Equals(null) && s.Departments.Any(d => d.Department.Name.Equals("Operation")));
                //var data = await repositoryManager.GetAsync<Employee>(s => s.Status.Equals(null) && s.Departments.Any(d => d.Department.Name.Equals("Operation")) && s.EmailAddress != null);
        ...
        public async Task<IEnumerable<Entities.MasterData.Account.Staff.Employee>> GetAllBillingContactAsync()
        {
            try
            {
                //var data = await repositoryManager.GetAsync<Employee>(s => s.Status.Equals(null));
                //var data = await repositoryManager.GetAsync<Employee>(s => s.Status.Equals(null) && s.Departments.Any(d => d.Department.Name.Equals("Billing")) && s.EmailAddress != null);
        ...
        public async Task<IEnumerable<Employee>> GetAllCredentialingContactAsync()
        {
              try
              {
                ...
                //var data = await repositoryManager.GetAllAsync<Employee>();
                //var data = await repositoryManager.GetAsync<Employee>(s => s.EmailAddress != null);
        ...
        public async Task<IEnumerable<PracticePaymentAndRemittance>> GetAllPaymentAndRemittance()
        {
            try
            {
                //var data = await repositoryManager.GetAsync<PracticePaymentAndRemittance>(s => s.PracticePaymentAndRemittanceID != 0, "PaymentAndRemittancePerson");
                //var data = await repositoryManager.GetAsync<PracticePaymentAndRemittance>(s => s.PaymentAndRemittancePerson.EmailAddress != null, "PaymentAndRemittancePerson");
