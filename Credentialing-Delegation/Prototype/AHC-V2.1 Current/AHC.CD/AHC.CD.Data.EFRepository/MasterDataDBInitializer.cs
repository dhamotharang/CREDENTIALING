    ...
    internal class MasterDataDBInitializer
    {
        public async Task Seed()
        {
            try
            {
                ...
                // Read the CSV file
                StreamReader reader = new StreamReader("E:\\Credentialing\\Credentialing-Delegation\\Development\\AHC.CD\\AHC.CD.WebUI.MVC\\App_Data\\MasterData\\HospitalContactInfoMaster.csv");
