...
providerApp.directive('saving', function () {
    return {
        restrict: 'E',
        replace: true,
        template: '<div class="loading"><img src="' + rootDir + '/Content/Images/ajax-loader.gif" width="20" height="20" />SAVING...</div>',
...
providerApp.directive('loading', function () {
    return {
        restrict: 'E',
        replace: true,
        template: '<div class="loading"><img src="' + rootDir + '/Content/Images/ajax-loader.gif" width="20" height="20" />LOADING...</div>',
        link: function (scope, element, attr) {
...
providerApp.controller("providerController", ['$scope','$timeout', '$http', 'locationService', function ($scope, $timeout, $http, locationService) {
    ...
    //----------------------------- Get List Of Groups --------------------------
    //$http.get(rootDir + '/Profile/MasterData/GetAllOrganizationGroupAsync').
