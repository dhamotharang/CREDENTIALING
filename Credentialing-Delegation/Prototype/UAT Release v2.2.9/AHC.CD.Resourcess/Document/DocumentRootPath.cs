...
namespace AHC.CD.Resources.Document
{
    public static class DocumentRootPath
    {
        ...
        public static readonly string PSV_DOCUMENT_PATH = @"\PSVDocuments";
        ...
        public static readonly string CCM_SIGNATURE_DOCUMENT_PATH = @"\CCMSignatureDocuments";

        #endregion

        #region Loading Document

        public static readonly string LOADING_DOCUMENT_PATH = @"\LoadingDocuments";

        #endregion

        #region CCM Attach Document

        public static readonly string CCM_ATTACH_DOCUMENT_PATH = @"\CCMAttachDocuments";
