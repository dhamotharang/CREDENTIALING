    ...
    internal class PSVManager : IPSVManager
    {
        ...
        public List<Entities.Credentialing.Loading.CredentialingInfo> GetAllPSVList()
        {
            try
            {
                ...
                var psvData = psvRepo.Get(p => p.IsDelegated.Equals(Entities.MasterData.Enums.YesNoOption.YES.ToString()), "Plan, Profile.PersonalDetail.ProviderTitles.ProviderType").ToList();
