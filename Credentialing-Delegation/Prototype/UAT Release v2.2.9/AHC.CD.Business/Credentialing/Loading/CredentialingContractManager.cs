    ...
    public class CredentialingContractManager : ICredentialingContractManager
    {
        ...
        public async Task<CredentialingContractRequest> AddCredentialingContractRequest(int credentialingInfoID, CredentialingContractRequest credentialingContractRequest, string userAuthID)
        {
            try
            {
                ...
                CredentialingContractRequest returnCredentialingContractRequest = credentialingContractRequestRepo.Find(c => c.CredentialingContractRequestID == credentialingContractRequest.CredentialingContractRequestID, "ProfileReports, BusinessEntity, ContractLOBs.LOB, ContractPracticeLocations.ProfilePracticeLocation.Facility, ContractSpecialties.ProfileSpecialty.Specialty, ContractGrid, ContractGrid.LOB, ContractGrid.ProfilePracticeLocation.Facility, ContractGrid.ProfileSpecialty.Specialty, ContractGrid.BusinessEntity, ContractGrid.CredentialingInfo");
        ...
        /// <returns></returns>
        public async Task<ContractGrid> AddContractInfoFromPlan(ContractGrid contractGrid, DocumentDTO welcomeLetter)
        {
            try
            {
                var contractGridRepo = uow.GetGenericRepository<ContractGrid>();
                ContractGrid updateContractGrid = await contractGridRepo.FindAsync(c => c.ContractGridID == contractGrid.ContractGridID, "ProfileSpecialty.Specialty, ProfilePracticeLocation.Facility, LOB, CredentialingInfo, CredentialingInfo.Plan, CredentialingInfo.Profile, BusinessEntity, Report");
        ...
        /// <param name="contractGrid"></param>
        /// <returns></returns>
        public async Task<ContractGrid> QuickSaveContractInfoFromPlan(ContractGrid contractGrid)
        {
            try
            {
                var contractGridRepo = uow.GetGenericRepository<ContractGrid>();
