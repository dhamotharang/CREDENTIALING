...
planApp.controller('planController', function ($scope, $timeout, $filter, $location, ngTableParams, $compile, $http, $window, locationService, messageAlertEngine) {
   ...
   error(function (data, status, headers, config) {
    ...
    $http.get('/MasterDataNew/GetAllInactivePlans').
  success(function (data, status, headers, config) {
      console.log("All Plans");
      console.log(data);
      $scope.InactivePlans = data;
      //$scope.data = data;
      //$scope.init_table(data);
  }).
  error(function (data, status, headers, config) {
   ...
   error(function (data, status, headers, config) {
    ...
    $scope.ProceedAdd = function (plandatacheckforplanname) {
        ...
        if (validationStatus) {
            ...
            $http.post('/Credentialing/Plan/IsPlanNameExist', { planName: plandatacheckforplanname.PlanName }).
        success(function (data, status, headers, config) {
            if (data == "False") {
                $scope.AddNewPlan = true;
                $scope.saving = false;
   ...
   error(function (data, status, headers, config) {
    ...
    $scope.SaveData = function () {
        ...
        $http.post('/Credentialing/Plan/AddPlanContracts', { planContracts: PlanContractDetails, async: false }).
    ...
    $scope.UpdatePlanContract = function () {
        ...
        $http.post('/Credentialing/Plan/UpdatePlanContracts', { PlanID:$scope.EditPlanID, planContracts: PlanContractDetails, async: false }).
