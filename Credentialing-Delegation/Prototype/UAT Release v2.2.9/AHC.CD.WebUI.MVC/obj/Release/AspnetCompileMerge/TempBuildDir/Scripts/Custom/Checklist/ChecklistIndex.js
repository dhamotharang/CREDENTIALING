...
psvModule.controller('profileAppCtrl', function ($scope, $http,$filter, messageAlertEngine) {
    ...
    $scope.getPSVHistory = function (profile) {
        ...
        $http.get('/Credentialing/Verification/GetPSVHistory?profileId=' + profileId).
    ...
    $scope.UpdateOIGProfileVerificationDetail = function () {
        ...
        if (obj.ProfileVerificationDetail != null) {
    ...
    $scope.setAllVerified = function (credentialingInfoId, verificationId) {
        ...
        $http.post('/Credentialing/Verification/SetAllVerified?credinfoId=' + credentialingInfoId + '&credVerificationId=' + verificationId, $scope.VerificationDetailsId).
        success(function (data, status, headers, config) {
            if (data.status == "true") {
...
"Jul", "Aug", "Sep", "Oct", "Nov", "Dec"
    ...
    $scope.getVerificationLinks = function () {
        ...
        $http.get('/Profile/MasterData/GetAllVerificationLinks').
      success(function (data, status, headers, config) {
