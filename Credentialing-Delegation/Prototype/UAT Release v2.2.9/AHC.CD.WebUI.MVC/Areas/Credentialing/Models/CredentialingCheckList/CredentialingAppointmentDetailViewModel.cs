...
namespace AHC.CD.WebUI.MVC.Areas.Credentialing.Models.CredentialingCheckList
{
    public class CredentialingAppointmentDetailViewModel
    {
        ...
        [PostedFileExtension(AllowedFileExtensions = "jpeg,jpg,png,bmp,PNG,JPEG,JPG,BMP,pdf,doc,xls,PDF,DOC,XLS", ErrorMessage = "Please select the file of type jpeg, .png, .jpg, .bmp, .pdf, .xls, .doc")]
