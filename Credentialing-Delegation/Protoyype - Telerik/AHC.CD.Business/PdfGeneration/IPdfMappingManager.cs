...
namespace AHC.CD.Business.PdfGeneration
{
    public interface IPdfMappingManager
    {
        ...
        Task<WelcomeLetterBusinessModel> GenerateWelcomeLetterPDF(WelcomeLetterBusinessModel welcomeletterdata, string templateName, string cduserid, int credLogId);
