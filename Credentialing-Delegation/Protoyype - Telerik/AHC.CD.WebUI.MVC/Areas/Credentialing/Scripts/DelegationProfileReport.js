          ...
          if (data.status == 'true') {
              ...
              if ($scope.delegationProfileObj.ProviderPracitceInfos != null) {
                  for (var i = 0; i < $scope.delegationProfileObj.ProviderPracitceInfos.length; i++) {
                      if ($scope.delegationProfileObj.ProviderPracitceInfos[i].OfficeHourMonday != null && $scope.delegationProfileObj.ProviderPracitceInfos[i].OfficeHourMonday.indexOf('Off') == -1) {
                      ...
                      if ($scope.delegationProfileObj.ProviderPracitceInfos[i].OfficeHourTuesday != null && $scope.delegationProfileObj.ProviderPracitceInfos[i].OfficeHourTuesday.indexOf('Off') == -1) {
                      ...
                      if ($scope.delegationProfileObj.ProviderPracitceInfos[i].OfficeHourWednesday != null && $scope.delegationProfileObj.ProviderPracitceInfos[i].OfficeHourWednesday.indexOf('Off') == -1) {
                      ...
                      if ($scope.delegationProfileObj.ProviderPracitceInfos[i].OfficeHourThursday != null && $scope.delegationProfileObj.ProviderPracitceInfos[i].OfficeHourThursday.indexOf('Off') == -1) {
                      ...
                      if ($scope.delegationProfileObj.ProviderPracitceInfos[i].OfficeHourFridayday != null && $scope.delegationProfileObj.ProviderPracitceInfos[i].OfficeHourFridayday.indexOf('Off') == -1) {
