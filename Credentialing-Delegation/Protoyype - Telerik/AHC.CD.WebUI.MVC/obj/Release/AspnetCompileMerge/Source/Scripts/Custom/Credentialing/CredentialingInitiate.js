...
credentialinginitiateapp.controller('CredentialingInitiateAppCtrl', function ($scope, $http) {
    ...
    /* services to get JSON data result
       Dev : K Ashok Kumar
    */
    $scope.obtainPlanList = [];
    $http.get(rootDir + '/Credentialing/Plans?providerID=' + $scope.credentialInit.ProviderID).success(function (recData) {
    ...
    $http.get(rootDir + '/Credentialing/ExistingPlans?providerID=' + $scope.credentialInit.ProviderID).success(function (recData) {
