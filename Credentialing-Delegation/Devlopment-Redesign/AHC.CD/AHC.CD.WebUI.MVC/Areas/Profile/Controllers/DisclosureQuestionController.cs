...
namespace AHC.CD.WebUI.MVC.Areas.Profile.Controllers
{
    public class DisclosureQuestionController : Controller
    {
        ...
        public DisclosureQuestionController(IProfileManager profileManager, IErrorLogger errorLogger, IChangeNotificationManager notificationManager, IProfileUpdateManager profileUpdateManager)
        {
        ...
        [HttpPost]
        public Int64 FileUpload(object obj)
        {
            ...
            var fileStream = new FileStream(System.Web.HttpContext.Current.Server.MapPath("~/ApplicationDocuments/" + fileName), FileMode.Create, FileAccess.ReadWrite);
