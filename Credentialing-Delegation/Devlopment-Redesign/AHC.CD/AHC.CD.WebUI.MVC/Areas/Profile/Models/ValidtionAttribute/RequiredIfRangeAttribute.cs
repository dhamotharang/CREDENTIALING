...
namespace AHC.CD.WebUI.MVC.Areas.Profile.Models.ValidtionAttribute
{
    ...
    public class RequiredIfMonthGreaterThan : ValidationAttribute, IClientValidatable
    {
        ...
        {
            return string.Format(ErrorMessageString, name, StartDependentProperty, EndDependentProperty, Range);
        }

        IEnumerable<ModelClientValidationRule> IClientValidatable.GetClientValidationRules(ModelMetadata metadata, ControllerContext context)
        {
            var model = new ModelClientValidationRule { ValidationType = "requiredifmonthgreaterthan", ErrorMessage = this.FormatErrorMessage(metadata.DisplayName) };
