//Temp data
var data1 = [
        { Title: "MD", FirstName: "Pariksith", LastName: "Singh", City: "Spring Hill", County: "Hernando", State: "Florida", ProviderType: "Physicians", ProviderRelation: "Employee", Group: "Access1" },
        { Title: "MD.", FirstName: "Tiancum", LastName: "Shaw", City: "Milton", County: "Santa Rosa", State: "Florida", ProviderType: "Physicians", ProviderRelation: "Employee", Group: "PHY" },
        { Title: "Mr.", FirstName: "Jacob", LastName: "Shaw", City: "Milton", County: "Santa Rosa", State: "Florida", ProviderType: "Physicians", ProviderRelation: "Affiliate", Group: "PHY" },
        { Title: "Sir.", FirstName: "Nephi", LastName: "Shaw", City: "Milton", County: "Santa Rosa", State: "Florida", ProviderType: "Physicians", ProviderRelation: "Employee", Group: "PHY" },
        { Title: "CSE.", FirstName: "Enos", LastName: "Shaw", City: "Milton", County: "Santa Rosa", State: "Florida", ProviderType: "Physicians", ProviderRelation: "Employee", Group: "PHY" },
        { Title: "ARNP.", FirstName: "Tiancum", LastName: "Shaw", City: "Milton", County: "Santa Rosa", State: "Florida", ProviderType: "Physicians", ProviderRelation: "Affiliate", Group: "PHY" },
        { Title: "Dr.", FirstName: "Jacob", LastName: "Shaw", City: "Milton", County: "Santa Rosa", State: "Florida", ProviderType: "Dentists", ProviderRelation: "Employee", Group: "PHY" },
        { Title: "Dr.", FirstName: "Nephi", LastName: "Shaw", City: "Milton", County: "Santa Rosa", State: "Florida", ProviderType: "Physicians", ProviderRelation: "Employee", Group: "PHY" },
        { Title: "Dr.", FirstName: "Enos", LastName: "Shaw", City: "Milton", County: "Santa Rosa", State: "Florida", ProviderType: "Physicians", ProviderRelation: "Employee", Group: "PHY" },
        { Title: "Dr.", FirstName: "Tiancum", LastName: "Shaw", City: "Milton", County: "Santa Rosa", State: "Florida", ProviderType: "Physicians", ProviderRelation: "Employee", Group: "PHY" },
        { Title: "Dr.", FirstName: "Jacob", LastName: "Shaw", City: "Milton", County: "Santa Rosa", State: "Florida", ProviderType: "Physicians", ProviderRelation: "Employee", Group: "PHY" },
        { Title: "Dr.", FirstName: "Nephi", LastName: "Shaw", City: "Milton", County: "Santa Rosa", State: "Florida", ProviderType: "Physicians", ProviderRelation: "Affiliate", Group: "PHY" },
        { Title: "Dr.", FirstName: "Enos", LastName: "Shaw", City: "Milton", County: "Santa Rosa", State: "Florida", ProviderType: "Physicians", ProviderRelation: "Employee", Group: "PHY" },
        { Title: "Dr.", FirstName: "Tiancum", LastName: "Shaw", City: "Milton", County: "Santa Rosa", State: "Florida", ProviderType: "Dentists", ProviderRelation: "Employee", Group: "PHY" },
        { Title: "Dr.", FirstName: "Jacob", LastName: "Shaw", City: "Milton", County: "Santa Rosa", State: "Florida", ProviderType: "Physicians", ProviderRelation: "Employee", Group: "PHY" },
        { Title: "Dr.", FirstName: "Nephi", LastName: "Shaw", City: "Milton", County: "Santa Rosa", State: "Florida", ProviderType: "Physicians", ProviderRelation: "Employee", Group: "PHY" },
        { Title: "Dr.", FirstName: "Enos", LastName: "Shaw", City: "Milton", County: "Santa Rosa", State: "Florida", ProviderType: "Physicians", ProviderRelation: "Employee", Group: "PHY" }
];
...
providerapp.controller('ProviderCtrl', function ($scope, $http, $location, $filter, ngTableParams) {
    ...
    $scope.new_search = function () {
        ...
        $http({
            method: "POST",
            url: rootDir + "/Provider/SearchProviderJson",
            data: { CategoryID: $scope.CategoryID, ProviderStatus: $scope.ProviderStatus }
            ...
            try {
                if (resultData.length != 0) {
                    ...
                    $scope.data = data1;
                    $scope.init_table(data1);
                }
                else {
                    $scope.progressbar = false;
                    $scope.error_message = "No Record Available for the Selected Filters";
                }
            } catch (e) {
