...
namespace AHC.CD.Business.Profiles
{
    internal class PracticeLocationManager : IPracticeLocationManager
    {
        ...
        public async Task RemovePracticeLocationAsync(int profileId, PracticeLocationDetail practiceLocationDetail)
        {
            try
            {
                //Save record into History
                PracticeLocationRepository.AddPracticeLocationHistory(profileId, practiceLocationDetail.PracticeLocationDetailID);
        ...
        public async Task UpdateOpenPracticeStatusAsync(int practiceLocationDetailId, Entities.MasterProfile.PracticeLocation.OpenPracticeStatus openPracticeStatus)
        {
            try
            {
                ...
                if (PracticeLocationDetail!=null)
                {
                    ...
                    {
                        PracticeLocationDetail.OpenPracticeStatus = AutoMapper.Mapper.Map<OpenPracticeStatus, OpenPracticeStatus>(PracticeLocationDetail.OpenPracticeStatus, openPracticeStatus);
