    ...
    internal class MasterDataDBInitializer
    {
        public async Task Seed()
        {
            try
            {
                ...
                {
                    new DEASchedule() { ScheduleTitle = "Schedule I", ScheduleTypeTitle = "Narcotic", StatusType = StatusType.Active },
                ...
                // Read the CSV file
                StreamReader reader = new StreamReader("E:\\AHC-CD\\Credentialing-Delegation\\Development\\AHC.CD\\AHC.CD.WebUI.MVC\\App_Data\\MasterData\\HospitalContactInfoMaster.csv");
