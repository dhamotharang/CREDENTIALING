...
profileApp.controller('LiabilityCtrl', ['$scope', '$rootScope', '$http', 'masterDataService', 'messageAlertEngine', function ($scope, $rootScope, $http, masterDataService, messageAlertEngine) {
    ...
    $scope.addIntoInsuranceDropDown = function (inscurance, div) {        
        $scope.tempObject.InsuranceCarrier.InsuranceCarrierID = inscurance.InsuranceCarrierID;
        $scope.tempObject.InsuranceCarrier.Name = inscurance.Name;
        $scope.tempObject.InsuranceCarrierAddressID = "";
        $scope.Location = $scope.masterInsuranceCarriers.filter(function (masterInsuranceCarriers) { return masterInsuranceCarriers.InsuranceCarrierID == $scope.tempObject.InsuranceCarrier.InsuranceCarrierID })[0];
        $("#" + div).hide();
    }

    $scope.addIntoAddressDropDown = function (insuranceCarrierAddress, div) {
        
        $scope.tempObject.InsuranceCarrierAddress.LocationName = angular.copy(insuranceCarrierAddress.LocationName);
        $scope.tempObject.InsuranceCarrierAddress.InsuranceCarrierAddressID = insuranceCarrierAddress.InsuranceCarrierAddressID;
        $scope.LocationAddress = $scope.Location.InsuranceCarrierAddresses.filter(function (Location) { return Location.InsuranceCarrierAddressID == $scope.tempObject.InsuranceCarrierAddress.InsuranceCarrierAddressID })[0];
        //console.log("getting data");
        //console.log($scope.LocationAddress);
        $scope.tempObject.InsuranceCarrierAddress = $scope.LocationAddress;
    ...
    $scope.clear = function () {
        if (typeof $scope.tempObject.InsuranceCarrierAddress != 'undefined') {
            $scope.tempObject.InsuranceCarrier.InsuranceCarrierID = "";
            $scope.tempObject.InsuranceCarrierAddress.LocationName = "";
            $scope.tempObject.InsuranceCarrierAddress.InsuranceCarrierAddressID = "";
            $scope.tempObject.InsuranceCarrierAddress = "";
        }
    }
    ...
    $scope.clear1 = function () {
        if (typeof $scope.tempObject.InsuranceCarrierAddress != 'undefined') {
            $scope.tempObject.InsuranceCarrierAddress.InsuranceCarrierAddressID = "";
            $scope.tempObject.InsuranceCarrierAddress.Street = "";
            $scope.tempObject.InsuranceCarrierAddress.Building = "";
            $scope.tempObject.InsuranceCarrierAddress.City = "";
            $scope.tempObject.InsuranceCarrierAddress.State = "";
            $scope.tempObject.InsuranceCarrierAddress.ZipCode = "";
            $scope.tempObject.InsuranceCarrierAddress.Country = "";
            $scope.tempObject.InsuranceCarrierAddress.County = "";
        }
    }
