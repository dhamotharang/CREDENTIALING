...
profileApp.controller('hospitalcltr', ['$scope', '$rootScope', '$http', 'messageAlertEngine', function ($scope, $rootScope, $http, messageAlertEngine) {
    ...
    $scope.addIntoHospitalDropDown = function (hospital, div) {
        $scope.tempObject.Hospital.HospitalID = hospital.HospitalID;
        $scope.tempObject.Hospital.HospitalName = hospital.HospitalName;
        try {
            $scope.locations = angular.copy($scope.hospitals.filter(function (hospitals) { return hospitals.HospitalID == hospital.HospitalID })[0].HospitalContactInfoes);
        }
        catch (e) { }
        $("#" + div).hide();
    }
    ...
    $scope.addIntoLocationDropDown = function (location, div) {        
        $scope.tempObject.HospitalContactInfo.HospitalContactInfoID = angular.copy(location.HospitalContactInfoID);
        $scope.tempObject.HospitalContactInfo.LocationName = angular.copy(location.LocationName);        
        $scope.getAddress(location.HospitalContactInfoID);        
        $("#" + div).hide();
        
    }

    $scope.addIntoContactDropDown = function (contact, div) {
        $scope.tempObject.HospitalContactPerson.HospitalContactPersonID = contact.HospitalContactPersonID;
        $scope.tempObject.HospitalContactPerson.ContactPersonName = angular.copy(contact.ContactPersonName);
        $scope.getContactPersonDetail(contact.HospitalContactPersonID);
        $scope.ForContactHide = true;
        $("#" + div).hide();
    ...
    $scope.clear = function () {
        try{
            ...
            $scope.tempObject.HospitalContactInfo.LocationName = "";
    ...
    $scope.clear1 = function () {
        try {
            ...
            $scope.tempObject.HospitalContactInfo.Email = "";
            $scope.tempObject.HospitalContactPerson.HospitalContactPersonID = "";
            $scope.tempObject.HospitalContactPerson.ContactPersonName = "";
            $scope.tempObject.HospitalContactPerson.ContactPersonPhone = "";
            $scope.tempObject.HospitalContactPerson.ContactPersonFax = "";
        }
        catch(e){}
    ...
    $scope.getAddress = function (valAddress) {
        try {
            ...
            $scope.tempObject.HospitalContactInfo = angular.copy($scope.LocationAddress);            
