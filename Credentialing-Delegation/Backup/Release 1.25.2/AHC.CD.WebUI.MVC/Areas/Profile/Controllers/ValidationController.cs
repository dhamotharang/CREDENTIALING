...
namespace AHC.CD.WebUI.MVC.Areas.Profile.Controllers
{
    public class ValidationController : Controller
    {
        ...
        public JsonResult IsCAQHNumberDoesNotExists(string CAQHNumber, string profileId = null)
        {
            return Json(ProfileDataDuplicateManager.IsCAQHNumberDoesNotExists(CAQHNumber, Convert.ToInt32(profileId)), JsonRequestBehavior.AllowGet);
        }

        public JsonResult IsNPIUsernameDoesNotExists(string NPIUserName, string profileId = null)
        {
            return Json(ProfileDataDuplicateManager.IsNPIUsernameDoesNotExists(NPIUserName, Convert.ToInt32(profileId)), JsonRequestBehavior.AllowGet);
        }

        public JsonResult IsCAQHUsernameDoesNotExists(string CAQHUserName, string profileId = null)
        {
            return Json(ProfileDataDuplicateManager.IsCAQHUsernameDoesNotExists(CAQHUserName, Convert.ToInt32(profileId)), JsonRequestBehavior.AllowGet);
        }
