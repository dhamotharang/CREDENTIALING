...
masterDataStaffCategorys.controller('masterDataStaffCategorysController', ['$scope', '$http', '$filter', '$rootScope', 'masterDataService', 'messageAlertEngine', function ($scope, $http, $filter, $rootScope, masterDataService, messageAlertEngine) {
    ...
    $http.get("/MasterDataNew/GetAllStaffCategories").then(function (value) {
        console.log("StaffCategorys");
        console.log(value);
        ...
        $scope.StaffCategorys = value.data;
        console.log($scope.StaffCategorys);
    });
    ...
    $scope.saveStaffCategorys = function (idx) {
        ...
        console.log("Saving StaffCategorys");
        
        if (addData.Title && isExist) {
            $http.post('/MasterDataNew/AddStaffCategory', addData).
    ...
    $scope.updateStaffCategorys = function (idx) {
        ...
        console.log("Updating StaffCategorys");

        if (updateData.Title && isExist) {
            $http.post('/MasterDataNew/UpdateStaffCategory', updateData).
                success(function (data, status, headers, config) {
                    //----------- success message -----------
                    if (data.status == "true") {
