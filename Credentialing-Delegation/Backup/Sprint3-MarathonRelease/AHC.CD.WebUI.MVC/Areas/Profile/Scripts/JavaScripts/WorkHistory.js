...
profileApp.controller('WorkHistoryController', ['$scope', '$rootScope', '$http', '$filter', 'countryDropDownService', 'masterDataService', 'locationService', 'messageAlertEngine', function ($scope, $rootScope, $http, $filter, countryDropDownService, masterDataService, locationService, messageAlertEngine) {
