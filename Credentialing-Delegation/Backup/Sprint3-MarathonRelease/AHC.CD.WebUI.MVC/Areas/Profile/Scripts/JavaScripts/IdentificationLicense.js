...
profileApp.controller('identificationLicenseController', ['$scope', '$rootScope', '$http', 'dynamicFormGenerateService', 'masterDataService', 'locationService', 'messageAlertEngine', function ($scope, $rootScope, $http, dynamicFormGenerateService, masterDataService, locationService, messageAlertEngine) {
