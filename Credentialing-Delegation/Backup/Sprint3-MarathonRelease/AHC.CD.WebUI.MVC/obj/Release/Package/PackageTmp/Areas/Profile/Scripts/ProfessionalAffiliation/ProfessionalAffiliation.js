...
profileApp.controller('professionalAppCtrl', function ($scope,$rootScope,$http, dynamicFormGenerateService,masterDataService) {
    ...
    //    Member: ""
    //}, {
    //    OrganizationName: "Internal Medicine for Medical Students for The International University of the Health Sciences",
    //    StartDate: new Date(2001, 01, 01),
    //    EndDate: new Date(2003, 01, 01),
    //    PositionOfficeHeld: "Mentor",
    //    Member: ""
    //}
    //];
    ...
    $scope.saveProfessionalAffiliation = function (professionalAffiliation, index) {
        ...
        if ($scope.visibilityControl == 'addpa') {
            ...
            //validationStatus = $('#professionalAffiliationEditDiv' + index).find('form').valid();
