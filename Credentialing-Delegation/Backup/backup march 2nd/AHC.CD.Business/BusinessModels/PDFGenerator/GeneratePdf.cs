...
namespace AHC.CD.Business.BusinessModels.PDFGenerator
{
    public class GeneratePdf
    {
        public string FillForm(object dataObj, string pdfName, string templateName)
        {
            ...
            string pdfTemplate = HttpContext.Current.Server.MapPath("~/ApplicationDocument/PdfTemplate/" + templateName);
            string newFile = HttpContext.Current.Request.MapPath("~/ApplicationDocument/TempGeneratedPdf/" + pdfName);            
        ...
        {
            string generatedPdfPath = HttpContext.Current.Request.MapPath("~/ApplicationDocument/GeneratedPdf/" + outputFileName);
