...
namespace AHC.CD.Resources.Messages
{
    ...
    public static class ValidationErrorMessage
    {
        ...
        public const string CHARACTERS_ONLY_ALPHABETS_SPACE_COMMA_HYPHEN_DOT = "Please enter valid {0}. Only alphabets, apostrophe, spaces, comma, hyphen and dot accepted.";
        ...
        public const string PERCENT_TWO_DECIMAL_PLACES = "Please enter valid {0}. Only numbers and two decimals accepted.";
        ...
        public const string STOP_EFFECTIVEDATE_RANGE = "Effective Date should be greater than Original Effective Date and less than {1}";
