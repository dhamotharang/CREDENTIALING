        ...
        var active = $http.get(rootDir + "/ContractGrid/GetAllActiveContractGridinfoes?profileid=" + profileId).
             success(function (data) {
                 ...
                 for (var i = 0 ; i < $scope.activeContracts.length; i++) {
                     $scope.activeContracts[i].PracticeLocation = $scope.activeContracts[i].FacilityName + "-" + $scope.activeContracts[i].FacilityStreet + "," + $scope.activeContracts[i].FacilityCity + "," + $scope.activeContracts[i].FacilityState + "," + $scope.activeContracts[i].FacilityCountry;
        ...
        var inactive = $http.get(rootDir + "/ContractGrid/GetAllInActiveContractGridinfoes?profileid=" + profileId).
                  success(function (data) {
                      ...
                      for (var i = 0 ; i < $scope.inactiveContracts.length; i++) {
                          $scope.inactiveContracts[i].PracticeLocation = $scope.inactiveContracts[i].FacilityName + "-" + $scope.inactiveContracts[i].FacilityStreet + "," + $scope.inactiveContracts[i].FacilityCity + "," + $scope.inactiveContracts[i].FacilityState + "," + $scope.inactiveContracts[i].FacilityCountry;
