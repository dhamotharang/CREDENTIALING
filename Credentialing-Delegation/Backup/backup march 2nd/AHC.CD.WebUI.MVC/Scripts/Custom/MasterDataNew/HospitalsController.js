...
masterDataHospitals.controller('masterDatamasterDataHospitalsController', ['$scope', '$http', '$filter', 'masterDataService', 'messageAlertEngine', 'locationService', function ($scope, $http, $filter, masterDataService, messageAlertEngine, locationService) {
    ...
    $http.get(rootDir + "/MasterDataNew/GetAllHospitals").then(function (value) {
        ...
        for (var i = 0; i < value.data.length ; i++) {
            if (value.data[i] != null) {
                ...
                value.data[i].HospitalContactInfoesLength = value.data[i].HospitalContactInfoes.length;
        ...
        for (var i in $scope.Hospitals) {
            if ($scope.Hospitals[i].HospitalContactInfoes != null) {
                $scope.Hospitals[i].NoofLocations = $scope.Hospitals[i].HospitalContactInfoes.length;
            }
            else {
                $scope.Hospitals[i].NoofLocations = 0;
            }
        }
    ...
    $scope.saveHospital = function () {
        ...
        if (validationStatus && exist) {
            ...
            $http.post(rootDir + '/MasterDataNew/AddHospital', addData).
                    ...
                    if (data.status == "true") {
                        ...
                        for (var i = 0; i < $scope.Hospitals.length; i++) {
                            ...
                            if ($scope.Hospitals[i].HospitalID == 0) {
                                ...
                                $scope.Hospitals[i].NoofLocations = data.hospitalDetails.HospitalContactInfoes.length;
    ...
    $scope.updateHospital = function (idx) {
        ...
        var updateHospital = {
            ...
            HospitalName: $scope.tempHospital.HospitalName,
            HospitalContactInfoes : $scope.tempHospital.HospitalContactInfoes,
            Code: $scope.tempHospital.Code,
            StatusType: 1
        }
        ...
        for (var m = 0; m<$scope.Hospitals.length; m++) {
            ...
            if ($scope.Hospitals[m].HospitalID == updateHospital.HospitalID) 
                {
                    idx = m;
                }
            ...
            if (updateHospital.HospitalName && exist) {
                $http.post(rootDir + '/MasterDataNew/UpdateHospital', updateHospital).
                    success(function (data, status, headers, config) {
                        //----------- success message -----------
                        if (data.status == "true") {
                            ...
                            $scope.Hospitals[idx].NoofLocations = updateHospital.HospitalContactInfoes.length;
                            $scope.reset();
                            $scope.error = "";
                            $scope.existErr = "";
        ...
        $scope.saveHC = function () {
            ...
            //            if ($scope.Hospitals[m].HospitalContactInfoes[n].LocationName.replace(" ", "").toLowerCase() == addData.LocationName.replace(" ", "").toLowerCase()) {
            ...
            if (id && validationStatus && exist) {
                $http.post(rootDir + '/MasterDataNew/AddHospitalContactInfo?hospitalId=' + id, addData).
                    success(function (data, status, headers, config) {
                        //----------- success message -----------
                        if (data.status == "true") {
                            ...
                            for (var i = 0; i < $scope.Hospitals.length; i++) {
                                ...
                                if ($scope.Hospitals[i].HospitalID == id) {
                                    ...
                                    $scope.Hospitals[i].NoofLocations++;
                                }
                            }
                            $scope.reset();
                            $scope.error = "";
        ...
        $scope.updateHC = function (idx) {
            ...
            if (validationStatus && exist) {
                $http.post(rootDir + '/MasterDataNew/UpdateHospitalContactInfo', updateContactInfo).
                    success(function (data, status, headers, config) {
                        //----------- success message -----------
                        if (data.status == "true") {
                            $scope.AddNewHospitalContact = false;
        ...
        $scope.saveHCP = function (idx) {
            ...
            if (addData.ContactPersonName && addData.Phone && exist) {
                $http.post(rootDir + '/MasterDataNew/AddHospitalContactPerson?hospitalId=' + id + '&contactId=' + prsnId, addData).
                    success(function (data, status, headers, config) {
                        //----------- success message -----------
                        if (data.status == "true") {
        ...
        $scope.$watch('tempHCP.ContactPersonName', function (newval, oldval) {
            if (newval === oldval) {
                return;
            }
            if (newval != "") {
        ...
        $scope.$watch('tempHCP.Phone', function (newval, oldval) {
            if (newval === oldval) {
                return;
            }
            if (newval != "") {
        ...
        $scope.updateHCP = function (idx) {
            ...
            if (updatePerson.ContactPersonName && updatePerson.Phone && exist) {
                ...
                $http.post(rootDir + '/MasterDataNew/UpdateHospitalContactPerson', updatePerson).
                    success(function (data, status, headers, config) {
                        //----------- success message -----------
                        if (data.status == "true") {
