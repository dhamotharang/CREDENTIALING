    ...
    internal class PDFProfileDataGeneratorManager : IPDFProfileDataGeneratorManager
    {
        ...
        private string ConstructProfilePrimaryData(Profile profile)
        {
            ...
            try
            {
                ...
                if (profile.PersonalDetail != null && profile.PersonalDetail.ProviderTitles.Count > 0 && profile.PersonalDetail.ProviderTitles.First().ProviderType != null)
                {
                    profileData.PersonalInfoProviderType = profile.PersonalDetail.ProviderTitles.First().ProviderType.Title;
                }
                ...
                foreach (var item in profile.PracticeLocationDetails)
                {
                    if (item != null && item.IsPrimary == AHC.CD.Entities.MasterData.Enums.YesNoOption.YES.ToString())
                    {
                        ...
                        {
                            foreach (var mid in item.PracticeProviders)
                            {
                                if (count == 0 && mid != null && mid.Practice == AHC.CD.Entities.MasterData.Enums.PracticeType.Midlevel.ToString())
                                {
                                    profileData.MidLevelPractitionerLastName1 = mid.LastName;
                                    profileData.MidLevelPractitionerFirstName1 = mid.FirstName;
                                    count = 1;
                                    continue;
                                }
                                if (count == 1 && mid != null && mid.Practice == AHC.CD.Entities.MasterData.Enums.PracticeType.Midlevel.ToString())
                                {
                                    profileData.MidLevelPractitionerLastName2 = mid.LastName;
                                    profileData.MidLevelPractitionerFirstName2 = mid.FirstName;
                                    count = 2;
                                    continue;
                                }
                                if (count == 2 && mid != null && mid.Practice == AHC.CD.Entities.MasterData.Enums.PracticeType.Midlevel.ToString())
                                {
                                    profileData.MidLevelPractitionerLastName3 = mid.LastName;
                                    profileData.MidLevelPractitionerFirstName3 = mid.FirstName;
                                    count = 3;
                                    continue;
                                }
                                if (count == 3 && mid != null && mid.Practice == AHC.CD.Entities.MasterData.Enums.PracticeType.Midlevel.ToString())
                                {
                                    profileData.MidLevelPractitionerLastName4 = mid.LastName;
                                    profileData.MidLevelPractitionerFirstName4 = mid.FirstName;
                                    count = 4;
                                    continue;
                                }
                                if (count == 4 && mid != null && mid.Practice == AHC.CD.Entities.MasterData.Enums.PracticeType.Midlevel.ToString())
                                {
                                    profileData.MidLevelPractitionerLastName5 = mid.LastName;
                                    profileData.MidLevelPractitionerFirstName5 = mid.FirstName;
                                    break;
                                }
                        ...
                        {
                            if (item.Facility.FacilityDetail.Language.NonEnglishLanguages.Count > 0)
                                profileData.NonEnglishLanguage1 = item.Facility.FacilityDetail.Language.NonEnglishLanguages.First().Language;


                            if (item.Facility.FacilityDetail.Language.NonEnglishLanguages.Count > 1)
                                profileData.NonEnglishLanguage2 = item.Facility.FacilityDetail.Language.NonEnglishLanguages.ElementAt(1).Language;

                            if (item.Facility.FacilityDetail.Language.NonEnglishLanguages.Count > 2)
                                profileData.NonEnglishLanguage3 = item.Facility.FacilityDetail.Language.NonEnglishLanguages.ElementAt(2).Language;

                            if (item.Facility.FacilityDetail.Language.NonEnglishLanguages.Count > 3)
                                profileData.NonEnglishLanguage4 = item.Facility.FacilityDetail.Language.NonEnglishLanguages.ElementAt(3).Language;

                            if (item.Facility.FacilityDetail.Language.NonEnglishLanguages.Count > 4)
                                profileData.NonEnglishLanguage5 = item.Facility.FacilityDetail.Language.NonEnglishLanguages.ElementAt(4).Language;

                            if (item.Facility.FacilityDetail.Language.NonEnglishLanguages.Count > 0 && item.Facility.FacilityDetail.Language.NonEnglishLanguages.First().InterpretersAvailableYesNoOption.Equals(YesNoOption.YES))
                                profileData.LanguagesInterpreted1 = item.Facility.FacilityDetail.Language.NonEnglishLanguages.First().Language;

                            if (item.Facility.FacilityDetail.Language.NonEnglishLanguages.Count > 1 && item.Facility.FacilityDetail.Language.NonEnglishLanguages.ElementAt(1).InterpretersAvailableYesNoOption.Equals(YesNoOption.YES))
                                profileData.LanguagesInterpreted2 = item.Facility.FacilityDetail.Language.NonEnglishLanguages.ElementAt(1).Language;

                            if (item.Facility.FacilityDetail.Language.NonEnglishLanguages.Count > 2 && item.Facility.FacilityDetail.Language.NonEnglishLanguages.ElementAt(2).InterpretersAvailableYesNoOption.Equals(YesNoOption.YES))
                                profileData.LanguagesInterpreted3 = item.Facility.FacilityDetail.Language.NonEnglishLanguages.ElementAt(2).Language;

                            if (item.Facility.FacilityDetail.Language.NonEnglishLanguages.Count > 3 && item.Facility.FacilityDetail.Language.NonEnglishLanguages.ElementAt(3).InterpretersAvailableYesNoOption.Equals(YesNoOption.YES))
                        ...
                        if (item.PracticeProviders.Count > 0)
                        {
                            ...
                            var colleagues = item.PracticeProviders.Where(p => p.Practice == AHC.CD.Entities.MasterData.Enums.PracticeType.CoveringColleague.ToString()).ToList();
                ...
                if (profile.HospitalPrivilegeInformation != null)
                {
                    ...
                    if (profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.Count > 0)
                    {
                        profileData.HospitalDepartmentName = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.First().DepartmentName;
                        profileData.HospitalDepartmentDirectorFirstName = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.First().DepartmentChief;
                        profileData.HospitalAffiliationStartDate = ConvertToDateString(profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.First().AffilicationStartDate);
                        profileData.HospitalAffiliationEndDate = ConvertToDateString(profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.First().AffiliationEndDate);
                        profileData.HospitalUnrestrictedPrivilege = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.First().FullUnrestrictedPrevilages;
                        profileData.HospitalPrivilegesTemporary = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.First().ArePrevilegesTemporary;
                        profileData.HospitalPercentageAnnualAdmission = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.First().AnnualAdmisionPercentage;

                        if (profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.First().AdmittingPrivilege != null)
                        {
                            profileData.HospitalAdmittingPrivilegeStatus = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.First().AdmittingPrivilege.Title;
                        }

                        if (profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.First().Hospital != null)
                        {
                            profileData.HospitalName = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.First().Hospital.HospitalName;

                            if (profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.First().Hospital.HospitalContactInfoes.Count > 0)
                            {
                                profileData.HospitalNumber = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.First().Hospital.HospitalContactInfoes.First().UnitNumber;
                                profileData.HospitalStreet = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.First().Hospital.HospitalContactInfoes.First().Street;
                                profileData.HospitalCity = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.First().Hospital.HospitalContactInfoes.First().City;
                                profileData.HospitalState = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.First().Hospital.HospitalContactInfoes.First().State;
                                profileData.HospitalZip = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.First().Hospital.HospitalContactInfoes.First().ZipCode;
                                profileData.HospitalTelephone = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.First().Hospital.HospitalContactInfoes.First().Phone;
                                profileData.HospitalFax = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.First().Hospital.HospitalContactInfoes.First().Fax;
                            }
                    ...
                    //Other Hospital Name
                    if (profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.Count > 1)
                    {
                        profileData.OtherHospitalDepartmentName = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(1).DepartmentName;
                        profileData.OtherHospitalDepartmentDirectorFirstName = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(1).DepartmentChief;
                        profileData.OtherHospitalAffiliationStartDate = ConvertToDateString(profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(1).AffilicationStartDate);
                        profileData.OtherHospitalAffiliationEndDate = ConvertToDateString(profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(1).AffiliationEndDate);
                        profileData.OtherHospitalUnrestrictedPrivilege = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(1).FullUnrestrictedPrevilages;
                        profileData.OtherHospitalPrivilegesTemporary = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(1).ArePrevilegesTemporary;                        
                        profileData.OtherHospitalPercentageAnnualAdmission = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(1).AnnualAdmisionPercentage;

                        if (profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(1).AdmittingPrivilege != null)
                        {
                            profileData.OtherHospitalAdmittingPrivilegeStatus = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(1).AdmittingPrivilege.Title;
                        }

                        if (profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(1).Hospital != null)
                        {
                            profileData.OtherHospitalName = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(1).Hospital.HospitalName;

                            if (profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(1).Hospital.HospitalContactInfoes.Count > 0)
                            {
                                profileData.OtherHospitalNumber = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(1).Hospital.HospitalContactInfoes.First().UnitNumber;
                                profileData.OtherHospitalStreet = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(1).Hospital.HospitalContactInfoes.First().Street;
                                profileData.OtherHospitalCity = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(1).Hospital.HospitalContactInfoes.First().City;
                                profileData.OtherHospitalState = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(1).Hospital.HospitalContactInfoes.First().State;
                                profileData.OtherHospitalZip = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(1).Hospital.HospitalContactInfoes.First().ZipCode;
                                profileData.OtherHospitalTelephone = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(1).Hospital.HospitalContactInfoes.First().Phone;
                                profileData.OtherHospitalFax = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(1).Hospital.HospitalContactInfoes.First().Fax;
                            }
                ...
                if (profile.ProfessionalReferenceInfos.Count > 0)
                {
                    ...
                    if (profile.ProfessionalReferenceInfos.Count > 0)
                    {
                        ...
                        profileData.ProfessionalReferenceFax1 = profile.ProfessionalReferenceInfos.First().Fax;
                ...
                {
                    profileData.LicensureQn1 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(0).ProviderDisclousreAnswer;
                    profileData.LicensureQn2 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(1).ProviderDisclousreAnswer;
                    profileData.HOSPITALPRIVILEGESANDOTHERAFFILIATIONSQn1 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(2).ProviderDisclousreAnswer;
                    profileData.HOSPITALPRIVILEGESANDOTHERAFFILIATIONSQn2 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(3).ProviderDisclousreAnswer;
                    profileData.HOSPITALPRIVILEGESANDOTHERAFFILIATIONSQn3 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(4).ProviderDisclousreAnswer;
                    profileData.EDUCATIONTRAININGANDBOARDCERTIFICATIONQn1 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(5).ProviderDisclousreAnswer;
                    profileData.EDUCATIONTRAININGANDBOARDCERTIFICATIONQn2 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(6).ProviderDisclousreAnswer;
                    profileData.EDUCATIONTRAININGANDBOARDCERTIFICATIONQn3 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(7).ProviderDisclousreAnswer;
                    profileData.EDUCATIONTRAININGANDBOARDCERTIFICATIONQn4 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(8).ProviderDisclousreAnswer;
                    profileData.DEAORSTATECONTROLLEDSUBSTANCEREGISTRATIONQn1 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(9).ProviderDisclousreAnswer;
                    profileData.MEDICAREMEDICAIDOROTHERGOVERNMENTALPROGRAMPARTICIPATIONQn1 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(10).ProviderDisclousreAnswer;
                    profileData.OTHERSANCTIONSORINVESTIGATIONSQn1 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(11).ProviderDisclousreAnswer;
                    profileData.OTHERSANCTIONSORINVESTIGATIONSQn2 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(12).ProviderDisclousreAnswer;
                    profileData.OTHERSANCTIONSORINVESTIGATIONSQn3 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(13).ProviderDisclousreAnswer;
                    profileData.OTHERSANCTIONSORINVESTIGATIONSQn4 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(14).ProviderDisclousreAnswer;
                    profileData.OTHERSANCTIONSORINVESTIGATIONSQn5 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(15).ProviderDisclousreAnswer;
                    profileData.PROFESSIONALLIABILITYINSURANCEINFORMATIONANDCLAIMSHISTORYQn1 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(16).ProviderDisclousreAnswer;
                    profileData.PROFESSIONALLIABILITYINSURANCEINFORMATIONANDCLAIMSHISTORYQn2 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(17).ProviderDisclousreAnswer;
                    profileData.MalpractiseClaimHistoryQn1 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(18).ProviderDisclousreAnswer;
                    profileData.CRIMINALCIVILHISTORYQn1 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(19).ProviderDisclousreAnswer;
                    profileData.CRIMINALCIVILHISTORYQn2 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(20).ProviderDisclousreAnswer;
                    profileData.CRIMINALCIVILHISTORYQn3 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(21).ProviderDisclousreAnswer;
                    profileData.ABILITYTOPERFORMJOBQn1 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(22).ProviderDisclousreAnswer;
                    profileData.ABILITYTOPERFORMJOBQn2 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(23).ProviderDisclousreAnswer;
                    profileData.ABILITYTOPERFORMJOBQn3 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(24).ProviderDisclousreAnswer;
                    profileData.ABILITYTOPERFORMJOBQn4 = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.ElementAt(25).ProviderDisclousreAnswer;
        ...
        private List<string> ConstructSpecialtyPDF(Profile profile)
        {
            ...
            try
            {
                ...
                for (int i = 2; i < profile.SpecialtyDetails.Count; i++)
                {
                    ...
                    {
                        specialty.SupplementSpecialtyCode1 = profile.SpecialtyDetails.ElementAt(i).Specialty.Name;

                        if (profile.SpecialtyDetails.ElementAt(i).SpecialtyBoardCertifiedDetail != null)
                        {
                            specialty.SupplementSpecialtyInitialCertificationDate1 = ConvertToDateString(profile.SpecialtyDetails.ElementAt(i).SpecialtyBoardCertifiedDetail.InitialCertificationDate);
                            specialty.SupplementSpecialtyReCertificationDate1 = ConvertToDateString(profile.SpecialtyDetails.ElementAt(i).SpecialtyBoardCertifiedDetail.LastReCerificationDate);
                            specialty.SupplementSpecialtyExpirationDate1 = ConvertToDateString(profile.SpecialtyDetails.ElementAt(i).SpecialtyBoardCertifiedDetail.ExpirationDate);
                            specialty.SupplementSpecialtyBoardCertified1 = profile.SpecialtyDetails.ElementAt(i).SpecialtyBoardCertifiedDetail.SpecialtyBoard.Name;
                        }

                        if (profile.SpecialtyDetails.ElementAt(i).SpecialtyBoardNotCertifiedDetail != null)
                        {
                            specialty.SupplementSpecialtyExamStatus1 = profile.SpecialtyDetails.ElementAt(i).SpecialtyBoardNotCertifiedDetail.SpecialtyBoardExamStatus.ToString();
                            specialty.SupplementSpecialtyReasonForNotTakingExam1 = profile.SpecialtyDetails.ElementAt(i).SpecialtyBoardNotCertifiedDetail.ReasonForNotTakingExam;
                        }
                        specialty.SupplementSpecialtyCertifyingBoardCode1 = profile.SpecialtyDetails.ElementAt(i).IsBoardCertified;
                        specialty.SupplementSpecialtyHMO1 = profile.SpecialtyDetails.ElementAt(i).ListedInHMO.ToString();
                        specialty.SupplementSpecialtyPPO1 = profile.SpecialtyDetails.ElementAt(i).ListedInPPO.ToString();
                        specialty.SupplementSpecialtyPOS1 = profile.SpecialtyDetails.ElementAt(i).ListedInPOS.ToString();
                    }
                    ...
                    if (profile.SpecialtyDetails.Count > i)
                    {
                        specialty.SupplementSpecialtyCode2 = profile.SpecialtyDetails.ElementAt(i).Specialty.Name;

                        if (profile.SpecialtyDetails.ElementAt(i).SpecialtyBoardCertifiedDetail != null)
                        {
                            specialty.SupplementSpecialtyInitialCertificationDate2 = ConvertToDateString(profile.SpecialtyDetails.ElementAt(i).SpecialtyBoardCertifiedDetail.InitialCertificationDate);
                            specialty.SupplementSpecialtyReCertificationDate2 = ConvertToDateString(profile.SpecialtyDetails.ElementAt(i).SpecialtyBoardCertifiedDetail.LastReCerificationDate);
                            specialty.SupplementSpecialtyExpirationDate2 = ConvertToDateString(profile.SpecialtyDetails.ElementAt(i).SpecialtyBoardCertifiedDetail.ExpirationDate);
                            specialty.SupplementSpecialtyBoardCertified2 = profile.SpecialtyDetails.ElementAt(i).SpecialtyBoardCertifiedDetail.SpecialtyBoard.Name;
                        }

                        if (profile.SpecialtyDetails.ElementAt(i).SpecialtyBoardNotCertifiedDetail != null)
                        {
                            specialty.SupplementSpecialtyExamStatus2 = profile.SpecialtyDetails.ElementAt(i).SpecialtyBoardNotCertifiedDetail.SpecialtyBoardExamStatus.ToString();
                            specialty.SupplementSpecialtyReasonForNotTakingExam2 = profile.SpecialtyDetails.ElementAt(i).SpecialtyBoardNotCertifiedDetail.ReasonForNotTakingExam;
                        }
                        specialty.SupplementSpecialtyCertifyingBoardCode2 = profile.SpecialtyDetails.ElementAt(i).IsBoardCertified;
                        specialty.SupplementSpecialtyHMO2 = profile.SpecialtyDetails.ElementAt(i).ListedInHMO.ToString();
                        specialty.SupplementSpecialtyPPO2 = profile.SpecialtyDetails.ElementAt(i).ListedInPPO.ToString();
                        specialty.SupplementSpecialtyPOS2 = profile.SpecialtyDetails.ElementAt(i).ListedInPOS.ToString();
                    }
        ...
        private List<string> ConstructHospitalPDF(Profile profile)
        {
            ...
            try
            {
                if (profile.HospitalPrivilegeInformation != null)
                {
                    for (int i = 2; i < profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.Count; i++)
                    {
                        PDFSupplementData_HospitalPrivilegeBusinessModel hospital = new PDFSupplementData_HospitalPrivilegeBusinessModel();

                        if (profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.Count > i)
                        {
                            hospital.SupplementHospitalDepartmentName = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(i).DepartmentName;
                            hospital.SupplementHospitalDepartmentDirectorFirstName = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(i).DepartmentChief;
                            hospital.SupplementHospitalAffiliationStartDate = ConvertToDateString(profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(i).AffilicationStartDate);
                            hospital.SupplementHospitalAffiliationEndDate = ConvertToDateString(profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(i).AffiliationEndDate);
                            hospital.SupplementHospitalUnrestrictedPrivilege = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(i).FullUnrestrictedPrevilages;
                            hospital.SupplementHospitalPrivilegesTemporary = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(i).ArePrevilegesTemporary;
                            
                            hospital.SupplementHospitalPercentageAnnualAdmission = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(i).AnnualAdmisionPercentage;

                            if (profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(i).AdmittingPrivilege != null)
                            {
                                hospital.SupplementHospitalAdmittingPrivilegeStatus = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(i).AdmittingPrivilege.Title;
                            }

                            if (profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(i).Hospital != null)
                            {
                                hospital.SupplementHospitalName = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(i).Hospital.HospitalName;
                                if (profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(i).Hospital.HospitalContactInfoes.Count > 0)
                                {
                                    hospital.SupplementHospitalNumber = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(i).Hospital.HospitalContactInfoes.First().UnitNumber;
                                    hospital.SupplementHospitalStreet = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(i).Hospital.HospitalContactInfoes.First().Street;
                                    hospital.SupplementHospitalCity = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(i).Hospital.HospitalContactInfoes.First().City;
                                    hospital.SupplementHospitalState = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(i).Hospital.HospitalContactInfoes.First().State;
                                    hospital.SupplementHospitalZip = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(i).Hospital.HospitalContactInfoes.First().ZipCode;
                                    hospital.SupplementHospitalTelephone = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(i).Hospital.HospitalContactInfoes.First().Phone;
                                    hospital.SupplementHospitalFax = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.ElementAt(i).Hospital.HospitalContactInfoes.First().Fax;
                                }
        ...
        private List<string> ConstructPrimaryCoveringColleaguePDF(Profile profile)
        {
            ...
            try
            {
                ...
                {
                    var coveringColleagues1 = primaryPracticeLocation.PracticeProviders.Where(p => p.Practice == AHC.CD.Entities.MasterData.Enums.PracticeType.CoveringColleague.ToString()).ToList();
        ...
        private List<string> ConstructSecondaryCoveringColleaguePDF(Profile profile)
        {
            ...
            try
            {
                ...
                {
                    var coveringColleagues1 = secondaryPracticeLocation.PracticeProviders.Where(p => p.Practice == AHC.CD.Entities.MasterData.Enums.PracticeType.CoveringColleague.ToString()).ToList();
        ...
        private List<string> ConstructDisclosurePDF(Profile profile)
        {
            ...
            try
            {
                ...
                {
                    var answerYes = profile.ProfileDisclosure.ProfileDisclosureQuestionAnswers.Where(q => q.ProviderDisclousreAnswer == AHC.CD.Entities.MasterData.Enums.YesNoOption.YES.ToString()).ToList();
                    ...
                    for (int i = 0; i < answerYes.Count; i++)
                    {
                        ...
                        {
                            question.QuestionCode1 = answerYes.ElementAt(i).QuestionID;
                        ...
                        if (answerYes.Count > i)
                        {
                            question.QuestionCode2 = answerYes.ElementAt(i).QuestionID;
                        ...
                        if (answerYes.Count > i)
                        {
                            question.QuestionCode3 = answerYes.ElementAt(i).QuestionID;
            ...
            try
            {
                ...
                for (int i = 0; i < praticeInfo.Count; i++)
                {
                    if (praticeInfo.Count > i)
                    {
                        ...
                        {
                            var coveringColleagues1 = praticeInfo.ElementAt(i).PracticeProviders.Where(p => p.Practice == AHC.CD.Entities.MasterData.Enums.PracticeType.CoveringColleague.ToString()).ToList();
