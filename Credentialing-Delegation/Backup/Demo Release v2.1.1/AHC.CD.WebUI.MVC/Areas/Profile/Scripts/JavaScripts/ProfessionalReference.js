...
profileApp.controller('ProfessionalReference', ['$scope', '$rootScope', '$http', 'masterDataService', 'locationService', 'messageAlertEngine', '$filter', function ($scope, $rootScope, $http, masterDataService, locationService, messageAlertEngine, $filter) {
  ...
  */
  ...
  $scope.SelectProviderTitle = function(titleType){
    ...
    var historyUrl = "/Profile/ProfileHistory/GetAllProfessionalReferenceHistory?profileId=" + profileId;
    ...
    $scope.removeProfessionalReference = function (ProfessionalReferences) {
        ...
        url = "/Profile/ProfessionalReference/RemoveProfessionalReference?profileId=" + profileId;
