...
profileApp.controller('educationController', ['$scope', '$rootScope', '$http', 'masterDataService', 'locationService', 'messageAlertEngine', '$filter', function ($scope, $rootScope, $http, masterDataService, locationService, messageAlertEngine, $filter) {
    ...
    $scope.showUnderGraduateDetailHistory = function (loadingId) {
        if ($scope.schooDetailsArray.length == 0) {
            ...
            var url = "/Profile/ProfileHistory/GetAllEducationDetailHistory?profileId=" + profileId;
    ...
    $scope.showCMECertificationHistory = function (loadingId) {
        if ($scope.CMECertificationArray.length == 0) {
            $("#" + loadingId).css('display', 'block');
            var url = "/Profile/ProfileHistory/GetCMECertificationHistory?profileId=" + profileId;
            $http.get(url).success(function (data) {
    ...
    $scope.showProgramDetailHistory = function (loadingId) {
        if ($scope.programDetailHistoryArray.length == 0) {
            $("#" + loadingId).css('display', 'block');
            var url = "/Profile/ProfileHistory/GetProgramDetailHistory?profileId=" + profileId;
            $http.get(url).success(function (data) {
    ...
    $scope.removeUGSchool = function (educationDetailViewModels) {
        ...
        url = "/Profile/EducationHistory/RemoveEducationDetailAsync?profileId=" + profileId;
        ResetFormForValidation($formData);
        validationStatus = $formData.valid();
    ...
    $scope.saveResidencyInternshipFellowshipProgram = function (residencyInternshipViewModel, IndexValue) {
        ...
        if ($scope.visibilityControl == 'addProgramDetail') {
            ...
            url = "/Profile/EducationHistory/AddProgramDetailAsync?profileId=" + profileId;
        }
            ...
            url = "/Profile/EducationHistory/UpdateProgramDetailAsync?profileId=" + profileId;
        }
    ...
    $scope.removeProgramDetail = function (ResidencyInternshipViewModel) {
        ...
        url = "/Profile/EducationHistory/RemoveProgramDetailAsync?profileId=" + profileId;
        ResetFormForValidation($formData);
        validationStatus = $formData.valid();
    ...
    $scope.removeCertificationDetail = function (CertificationCMEViewModel) {
        ...
        url = "/Profile/EducationHistory/RemoveCertificationDetailAsync?profileId=" + profileId;
        ResetFormForValidation($formData);
        validationStatus = $formData.valid();
    ...
    $rootScope.$on('EducationHistory', function () {
        if (!$scope.dataLoaded) {
            ...
            $http({
                method: 'GET',
                url: '/Profile/MasterProfile/GetEducationHistoriesProfileDataAsync?profileId=' + profileId
