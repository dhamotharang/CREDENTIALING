...
using System.Linq;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<AHC.CD.Data.EFRepository.EFEntityContext>
    {
        ...
        /*
        protected override void Seed(AHC.CD.Data.EFRepository.EFEntityContext context)
        {
            //  This method will be called after migrating to the latest version.

       
            var pc1 = new ProviderCategory{Title = "Individual",Code = "P"};
            var pc2 = new ProviderCategory{Title = "Facility",Code = "F"};

            context.ProviderCategories.AddOrUpdate(pc1);
            context.ProviderCategories.AddOrUpdate(pc2);
            ...
            context.DocumentCategories.AddOrUpdate(docCat1);
            context.DocumentCategories.AddOrUpdate(docCat2);
            context.DocumentCategories.AddOrUpdate(docCat3);

            context.DocumentTypes.AddOrUpdate(docType1);
            context.DocumentTypes.AddOrUpdate(docType2);
            context.DocumentTypes.AddOrUpdate(docType3);
            context.DocumentTypes.AddOrUpdate(docType4);
            context.DocumentTypes.AddOrUpdate(docType5);
            context.DocumentTypes.AddOrUpdate(docType6);
            context.DocumentTypes.AddOrUpdate(docType7);
            ...
            context.InsuranceCompanies.AddOrUpdate(ic1);
            context.InsuranceCompanies.AddOrUpdate(ic2);
            context.InsuranceCompanies.AddOrUpdate(ic3);
            context.InsuranceCompanies.AddOrUpdate(ic4);
