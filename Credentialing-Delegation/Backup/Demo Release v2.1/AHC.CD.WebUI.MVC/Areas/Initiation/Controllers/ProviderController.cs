...
namespace AHC.CD.WebUI.MVC.Areas.Initiation.Controllers
{
    public class ProviderController : Controller
    {
        ...
        private void SendEmail(string authUserId, string emailAddress)
        {
            ...
            var confirmationLink = string.Format("<h4>Dear Provider,</h4>" +
                ...
                "<a href=\"mailto:jmartin@accesshealthcarellc.net?subject=New%20Provider%20Information\">jmartin@accesshealthcarellc.net</a></i>", hosturl, emailAddress);
