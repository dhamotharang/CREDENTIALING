...
namespace AHC.CD.Entities.MasterProfile.PracticeLocation
{
    public class WorkersCompensationInformation
    {
        ...
        public StatusType? StatusType
        {
            get
            {
                if (String.IsNullOrEmpty(this.CertificationStatus))
                    return null;

                if (this.CertificationStatus.Equals("Not Available"))
                    return null;
        ...
        public virtual ICollection<WorkersCompensationInfoHistory> WorkersCompensationInfoHistory { get; set; }
