...
namespace AHC.CD.Business.MasterData
{
    internal class MasterDataManager : IMasterDataManager
    {
        ...
        public async Task<Specialty> GetSpecialtyByIDAsync(int? specialtyID)
        {
            try
            {
                var specialtyData = await repositoryManager.FindAsync<Specialty>(s => s.SpecialtyID == specialtyID && s.Status.Equals(StatusType.Active.ToString()));
        ...
        public async Task<Facility> GetMasterFacilityInformationByIDAsync(int facilityID)
        {
            try
            {
                var facilityData = await repositoryManager.FindAsync<Facility>(s => s.FacilityID == facilityID && s.Status.Equals(StatusType.Active.ToString()));
        ...
        public async Task<InsuranceCarrier> GetInsuranceCarrierByIDAsync(int insuranceCarrierID)
        {
            try
            {
                var insuranceCarrierData = await repositoryManager.FindAsync<InsuranceCarrier>(s => s.InsuranceCarrierID == insuranceCarrierID && s.Status.Equals(StatusType.Active.ToString()));

                return insuranceCarrierData;
            }
            catch (Exception)
            {
        ...
        public async Task<SpecialtyBoard> GetSpecialtyBoardByIDAsync(int boardID)
        {
            try
            {
                var specialtyBoardData = await repositoryManager.FindAsync<SpecialtyBoard>(s => s.SpecialtyBoardID == boardID && s.Status.Equals(StatusType.Active.ToString()));

                return specialtyBoardData;
            }
            catch (Exception)
            {
        ...
        public async Task<ProviderType> GetProviderTypeByIDAsync(int? providerTypeID)
        {
            try
            {
                var providerType = await repositoryManager.FindAsync<ProviderType>(s => s.ProviderTypeID == providerTypeID && s.Status.Equals(StatusType.Active.ToString()));
        ...
        public async Task<HospitalContactInfo> GetHospitalContactInfoByIDAsync(int contactID)
        {
            try
            {
                var hospitalContact = await repositoryManager.FindAsync<HospitalContactInfo>(s => s.HospitalContactInfoID == contactID && s.Status.Equals(StatusType.Active.ToString()));
        ...
        public async Task<InsuranceCarrierAddress> GetInsuranceCarrierAddressesByIDAsync(int? carrierAddressID)
        {
            try
            {
                var insuranceCarrierAddress = await repositoryManager.FindAsync<InsuranceCarrierAddress>(s => s.InsuranceCarrierAddressID == carrierAddressID && s.Status.Equals(StatusType.Active.ToString()));

                return insuranceCarrierAddress;
            }
            catch (Exception)
            {
        ...
        public async Task<StateLicenseStatus> GetLicenseStatusByIDAsync(int licenseStatusID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<StateLicenseStatus>(s => s.StateLicenseStatusID == licenseStatusID && s.Status.Equals(StatusType.Active.ToString()));
        ...
        public async Task<StaffCategory> GetStaffCategoryByIDAsync(int staffCategoryID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<StaffCategory>(s => s.StaffCategoryID == staffCategoryID && s.Status.Equals(StatusType.Active.ToString()));
        ...
        public async Task<School> GetSchoolByIDAsync(int schoolID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<School>(s => s.SchoolID == schoolID && s.Status.Equals(StatusType.Active.ToString()), "SchoolContactInfoes");
        ...
        public async Task<QualificationDegree> GetQualificationDegreeByIDAsync(int degreeID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<QualificationDegree>(s => s.QualificationDegreeID == degreeID && s.Status.Equals(StatusType.Active.ToString()));
        ...
        public async Task<ProfileDisclosureQuestion> GetProfileDisclosureQuestionByIDAsync(int questionID)
        {
            try
            {
                return await repositoryManager.FindAsync<ProfileDisclosureQuestion>(s => s.ProfileDisclosureQuestionID == questionID && s.Status.Equals(StatusType.Active.ToString()), "Questions, Questions.QuestionCategory, Questions.QuestionTheme");
            }
            catch (Exception)
            {
        ...
        public async Task<FacilityAccessibilityQuestion> GetPracticeAccessibilityQuestionByIDAsync(int accessibilityQuestionID)
        {
            try
            {
                return await repositoryManager.FindAsync<FacilityAccessibilityQuestion>(s => s.FacilityAccessibilityQuestionId == accessibilityQuestionID && s.Status.Equals(StatusType.Active.ToString()));
            }
            catch (Exception)
            {
        ...
        public async Task<MilitaryRank> GetMilitaryRankByIDAsync(int rankID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<MilitaryRank>(s => s.MilitaryRankID == rankID && s.Status.Equals(StatusType.Active.ToString()));
                return data;
        ...
        public async Task<MilitaryPresentDuty> GetMilitaryPresentDutyByIDAsync(int militaryPresentDutyID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<MilitaryPresentDuty>(s => s.MilitaryPresentDutyID == militaryPresentDutyID && s.Status.Equals(StatusType.Active.ToString()));
        ...
        public async Task<MilitaryDischarge> GetMilitaryDischargeByIDAsync(int dischargeID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<MilitaryDischarge>(s => s.MilitaryDischargeID == dischargeID && s.Status.Equals(StatusType.Active.ToString()));
        ...
        public async Task<MilitaryBranch> GetMilitaryBranchByIDAsync(int branchID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<MilitaryBranch>(s => s.MilitaryBranchID == branchID && s.Status.Equals(StatusType.Active.ToString()));
                return data;
            }
            catch (Exception)
            {
        ...
        public async Task<HospitalContactPerson> GetHospitalContactPersonByIDAsync(int personID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<HospitalContactPerson>(s => s.HospitalContactPersonID == personID && s.Status.Equals(StatusType.Active.ToString()));
        ...
        public async Task<DEASchedule> GetDEAScheduleByIDAsync(int scheduleID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<DEASchedule>(s => s.DEAScheduleID == scheduleID && s.Status.Equals(StatusType.Active.ToString()));
        ...
        public async Task<Certification> GetCertificationByIDAsync(int certificateID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<Certification>(s => s.CertificationID == certificateID && s.Status.Equals(StatusType.Active.ToString()));
        ...
        public async Task<AdmittingPrivilege> GetAdmittingPrivilegeByIDAsync(int privilegeID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<AdmittingPrivilege>(s => s.AdmittingPrivilegeID == privilegeID && s.Status.Equals(StatusType.Active.ToString()));
                return data;
            }
            catch (Exception)
            {
        ...
        public async Task<VisaType> GetVisaTypeByIDAsync(int visaTypeID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<VisaType>(s => s.VisaTypeID == visaTypeID && s.Status.Equals(StatusType.Active.ToString()));
        ...
        public async Task<Question> GetQuestionByIDAsync(int questionID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<Question>(s => s.QuestionID == questionID && s.Status.Equals(StatusType.Active.ToString()));
        ...
        public async Task<VisaStatus> GetVisaStatusByIDAsync(int visaStatusID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<VisaStatus>(s => s.VisaStatusID == visaStatusID && s.Status.Equals(StatusType.Active.ToString()));
        ...
        public async Task<QuestionCategory> GetQuestionCategoryByIDAsync(int questionCategoryID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<QuestionCategory>(s => s.QuestionCategoryID == questionCategoryID && s.Status.Equals(StatusType.Active.ToString()));
        ...
        public async Task<ProviderLevel> GetProviderLevelByIDAsync(int providerLevelID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<ProviderLevel>(s => s.ProviderLevelID == providerLevelID && s.Status.Equals(StatusType.Active.ToString()));
        ...
        public async Task<FacilityAccessibilityQuestion> GetAccessibilityQuestionByIDAsync(int accessibilityQuestionID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<FacilityAccessibilityQuestion>(s => s.FacilityAccessibilityQuestionId == accessibilityQuestionID && s.Status.Equals(StatusType.Active.ToString()));
        ...
        public async Task<FacilityPracticeType> GetPracticeTypeByIDAsync(int practiceTypeID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<FacilityPracticeType>(s => s.FacilityPracticeTypeID == practiceTypeID && s.Status.Equals(StatusType.Active.ToString()));
        ...
        public async Task<FacilityServiceQuestion> GetServiceQuestionByIDAsync(int serviceQuestionID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<FacilityServiceQuestion>(s => s.FacilityServiceQuestionID == serviceQuestionID && s.Status.Equals(StatusType.Active.ToString()));
        ...
        public async Task<PracticeOpenStatusQuestion> GetOpenPracticeStatusQuestionByIDAsync(int openPracticeStatusQuestionID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<PracticeOpenStatusQuestion>(s => s.PracticeOpenStatusQuestionID == openPracticeStatusQuestionID && s.Status.Equals(StatusType.Active.ToString()));
        ...
        public async Task<PracticePaymentAndRemittance> GetPaymentAndRemittanceByIDAsync(int paymentAndRemittanceID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<PracticePaymentAndRemittance>(s => s.PracticePaymentAndRemittanceID == paymentAndRemittanceID && s.PaymentAndRemittancePerson.Departments.Any(d => d.Department.Name.Equals("Payment and Remmittance")) && s.PaymentAndRemittancePerson.Status != Entities.MasterData.Enums.StatusType.Inactive.ToString(), "PaymentAndRemittancePerson");
        ...
        public async Task<Employee> GetBusinessContactPersonByIDAsync(int businessContactPersonID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<Employee>(s => s.EmployeeID == businessContactPersonID && s.Status != Entities.MasterData.Enums.StatusType.Inactive.ToString() && s.Departments.Any(d => d.Department.Name.Equals("Operation")));
        ...
        public async Task<OrganizationGroup> GetOrganizationGroupByIDAsync(int organizationGroupID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<OrganizationGroup>(s => s.OrganizationGroupID == organizationGroupID && s.Status.Equals(StatusType.Active.ToString()));
        ...
        public async Task<Employee> GetBillingContactByIDAsync(int billingContactID)
        {
            try
            {
                var data = await repositoryManager.FindAsync<Employee>(s => s.EmployeeID == billingContactID && s.Status != Entities.MasterData.Enums.StatusType.Inactive.ToString() && s.Departments.Any(d => d.Department.Name.Equals("Billing")));
        ...
        public async Task<Employee> GetCredentialingContactByIDAsync(int credentialingContactID)
        {
            try
            {

                var data = await repositoryManager.FindAsync<Employee>(s => s.EmployeeID == credentialingContactID && s.Status != Entities.MasterData.Enums.StatusType.Inactive.ToString() && s.Designations.Any(x => x.DesignationID == EmployeeDesignationValue.PrimaryCredentialingContactDesignationId));
                return data;
            }
