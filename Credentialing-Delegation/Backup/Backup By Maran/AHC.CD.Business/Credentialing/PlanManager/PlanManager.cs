...
namespace AHC.CD.Business.Credentialing.PlanManager
{
    public class PlanManager : IPlanManager
    {
        ...
        //public List<CredentialingInfo> GetAllCredentialingPlansForaProvider(int ProfileID)
        //{
        //    try
        //    {
        //        List<CredentialingInfo> CredentialedPlansForAProvider = null;
        //        var CredentialingInfoRepo = uow.GetGenericRepository<CredentialingInfo>();
        //        if (CredentialingInfoRepo != null)
        //        {
        //            CredentialedPlansForAProvider = (CredentialingInfoRepo.GetAll("Plan,CredentialingLogs.CredentialingActivityLogs.ActivityStatus").Where(p => p.ProfileID == ProfileID)).ToList();
        //        }
        //        return CredentialedPlansForAProvider;
        //    }
        //    catch(Exception)
        //    {
        //        throw;
