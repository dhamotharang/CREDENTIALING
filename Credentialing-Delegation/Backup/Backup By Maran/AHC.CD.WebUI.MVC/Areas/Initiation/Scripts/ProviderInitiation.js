...
providerApp.controller("providerController", ['$scope','$timeout', '$http', 'locationService', function ($scope, $timeout, $http, locationService) {
	...
	$scope.MyArray = {
	    "NPI_Number": $scope.Profile.OtherIdentificationNumber.NPINumber,
	    "SalutationType": "3",
	    "FirstName": "Zera",
	    "MiddleName": "",
	    "LastName": "Smith",
	    ...
	    "GenderType": "FeMale",
	    "ProviderLevelID": 1,
	    "ProviderTitles": [{ "ProviderTypeId": 40, "ProviderType": { Title: "ARNP" } }]
	}
	$scope.MyAddress = {
	    "Street": "540 Carillon Parkway",
	    "UnitNumber": "Apt 3072",
	...
	$scope.bindData = function (selectedId) {
	    $scope.PersonalDetail = {};
	    $scope.HomeAddresses = {};
	    $scope.ContractInfo = {};
	    $scope.ContactDetail = {};
	    //if ($scope.MyArray.NPI_Number == selectedId) {
	    $scope.PersonalDetail = $scope.MyArray;
	    $scope.HomeAddresses = $scope.MyAddress;
	    $scope.ContractInfo = $scope.Contract;
	    $scope.ContactDetail = $scope.ContactDetails;
	    //}
	}
}]);
