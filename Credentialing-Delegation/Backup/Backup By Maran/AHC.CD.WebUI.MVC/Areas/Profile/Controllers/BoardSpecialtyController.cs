...
namespace AHC.CD.WebUI.MVC.Areas.Profile.Controllers
{
    public class BoardSpecialtyController : Controller
    {
        ...
        public BoardSpecialtyController(IProfileManager profileManager, IErrorLogger errorLogger, IChangeNotificationManager notificationManager, IProfileUpdateManager profileUpdateManager, IMasterDataManager masterDataManager)
        {
