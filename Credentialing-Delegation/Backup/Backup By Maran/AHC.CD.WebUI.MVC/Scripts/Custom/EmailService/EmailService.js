var EmailServiceApp = angular.module("EmailServiceApp", ["ngTable", 'mgcrea.ngStrap', "wysiwyg.module", "ui.bootstrap", "smart-table", 'colorpicker.module']);
...
EmailServiceApp.controller("EmailServiceController", function ($rootScope, $timeout, $scope, $http, $filter, messageAlertEngine, ngTableParams, $sce, $filter) {
    ...
    $scope.showCompose = function () {
        ...
        $scope.compose = true;
        //$scope.tempObject.Body = "Satya Siva Venkata Manideep Innamuri";
    }
