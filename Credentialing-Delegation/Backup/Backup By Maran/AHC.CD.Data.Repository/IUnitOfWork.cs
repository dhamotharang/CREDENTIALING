...
namespace AHC.CD.Data.Repository
{
    ...
    public interface IUnitOfWork
    {
        ...
        ITaskTrackerRepository GetTaskTrackerRepository();
        IContractGridRepository GetContractGridRepository();
        INotesTemplateRepository GetNotesTemplateRepository();
        ITaskTrackerExpiryRepository GetTaskTrackerExpiryRepository();
