...
var StateLicenseHTMLTemplate = "<table class='table table-striped table-bordered small wrap-words'>" +
    "<thead><tr><th>License Number</th><th>State</th><th>Expiry Date</th><th>Day Left</th><th>Action</th></tr></thead>" +
    "<tbody><tr ng-repeat='license in CurrentPageLicenses' ng-class='{danger:license.dayLeft < -1, warning:license.dayLeft < 90, success:license.dayLeft < 180}'><td>{{license.LicenseNumber}}</td><td>{{license.IssueState}}</td><td>{{license.ExpiryDate | date:'MM/dd/yyyy'}}</td><td>{{license.dayLeft}}</td>" +
    "<td><a href='/Profile/MasterProfile/Index' target='_blank' class='btn btn-xs btn-default' tooltip data-toggle='tooltip' data-placement='right' title='Renew'><i class='fa fa-repeat'></i></a></td></tr>" +
    "</tbody></table>";

var FederalDEAHTMLTemplate = "<table class='table table-striped table-bordered small wrap-words'>" +
    "<thead><tr><th>DEA Number</th><th>State of Register</th><th>Expiry Date</th><th>Day Left</th><th>Action</th></tr></thead>" +
    "<tbody><tr ng-repeat='license in CurrentPageLicenses' ng-class='{danger:license.dayLeft < -1, warning:license.dayLeft < 90, success:license.dayLeft < 180}'><td>{{license.DEANumber}}</td><td>{{license.StateOfReg}}</td><td>{{license.ExpiryDate | date:'MM/dd/yyyy'}}</td><td>{{license.dayLeft}}</td>" +
    "<td><a href='/Profile/MasterProfile/Index' target='_blank' class='btn btn-xs btn-default' tooltip data-toggle='tooltip' data-placement='right' title='Renew'><i class='fa fa-repeat'></i></a></td></tr>" +
    "</tbody></table>";

var CDSInformationHTMLTemplate = "<table class='table table-striped table-bordered small wrap-words'>" +
    "<thead><tr><th>CDS Number</th><th>State</th><th>Expiry Date</th><th>Day Left</th><th>Action</th></tr></thead>" +
    "<tbody><tr ng-repeat='license in CurrentPageLicenses' ng-class='{danger:license.dayLeft < -1, warning:license.dayLeft < 90, success:license.dayLeft < 180}'><td>{{license.CertNumber}}</td><td>{{license.State}}</td><td>{{license.ExpiryDate | date:'MM/dd/yyyy'}}</td><td>{{license.dayLeft}}</td>" +
    "<td><a href='/Profile/MasterProfile/Index' target='_blank' class='btn btn-xs btn-default' tooltip data-toggle='tooltip' data-placement='right' title='Renew'><i class='fa fa-repeat'></i></a></td></tr>" +
    "</tbody></table>";

var SpecialityBoardHTMLTemplate = "<table class='table table-striped table-bordered small wrap-words'>" +
    "<thead><tr><th>Certificate Number</th><th>Specialty Board Name</th><th>Specialty Name</th><th>Expiry Date</th><th>Day Left</th><th>Action</th></tr></thead>" +
    "<tbody><tr ng-repeat='license in CurrentPageLicenses' ng-class='{danger:license.dayLeft < -1, warning:license.dayLeft < 90, success:license.dayLeft < 180}'><td>{{license.CertificateNumber}}</td><td>{{license.SpecialtyBoardName}}</td><td>{{license.SpecialtyName}}</td><td>{{license.ExpiryDate | date:'MM/dd/yyyy'}}</td><td>{{license.dayLeft}}</td>" +
    "<td><a href='/Profile/MasterProfile/Index' target='_blank' class='btn btn-xs btn-default' tooltip data-toggle='tooltip' data-placement='right' title='Renew'><i class='fa fa-repeat'></i></a></td></tr>" +
    "</tbody></table>";

var HospitalPrivilagesHTMLTemplate = "<table class='table table-striped table-bordered small wrap-words'>" +
    "<thead><tr><th>Hospital Name</th><th>Expiry Date</th><th>Day Left</th><th>Action</th></tr></thead>" +
    "<tbody><tr ng-repeat='license in CurrentPageLicenses' ng-class='{danger:license.dayLeft < -1, warning:license.dayLeft < 90, success:license.dayLeft < 180}'><td>{{license.HospitalName}}</td><td>{{license.AffiliationEndDate | date:'MM/dd/yyyy'}}</td><td>{{license.dayLeft}}</td>" +
    "<td><a href='/Profile/MasterProfile/Index' target='_blank' class='btn btn-xs btn-default' tooltip data-toggle='tooltip' data-placement='right' title='Renew'><i class='fa fa-repeat'></i></a></td></tr>" +
    "</tbody></table>";

var ProfessionalLiabilityHTMLTemplate = "<table class='table table-striped table-bordered small wrap-words'>" +
    "<thead><tr><th>Policy Number</th><th>Insurance Carrier</th><th>Expiry Date</th><th>Day Left</th><th>Action</th></tr></thead>" +
    "<tbody><tr ng-repeat='license in CurrentPageLicenses' ng-class='{danger:license.dayLeft < -1, warning:license.dayLeft < 90, success:license.dayLeft < 180}'><td>{{license.PolicyNumber}}</td><td>{{license.InsuranceCarrier}}</td><td>{{license.ExpirationDate | date:'MM/dd/yyyy'}}</td><td>{{license.dayLeft}}</td>" +
    "<td><a href='/Profile/MasterProfile/Index' target='_blank' class='btn btn-xs btn-default' tooltip data-toggle='tooltip' data-placement='right' title='Renew'><i class='fa fa-repeat'></i></a></td></tr>" +
    "</tbody></table>";

var WorkerCompensationHTMLTemplate = "<table class='table table-striped table-bordered small wrap-words'>" +
    "<thead><tr><th>Workers Compensation Number</th><th>Expiry Date</th><th>Day Left</th><th>Action</th></tr></thead>" +
    "<tbody><tr ng-repeat='license in CurrentPageLicenses' ng-class='{danger:license.dayLeft < -1, warning:license.dayLeft < 90, success:license.dayLeft < 180}'><td>{{license.WorkersCompensationNumber}}</td><td>{{license.ExpirationDate | date:'MM/dd/yyyy'}}</td><td>{{license.dayLeft}}</td>" +
    "<td><a href='/Profile/MasterProfile/Index' target='_blank' class='btn btn-xs btn-default' tooltip data-toggle='tooltip' data-placement='right' title='Renew'><i class='fa fa-repeat'></i></a></td></tr>" +
    "</tbody></table>";


// -------------------- Directive for generate costume table according to selected Licenses ----------------------
