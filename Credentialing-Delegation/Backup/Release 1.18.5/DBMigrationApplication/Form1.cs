...
namespace DBMigrationApplication
{
    public partial class Form1 : Form
    {
            ...
            foreach (var file in xmlFiles)
            {
                ...
                var contactDetails = (from x in xmlDoc.Descendants("d_prf_personal_row")
                                      ...
                                      new AHC.CD.Entities.MasterProfile.Demographics.ContactDetail
                                      {
                                          ...
                                          EmailIDs = new List<EmailDetail>
                                          {
                                              new EmailDetail { EmailAddress = "NotAvailable@access.com", Preference = "Primary"}
                                          }
                ...
                while (!reader.EndOfStream)
                {
                    ...
                    while (!sreader.EndOfStream)
                    {
                        ...
                        if (data[0] == ProviderNPINumber)
                        {
                            ...
                            hpd.HospitalPrevilegeLetterPath = GetFilePath(ProviderNPINumber, data[1] + ".pdf", "Hospital Prievilage");
                    ...
                    var profRefs = (from x1 in xmlDoc.Descendants("d_prf_references")
                                    ...
                                    select new AHC.CD.Entities.MasterProfile.ProfessionalReference.ProfessionalReferenceInfo
                                    {
                                        ...
                                        LastName = x.Element("pd_references_last_name").Value.Length > 0 ? x.Element("pd_references_last_name").Value : null,
                                        ...
                                        FirstName = x.Element("pd_references_first_middle_name").Value.Length > 0 ? x.Element("pd_references_first_middle_name").Value : null,
                    ...
                    try
                    {
                        ...
                        //{
                        //    providerRole.CDUsers = new List<CDUser>();
                        //}
        ...
        private void AddBoardSpecialities(string ProviderNPINumber, ICollection<SpecialtyDetail> collection)
        {
            ...
            while (!reader.EndOfStream)
            {
                ...
                if (data[0] == ProviderNPINumber)
                {
                    ...
                    Specialty sp = context.Specialities.FirstOrDefault(s => s.Name == data[2]);
                    if(sp == null)
                    {
                    ...
                    SpecialtyBoard sb = context.SpecialtyBoards.FirstOrDefault(ss => ss.Name == data[3]);
                    if(sb == null)
                    {
        ...
        private void AddCMECertificationExtraDetails(ICollection<CMECertification> collection, string npi)
        {
            ...
            while(!reader.EndOfStream)
            {
                ...
                if (data[0] == npi)
                {
                    ...
                    cme.CreditHours = (data[5].Length > 0 && !string.IsNullOrEmpty(data[5])) ? int.Parse(data[5]) : 0;
        ...
        private string FormatPhone(string phone)
        {
            ...
            if (phone != null && phone.Contains("Not Available"))
                return phone;
        ...
        private int GetInsuranceCarrierID(string insuranceCarrierName,out int insurranceCarrierAddressID)
        {
            ...
            else // Create master data
            {
                ...
                if (ic.InsuranceCarrierAddresses == null)
                {
                    ...
                    //insuranceCarrierAddress.LocationName = 
