...
profileApp.controller('practiceLocationController', ['$scope', '$rootScope', '$http', '$filter', 'masterDataService', 'locationService', 'messageAlertEngine', function ($scope, $rootScope, $http, $filter, masterDataService, locationService, messageAlertEngine) {
    ...
    masterDataService.getPractitioners("/Profile/MasterData/GetPractitionersByProviderLevel", "Supervisor", profileId).then(function (SupervisingPractitioners) {
        ...
        $scope.supervisingPractitioners = SupervisingPractitioners;
    });
    ...
    $scope.saveOfficeManager = function (PracticeLocationDetail, index) {
        ...
        if ($scope.manager=='Yes') {
            ...
            url = "/Profile/PracticeLocation/UpdateOfficeManagerAsync";
        }
        else {
            validationStatus = $formData.valid();
            url = "/Profile/PracticeLocation/AddOfficeManagerAsync";
        }
        if (validationStatus) {
    ...
    $scope.saveBillingContact = function (PracticeLocationDetail, index) {
        ...
        if ($scope.managerStatus) {
            validationStatus = 'True';
            url = "/Profile/PracticeLocation/UpdateBillingContactAsync";
        }
        else {
            validationStatus = $formData.valid();
            url = "/Profile/PracticeLocation/AddBillingContactAsync";
        }
        if (validationStatus) {
            //Simple POST request example (passing data) :
            $.ajax({
    ...
    $scope.savePayment = function (PracticeLocationDetail, index) {
        ...
        if ($scope.managerStatus) {
            validationStatus = 'True';
            url = "/Profile/PracticeLocation/UpdatePaymentAndRemittanceAsync";
        }
        else {
            validationStatus = $formData.valid();
            url = "/Profile/PracticeLocation/AddPaymentAndRemittanceAsync";
        }
        if (validationStatus) {
            //Simple POST request example (passing data) :
            $.ajax({
    ...
    $scope.saveFacilityInformaton = function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.status == "true") {
                        ...
                        $scope.PracticeLocationDetails.push(data.practiceLocationDetail);
                        $scope.operateAddControlPracLoc('');
    ...
    $scope.validateDailyHours = function (PracticeDays, parent ,subsection, index) {
        var status = true;
    ...
    $scope.updateOfficeHours = function (PracticeLocationDetail, index) {
        ...
        url = "/Profile/PracticeLocation/updateOfficeHours";
    ...
    $scope.updateWorkersCompensationInformation = function (PracticeLocationDetail, index) {
        ...
        url = "/Profile/PracticeLocation/UpdateWorkersCompensationInformationAsync";
    ...
    $scope.saveOpenPracticeStatus = function (PracticeLocationDetail, index) {
        ...
        url = "/Profile/PracticeLocation/UpdateOpenPracticeStatusAsync";
        ResetFormForValidation($formData);
        validationStatus = $formData.valid();
    ...
    $scope.saveMidLevel = function (PracticeLocationDetailID) {
        ...
        validationStatus = $formData.valid();
        url = "/Profile/PracticeLocation/addMidLevelAsync?practiceLocationDetailID=" + PracticeLocationDetailID;
    ...
    $scope.addMidlevelPractioners = function (PracticeLocationDetail, index) {
        ...
        url = "/Profile/PracticeLocation/addMidlevelPractionersAsync";
    ...
    $scope.updateMidLevelPractitioner = function (PracticeLocationDetail) {
        ...
        url = "/Profile/PracticeLocation/UpdateMidLevelPractitionerAsync";
    ...
    $scope.getSupervisingPractionersByName = function (query) {
        if (angular.isObject(query)) {
            $scope.SupervisingPractitioner = query;
        }
    };

    $scope.addSupervisingPractioners = function () {

    };
    $scope.fillCorporateName = function (val) {
        $scope.tempSecondObject.PracticeLocationCorporateName = val.Name;
    }
