...
profileApp.controller('LiabilityCtrl', ['$scope', '$rootScope', '$http', 'dynamicFormGenerateService', 'masterDataService', function ($scope,$rootScope,$http, dynamicFormGenerateService,masterDataService) {
                ...
                success: function (data) {
                    ...
                    if (data.status == "true") {
                        ...
                        if ($scope.visibilityControl != (index + '_editLi')) {
                            ...
                            $rootScope.visibilityControl = "addedNewProfessionalLiability";
                        }
                        else {
                            $scope.ProfessionalLiabilityInfoes[index] = data.professionalLiability;
                            $rootScope.visibilityControl = "updatedProfessionalLiability";
                        }
