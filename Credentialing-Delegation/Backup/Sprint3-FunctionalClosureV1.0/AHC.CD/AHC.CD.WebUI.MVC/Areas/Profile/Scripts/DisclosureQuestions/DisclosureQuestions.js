...
profileApp.controller('DisclosureController', function ($scope) {
    ...
    $scope.disclosureQuestions = [{
                ...
                ]},
       {
        ...
        },
        {
            ...
            instruction: "* Answer all questions. For any \"Yes\"  response, provide an explanation",
            questions:
            [{ questionText: "20. Has your professional liability coverage ever been cancelled, restricted, declined or not renewed by the carrier based on your individual liability history?*", placeholderText: "Please Elaborate", answerText: "No", reasonText: "" },
             ...
             { questionText: "24. Are any professional liability  (i.e. malpractice)claims ,suits, judgements, settlements or arbitration proceedings involving you currently pending?*", placeholderText: "Please Elaborate", answerText: "No", reasonText: "" },
            ...
            ]},
        {
            ...
            questions:
            [{ questionText: "25. Have you had any professional liability actions (pending, settled, arbitrated, mediated or litigated) within the past 10 years?* If yes, provide information for each case.", placeholderText: "Please Elaborate", answerText: "Yes", reasonText: "" },
            ]},
        {
    ...
    $scope.saveQuestions = function (disclosureQuestions) {
        ...
        url = "/Profile/Specialty/UpdatePracticeInterestAsync?profileId=1"; //+ profileId;
        if (validationStatus) {
            console.log(practiceInterest);
            //Simple POST request example (passing data) :
            $http.post(url, practiceInterest).
              success(function (data, status, headers, config) {
                  console.log(practiceInterest);
                  alert("Success");
                  if ($scope.changePartial) {
                      //Add Details - Denote the URL
                      practiceInterest.PracticeInterestID = data;
                  }
