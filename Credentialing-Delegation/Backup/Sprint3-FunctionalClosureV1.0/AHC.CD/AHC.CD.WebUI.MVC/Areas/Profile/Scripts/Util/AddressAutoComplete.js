...
profileApp.service('locationService', ['$http',  function ($http) {
    ...
    this.getLocations = function (QueryString) {
        return $http.get("/Location/Get?city=" + QueryString)     //locationService makes an ajax call to fetch all the cities which have relevent names as the query string.
