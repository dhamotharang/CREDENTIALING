...
var StateLicenseHTMLTemplate = "<table class='table table-striped table-bordered customtbodyStyle small'>" +
    ...
    "<tr ng-repeat='l in p.Licenses'><td>{{l.LicenseNumber}}</td><td>{{l.IssueState}}</td><td>{{l.ExpiryDate | date:'MM/dd/yyyy'}}</td><td>{{l.dayLeft}}</td>" +
    "<td><a href='/Profile/MasterProfile/ProviderProfile/{{p.PersonalDetails.ProfileId}}' target='_blank' class='btn btn-xs btn-default' data-toggle='tooltip' data-placement='right' title='Renew'><i class='fa fa-repeat'></i></a></td>" +
    "</tr></tbody></table>";

var FederalDEAHTMLTemplate = "<table class='table table-striped table-bordered customtbodyStyle small'>" +
    ...
    "<tbody ng-repeat='p in CurrentPageProviders track by $index'><tr><td rowspan='{{p.Licenses.length+1}}'>{{p.PersonalDetails.NPINumber}}</td>" +
    "<td rowspan='{{p.Licenses.length+1}}'>{{p.PersonalDetails.FirstName}} {{p.PersonalDetails.LastName}}</td></tr>" +
    "<tr ng-repeat='l in p.Licenses'><td>{{l.DEANumber}}</td><td>{{l.StateOfReg}}</td><td>{{l.ExpiryDate | date:'MM/dd/yyyy'}}</td><td>{{l.dayLeft}}</td>" +
    "<td><a href='/Profile/MasterProfile/ProviderProfile/{{p.PersonalDetails.ProfileId}}' target='_blank' class='btn btn-xs btn-default' data-toggle='tooltip' data-placement='right' title='Renew'><i class='fa fa-repeat'></i></a></td>" +
    "</tr></tbody></table>";

var CDSInformationHTMLTemplate = "<table class='table table-striped table-bordered customtbodyStyle small'>" +
    ...
    "<tbody ng-repeat='p in CurrentPageProviders track by $index'><tr><td rowspan='{{p.Licenses.length+1}}'>{{p.PersonalDetails.NPINumber}}</td>" +
    "<td rowspan='{{p.Licenses.length+1}}'>{{p.PersonalDetails.FirstName}} {{p.PersonalDetails.LastName}}</td></tr>" +
    "<tr ng-repeat='l in p.Licenses'><td>{{l.CertNumber}}</td><td>{{l.State}}</td><td>{{l.ExpiryDate | date:'MM/dd/yyyy'}}</td><td>{{l.dayLeft}}</td>" +
    "<td><a href='/Profile/MasterProfile/ProviderProfile/{{p.PersonalDetails.ProfileId}}' target='_blank' class='btn btn-xs btn-default' data-toggle='tooltip' data-placement='right' title='Renew'><i class='fa fa-repeat'></i></a></td>" +
    "</tr></tbody></table>";

var SpecialityBoardHTMLTemplate = "<table class='table table-striped table-bordered customtbodyStyle small'>" +
    "<thead><tr><th>NPI Number</th><th>Provider Name</th><th>Certificate Number</th><th>Speciality Board Name</th><th>Speciality Name</th><th>Expiry Date</th><th>Day Left</th><th>Action</th></tr></thead>" +
    "<tbody ng-repeat='p in CurrentPageProviders track by $index'><tr><td rowspan='{{p.Licenses.length+1}}'>{{p.PersonalDetails.NPINumber}}</td>" +
    "<td rowspan='{{p.Licenses.length+1}}'>{{p.PersonalDetails.FirstName}} {{p.PersonalDetails.LastName}}</td></tr>" +
    "<tr ng-repeat='l in p.Licenses'><td>{{l.CertificateNumber}}</td><td>{{l.SpecialtyBoardName}}</td><td>{{l.SpecialtyName}}</td><td>{{l.ExpiryDate | date:'MM/dd/yyyy'}}</td><td>{{l.dayLeft}}</td>" +
    "<td><a href='/Profile/MasterProfile/ProviderProfile/{{p.PersonalDetails.ProfileId}}' target='_blank' class='btn btn-xs btn-default' data-toggle='tooltip' data-placement='right' title='Renew'><i class='fa fa-repeat'></i></a></td>" +
    "</tr></tbody></table>";

var HospitalPrivilagesHTMLTemplate = "<table class='table table-striped table-bordered customtbodyStyle small'>" +
    "<thead><tr><th>NPI Number</th><th>Provider Name</th><th>Hospital Name</th><th>Expiry Date</th><th>Day Left</th><th>Action</th></tr></thead>" +
    "<tbody ng-repeat='p in CurrentPageProviders track by $index'><tr><td rowspan='{{p.Licenses.length+1}}'>{{p.PersonalDetails.NPINumber}}</td>" +
    "<td rowspan='{{p.Licenses.length+1}}'>{{p.PersonalDetails.FirstName}} {{p.PersonalDetails.LastName}}</td></tr>" +
    "<tr ng-repeat='l in p.Licenses'><td>{{l.HospitalName}}</td><td>{{l.AffiliationEndDate | date:'MM/dd/yyyy'}}</td><td>{{l.dayLeft}}</td>" +
    "<td><a href='/Profile/MasterProfile/ProviderProfile/{{p.PersonalDetails.ProfileId}}' target='_blank' class='btn btn-xs btn-default' data-toggle='tooltip' data-placement='right' title='Renew'><i class='fa fa-repeat'></i></a></td>" +
    "</tr></tbody></table>";

var ProfessionalLiabilityHTMLTemplate = "<table class='table table-striped table-bordered customtbodyStyle small'>" +
    ...
    "<tbody ng-repeat='p in CurrentPageProviders track by $index'><tr><td rowspan='{{p.Licenses.length+1}}'>{{p.PersonalDetails.NPINumber}}</td>" +
    "<td rowspan='{{p.Licenses.length+1}}'>{{p.PersonalDetails.FirstName}} {{p.PersonalDetails.LastName}}</td></tr>" +
    "<tr ng-repeat='l in p.Licenses'><td>{{l.PolicyNumber}}</td><td>{{l.InsuranceCarrier}}</td><td>{{l.ExpirationDate | date:'MM/dd/yyyy'}}</td><td>{{l.dayLeft}}</td>" +
    "<td><a href='/Profile/MasterProfile/ProviderProfile/{{p.PersonalDetails.ProfileId}}' target='_blank' class='btn btn-xs btn-default' data-toggle='tooltip' data-placement='right' title='Renew'><i class='fa fa-repeat'></i></a></td>" +
    "</tr></tbody></table>";

var WorkerCompensationHTMLTemplate = "<table class='table table-striped table-bordered customtbodyStyle small'>" +
    ...
    "<tbody ng-repeat='p in CurrentPageProviders track by $index'><tr><td rowspan='{{p.Licenses.length+1}}'>{{p.PersonalDetails.NPINumber}}</td>" +
    "<td rowspan='{{p.Licenses.length+1}}'>{{p.PersonalDetails.FirstName}} {{p.PersonalDetails.LastName}}</td></tr>" +
    "<tr ng-repeat='l in p.Licenses'><td>{{l.WorkersCompensationNumber}}</td><td>{{l.ExpirationDate | date:'MM/dd/yyyy'}}</td><td>{{l.dayLeft}}</td>" +
    "<td><a href='/Profile/MasterProfile/ProviderProfile/{{p.PersonalDetails.ProfileId}}' target='_blank' class='btn btn-xs btn-default' data-toggle='tooltip' data-placement='right' title='Renew'><i class='fa fa-repeat'></i></a></td>" +
    "</tr></tbody></table>";
...
dashboardApp.service('CCOLicenseService', function () {
    ...
    this.GetLicenseByProviderType = function (providertype, masterProviders) {
        if (providertype != "") {
            var temp = [];
...
dashboardApp.controller("CCODashboardController", ["$scope", "$http", "CCOLicenseService", function ($scope, $http, CCOLicenseService) {
    ...
    //------------------- get data according Selected Provider Type -----------------------
    $scope.getDataAccordingProviderType = function (providertype) {
        $scope.Providers = CCOLicenseService.GetLicenseByProviderType(providertype, $scope.MasterProviderByLicense);
    };
