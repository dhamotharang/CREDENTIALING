...
providerApp.controller("providerController", ['$scope', '$http', 'locationService', function ($scope, $http, locationService) {
	...
	//$scope.$watch($scope.Profile.OtherIdentificationNumber.CAQHNumber, function (value) {

    //    if ($scope.Profile.OtherIdentificationNumber.CAQHNumber.length == 0) {
	...
	$scope.clearNPI = function () {

	    if ($scope.Profile.OtherIdentificationNumber.NPINumber.length == 0) {
	        $scope.Profile.OtherIdentificationNumber.NPIUserName = "";
	        $scope.Profile.OtherIdentificationNumber.NPIPassword = "";
	    }
	}

	$scope.clearCAQH = function () {
