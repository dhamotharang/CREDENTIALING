...
namespace AHC.CD.Entities.MasterProfile.PracticeLocation
{
    public class PracticeLocationDetail
    {
        ...
        public ProviderPracticeOfficeHour OfficeHour { get; set; }
        ...
        public ICollection<PracticeColleague> PracticeColleagues { get; set; }

        public ICollection<MidLevelPractitioner> MidlevelPractioners { get; set; }

        public ICollection<SupervisingProvider> SupervisingProviders { get; set; }
        ...
        public AHC.CD.Entities.MasterData.Account.PracticingGroup Group { get; set; }
