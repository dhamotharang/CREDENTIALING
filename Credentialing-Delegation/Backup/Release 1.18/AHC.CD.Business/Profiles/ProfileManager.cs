    ...
    {        
        ...
        public async Task<IEnumerable<Profile>> GetAllProfileByProviderLevel(string providerLevel, int profileId)
        {
            try
            {
                ...
                var practitioners = from provider in await profileRepository.GetAllAsync("PersonalDetail.ProviderLevel,OtherIdentificationNumber,SpecialtyDetails.Specialty, PracticeLocationDetails.Facility")
