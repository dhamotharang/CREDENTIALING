...
profileApp.controller('WorkHistoryController', ['$scope', '$rootScope', '$http', '$filter', '$timeout', 'masterDataService', 'locationService', 'messageAlertEngine', function ($scope, $rootScope, $http, $filter, $timeout, masterDataService, locationService, messageAlertEngine) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == "true") {
                        ...
                        console.log($scope.CVInformation);
