            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    else
                    {
                        ...
                        profileUpdateManager.AddProfileUpdateForProvider(specialty, dataModelSpecialty, tracker);
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    else
                    {
                        ...
                        tracker.ProfileId = profileId;
                        tracker.Section = "Board Specialty";
                        tracker.SubSection = "Specialty Detail";
                        tracker.userAuthId = userId;
                        tracker.objId = specialty.SpecialtyDetailID;
