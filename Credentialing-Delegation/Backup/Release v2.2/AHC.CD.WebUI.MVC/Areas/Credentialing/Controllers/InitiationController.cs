...
namespace AHC.CD.WebUI.MVC.Areas.Credentialing.Controllers
{
    public class InitiationController : Controller
    {
        ...
        [HttpPost]
        public JsonResult InitiateReCredentialing(int id, CredentialingInitiationInfoViewModel credentialingInitiationInfo, int[] CredentialingContractRequestsArray, int[] NonCredentialingContractRequestsArray)
        {
            string status = "true";
            ...
            try
            {
                id1 = individualCredentialingManager.InitiateReCredentialingAsync(id, dataCredentialingInitiationInfo, GetUserAuthId(), CredentialingContractRequestsArray, NonCredentialingContractRequestsArray);
            }
            catch (DatabaseValidationException ex)
            {
                errorLogger.LogError(ex);
