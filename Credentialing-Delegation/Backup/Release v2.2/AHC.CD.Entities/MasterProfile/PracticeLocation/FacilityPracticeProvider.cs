...
{
    public class FacilityPracticeProvider
    {
        public FacilityPracticeProvider()
        {
            LastModifiedDate = DateTime.Now;
        }

        public int FacilityPracticeProviderID { get; set; }
        ...
        public virtual ICollection<FacilityPracticeProviderType> FacilityPracticeProviderTypes { get; set; }

        public virtual ICollection<FacilityPracticeProviderSpeciality> FacilityPracticeProviderSpecialties { get; set; }
