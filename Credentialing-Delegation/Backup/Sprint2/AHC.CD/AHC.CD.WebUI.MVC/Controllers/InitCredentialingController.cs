...
namespace AHC.CD.WebUI.MVC.Controllers
{
    public class InitCredentialingController : Controller
    {
        ...
        IIndividualCredentialingManager individualCredentialingManager;
        public InitCredentialingController(IProvidersManager providersManager, IDocumentsManager documentManager, ICachingService cache, IIndividualCredentialingManager individualCredentialingManager)
        {
