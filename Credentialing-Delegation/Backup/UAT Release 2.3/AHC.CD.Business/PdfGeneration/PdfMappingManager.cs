            ...
            if (profile.PracticeLocationDetails.Count > 0)
            {
                ...
                if (practiceLocation.Count > 0 && practiceLocation[practiceLocationCount - 1] != null)
                {
                    if (practiceLocation[practiceLocationCount - 1].Facility != null)
                    {
                        ...
                        if (practiceLocation[practiceLocationCount - 1].Facility.MobileNumber != null)
                            pmodel.General_Phone1 = practiceLocation[practiceLocationCount - 1].Facility.MobileNumber.Substring(3, practiceLocation[practiceLocationCount - 1].Facility.MobileNumber.Length-3);
                        
                        pmodel.General_Email1 = practiceLocation[practiceLocationCount - 1].Facility.EmailAddress;

                        if (practiceLocation[practiceLocationCount - 1].Facility.FaxNumber != null)
                            pmodel.General_Fax1 = practiceLocation[practiceLocationCount - 1].Facility.FaxNumber.Substring(3, practiceLocation[practiceLocationCount - 1].Facility.FaxNumber.Length-3);
