...
credentialingList.controller('credentialingListController', ['$scope', '$http', '$filter', 'ngTableParams', '$rootScope', 'messageAlertEngine', '$timeout', function ($scope, $http, $filter, ngTableParams, $rootScope, messageAlertEngine, $timeout) {
    ...
    $scope.getStatus = function (data, index) {
        ...
        if (data[0].CredentialingActivityLogs != null && data[0].CredentialingActivityLogs.length != 0) {

            for (var i = 0; i < data[0].CredentialingActivityLogs.length; i++) {

                if (data[0].CredentialingActivityLogs[i].Activity == "Initiation") {
                    if (data[0].CredentialingActivityLogs[i].ActivityStatus == "Completed") {

                        //$scope.status.push("Initiated");
                        $scope.data[index].CurrentStatus = "Initiated";
                        $scope.isInitiated = true;
                        $scope.credInitDate = data[0].CredentialingActivityLogs[i].LastModifiedDate;
                    }

                } else if (data[0].CredentialingActivityLogs[i].Activity == "PSV") {
                    ...
                    if (data[0].CredentialingActivityLogs[i].ActivityStatus == "Completed") {
                        ...
                        $scope.psvInitDate = data[0].CredentialingActivityLogs[i].LastModifiedDate;
                ...
                } else if (data[0].CredentialingActivityLogs[i].Activity == "CCMAppointment") {
                    ...
                    if (data[0].CredentialingActivityLogs[i].ActivityStatus == "Completed") {
                        ...
                        $scope.ccmInitDate = data[0].CredentialingActivityLogs[i].LastModifiedDate;
                ...
                } else if (data[0].CredentialingActivityLogs[i].Activity == "Loading") {
                    ...
                    if (data[0].CredentialingActivityLogs[i].ActivityStatus == "Completed") {
                        ...
                        $scope.isLoaded = true;
                        $scope.loadToPlanInitDate = data[0].CredentialingActivityLogs[i].LastModifiedDate;
                ...
                } else if (data[0].CredentialingActivityLogs[i].Activity == "Report") {
                ...
                } else if (data[0].CredentialingActivityLogs[i].Activity == "Dropped") {
