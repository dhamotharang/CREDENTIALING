      ...
      if (data.status == 'true') {
          ...
          if ($scope.delegationProfileObj.ProviderPracitceInfos != null) {
              for (var i = 0; i < $scope.delegationProfileObj.ProviderPracitceInfos.length; i++) {
                  if ($scope.delegationProfileObj.ProviderPracitceInfos[i].OfficeHourMonday != null && $scope.delegationProfileObj.ProviderPracitceInfos[i].OfficeHourMonday.indexOf('off') < 0) {
                  ...
                  if ($scope.delegationProfileObj.ProviderPracitceInfos[i].OfficeHourTuesday != null && $scope.delegationProfileObj.ProviderPracitceInfos[i].OfficeHourTuesday.indexOf('off') < 0) {
                  ...
                  if ($scope.delegationProfileObj.ProviderPracitceInfos[i].OfficeHourWednesday != null && $scope.delegationProfileObj.ProviderPracitceInfos[i].OfficeHourWednesday.indexOf('off') < 0) {
                  ...
                  if ($scope.delegationProfileObj.ProviderPracitceInfos[i].OfficeHourThursday != null && $scope.delegationProfileObj.ProviderPracitceInfos[i].OfficeHourThursday.indexOf('off') < 0) {
                  ...
                  if ($scope.delegationProfileObj.ProviderPracitceInfos[i].OfficeHourFridayday != null && $scope.delegationProfileObj.ProviderPracitceInfos[i].OfficeHourFridayday.indexOf('off') < 0) {
