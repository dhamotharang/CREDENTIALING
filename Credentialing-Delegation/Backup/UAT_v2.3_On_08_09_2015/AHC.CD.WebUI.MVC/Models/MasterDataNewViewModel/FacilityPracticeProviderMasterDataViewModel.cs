...
{
    public class FacilityPracticeProviderMasterDataViewModel
    {
        ...
        public ICollection<FacilityPracticeProviderTypeViewModel> FacilityPracticeProviderTypes { get; set; }

        [Display(Name = "Specialty")]
        public ICollection<FacilityPracticeProviderSpecialityViewModel> FacilityPracticeProviderSpecialties { get; set; }
    }
}