...
namespace AHC.CD.WebUI.MVC.Areas.Profile.Controllers
{
    public class MasterProfileController : Controller
    {
        ...
        public void ChangeNotificationStatus(int dashboardNotificationID)
        {
            //AHC.CD.Entities.Notification.UserDashboardNotification dashboardNotification = null;
            RedirectToAction("Index", "Profile/MasterProfile");
            //Index();
            //RedirectToRoute("/Profile/MasterProfile/Index");
        ...
        {
            return JsonConvert.SerializeObject(await profileManager.GetBoardSpecialtiesProfileDataAsync(profileId), new JsonSerializerSettings
            {
                DateTimeZoneHandling = DateTimeZoneHandling.Local
            });
        }
