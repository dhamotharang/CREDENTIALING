            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (planViewModel .PlanLogoFile!= null)
                    {
                     ...
                     string filePath = Path.Combine(System.Web.HttpContext.Current.Server.MapPath("~/ApplicationDocuments/PlanLogo"), fileName);
                     planViewModel.PlanLogoFile.SaveAs(filePath);
                    }
                  
                    Plan = AutoMapper.Mapper.Map<PlanViewModel, Plan>(planViewModel);
                    Plan.PlanLogoPath = "~/ApplicationDocuments/PlanLogo/" + fileName;
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (planViewModel.PlanLogoFile != null && planViewModel.PlanLogoPath == null)
                    {
                        ...
                        string filePath = Path.Combine(System.Web.HttpContext.Current.Server.MapPath("~/ApplicationDocuments/PlanLogo"), fileName);
                        planViewModel.PlanLogoFile.SaveAs(filePath);
                        dataModelPlanDetail.PlanLogoPath = "~/ApplicationDocuments/PlanLogo/" + fileName;
                    }
