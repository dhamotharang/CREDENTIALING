...
namespace AHC.CD.Data.EFRepository.Profiles
{
    internal class ProfileEFRepository : EFGenericRepository<Profile>, IProfileRepository
    {
        ...
        public void RemoveFederalDEALicense(int profileId, FederalDEAInformation federalDEALicense)
        {
            try {
                ...
                if(IsProviderExists(profileId, profile))
                {
                    var removeFederalDeaLicense = profile.FederalDEAInformations.FirstOrDefault(d => d.FederalDEAInformationID == federalDEALicense.FederalDEAInformationID);
