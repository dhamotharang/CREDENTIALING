...
initCredApp.controller('singleProviderCtrl', function ($scope, $http, $location, $filter, ngTableParams, messageAlertEngine) {
    ...
    $scope.init_table = function (data, condition) {
        ...
        //        $scope.data[i].FullIPA = "";
        //        $scope.data[i].FullSpecialty = "";
        ...
        //        $scope.data[i].CAQH = $scope.data[i].OtherIdentificationNumber.CAQHNumber;
        //        //------------------ for full titles ---------------------
        //        var fulltitles = "";
        ...
        //        //------------------ for full IPA ---------------------
        //        //var fullipa = "";
        //        //for (var j in $scope.data[i].ContractInfoes.ContractGroupInfoes) {
        //        //    if (j > 0) {
        //        //        fullipa += ", ";
        //        //    }
        //        //    fullipa += $scope.data[i].ContractInfoes.ContractGroupInfoes[j].PracticingGroup.Group.Name;
        //        //}
        //        //$scope.data[i].FullIPA = fullipa;
        //        //------------------ for full Specialty ---------------------
        //       var fullspecialty = "";
        //       for (var j in $scope.data[i].SpecialtyDetail.Specialty) {
        //           if (j > 0) {
        //               fullspecialty += ", ";
        //           }
        //           fullspecialty += $scope.data[i].SpecialtyDetail.Specialty[j].Name;
        //       }
        //       $scope.data[i].FullSpecialty = fullspecialty;
        //        //-------------- for full relations ---------------
        //        var fullrelations = "";
        ...
        //        $scope.data[i].FirstName = $scope.data[i].Profile.PersonalDetail.FirstName;  //set the data from nested obj into new property
        //        $scope.data[i].LastName = $scope.data[i].Profile.PersonalDetail.LastName;
        //        $scope.data[i].NPINumber = $scope.data[i].Profile.OtherIdentificationNumber.NPINumber;
        //        $scope.data[i].CAQH = $scope.data[i].Profile.OtherIdentificationNumber.CAQHNumber;
        //        $scope.data[i].ProfilePhotoPath = $scope.data[i].Profile.ProfilePhotoPath;
        //        //------------------ for full titles ---------------------
        //        var fulltitles = "";
        //        for (var j in $scope.data[i].Profile.PersonalDetail.ProviderTitles) {
        //            if (j > 0) {
        //                fulltitles += ", ";
        //            }
        //            fulltitles += $scope.data[i].Profile.PersonalDetail.ProviderTitles[j].ProviderType.Title;
        //        }
        //        $scope.data[i].FullTitles = fulltitles;
        //        //------------------ for full IPA ---------------------
        //        //var fullipa = "";
        ...
        //        //-------------- for full relations ---------------
        //        var fullrelations = "";
        //        for (var j in $scope.data[i].Profile.ContractInfoes) {
        //            if (j > 0) {
        //                fullrelations += ", ";
        //            }
        //            fullrelations += $scope.data[i].Profile.ContractInfoes[j].ProviderRelationship;
        //        }
        //        $scope.data[i].FullRelations = fullrelations;
        //    }
        //}
    ...
    $scope.findIsDelegated = function (id) {
        for (i = 0; i < $scope.plans.length;i++) {
            if ($scope.plans[i].PlanID == id) {
                $scope.tempObject.IsDelegated = $scope.plans[i].IsDelegated;
            }
        }
    };
    ...
    $scope.InitiateCredentialing = function () {
        var obj = {
            ...
            IsDelegated: $scope.tempObject.IsDelegated,
            StatusType: 1
        };
