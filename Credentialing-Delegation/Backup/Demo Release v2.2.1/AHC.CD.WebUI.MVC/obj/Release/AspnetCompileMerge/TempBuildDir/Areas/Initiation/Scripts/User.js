...
userApp.controller("userController", ['$scope', '$timeout', '$http', 'messageAlertEngine', '$filter', function ($scope, $timeout, $http, messageAlertEngine, $filter) {
    ...
    $scope.addUser = function (user) {
        ...
        if (validationStatus)
        {
            ...
            $http.post('/Initiation/InitiateUser/Index', user).
