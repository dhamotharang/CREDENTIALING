...
namespace AHC.CD.Business
{
    public interface IProfileManager
    {
        ...
        Task<IEnumerable<string>> GetAllProviderLevelByProfileId(int profileID);
        #endregion
        ...
        Task UpdateSpecialtyDetailAsync(int profileId, SpecialtyDetail specialtyDetail, DocumentDTO document);
