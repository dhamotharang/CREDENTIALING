...
namespace AHC.CD.Business
{
    ...
    {        
        ...
        public async Task<Profile> GetByIdAsync(int profileId)
        {
            try
            {
                var includeProperties = new string[]
                {
                    ...
                    "PracticeLocationDetails.MidlevelPractioners.Profile.PersonalDetail",
                    "PracticeLocationDetails.MidlevelPractioners.Profile.OtherIdentificationNumber",
                ...
                {
                    item.MidlevelPractioners = item.MidlevelPractioners.Where(x=>x.Status.Equals(StatusType.Active.ToString())).ToList();
                }
        ...
        public async Task<IEnumerable<string>> GetAllProviderLevelByProfileId(int profileID)
        {
            try
            {
                var providerLevels = from provider in await profileRepository.GetAllAsync("PersonalDetail.ProviderTitles.ProviderType.ProviderLevel")
                                     from titles in provider.PersonalDetail.ProviderTitles.Where(p => p != null)
                                     where provider.ProfileID == profileID
                                     select titles.ProviderType.ProviderLevel.Name;

                return providerLevels.ToList<string>();
        ...
        public async Task UpdateContactDetailAsync(int profileId, Entities.MasterProfile.Demographics.ContactDetail contactDetail)
        {
            try
            {
                ...
                {
                    if (phoneDetails.Any(h => h.PhoneDetailID != item.PhoneDetailID && h.PhoneNumber.Equals(item.PhoneNumber)))
        ...
        private static void DuplicateNumber(PhoneDetail item)
        {
            switch (item.PhoneTypeEnum)
            {
                ...
                case PhoneTypeEnum.Mobile:
                    throw new DuplicateMobileNumberException(String.Format(ExceptionMessage.FAX_NUMBER_EXISTS_EXCEPTION, item.PhoneNumber));
                default:
                    break;
            }
        }
        ...
        //    public async Task<int> AddPracticeLocationAsync(int profileId, PracticeLocationDetail practiceLocationDetail)
        //{
        //    try
        //    {               
                
        //        //Add practice location information
        //        profileRepository.AddPracticeLocation(profileId, practiceLocationDetail);

        //        //save the information in the repository
        //        await profileRepository.SaveAsync();

        //        return practiceLocationDetail.PracticeLocationDetailID;
        //    }
        //    catch (ApplicationException)
        //    {
        //        throw;
        ...
        //    catch (Exception ex)
        //    {
        //        throw new ProfileManagerException(ExceptionMessage.PRACTICE_LOCATION_CREATE_EXCEPTION, ex);
        //    }
        //}

        //public async Task UpdateOfficeManagerAsync(int profileId, Entities.MasterProfile.PracticeLocation.BusinessOfficeContactPerson officemanager)
        //{
        //    try
        //    {
        //        //Update office manager details
        //        profileRepository.UpdateOfficeManager(profileId, officemanager);
        ...
        //    catch (Exception ex)
        //    {
        //        throw new ProfileManagerException(ExceptionMessage.OFFICE_MANAGER_UPDATE_EXCEPTION, ex); 
        //    }
        //}

        //public async Task UpdateWorkersCompensationInformationAsync(int profileId, Entities.MasterProfile.PracticeLocation.WorkersCompensationInformation workersCompensationInformation)
        //{
        //    try
        //    {
        //        //Update worker compensation details
        //        profileRepository.UpdateWorkersCompensationInformation(profileId, workersCompensationInformation);
        ...
        //    catch (Exception ex)
        //    {
        //        throw new ProfileManagerException(ExceptionMessage.WORKER_COMPENSATION_UPDATE_EXCEPTION, ex);
        //    }
        //}

        //public async Task UpdateOpenPracticeStatusAsync(int profileId, Entities.MasterProfile.PracticeLocation.OpenPracticeStatus openPracticeStatus)
        //{
        //    try
        //    {
        //        //Update open practice status details
        //        profileRepository.UpdateOpenPracticeStatus(profileId, openPracticeStatus);
        ...
        //    catch (Exception ex)
        //    {
        //        throw new ProfileManagerException(ExceptionMessage.OPEN_PRACTICE_UPDATE_EXCEPTION, ex);
        //    }
        //}

        //public async Task UpdateAccessibilitiesAsync(int profileId, Entities.MasterProfile.PracticeLocation.PracticeAccessibility practiceAccessibility)
        //{
        //    try
        //    {
        //        //Update open practice status details
        //        profileRepository.UpdateAccessibilities(profileId, practiceAccessibility);
        ...
        //    catch (Exception ex)
        //    {
        //        throw new ProfileManagerException(ExceptionMessage.ACCESSIBILITIES_UPDATE_EXCEPTION, ex);
        //    }
        //}
