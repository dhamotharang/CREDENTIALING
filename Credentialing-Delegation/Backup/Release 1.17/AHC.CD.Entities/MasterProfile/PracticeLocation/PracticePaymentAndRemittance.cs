...
{
    public class PracticePaymentAndRemittance
    {
        public PracticePaymentAndRemittance()
        {
        ...
        //[ForeignKey("PaymentAndRemittancePersonId")]

        public Employee PaymentAndRemittancePerson { get; set; }
