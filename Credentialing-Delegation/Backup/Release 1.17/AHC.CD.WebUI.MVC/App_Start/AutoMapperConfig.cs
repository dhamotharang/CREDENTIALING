...
namespace AHC.CD.WebUI.MVC.App_Start
{
    public class AutoMapperConfig
    {
        public static void Configure()
        {
            ...
            Mapper.CreateMap<Employee, Employee>().ForMember(dto => dto.Departments, opt => opt.Ignore()); 
            Mapper.CreateMap<Employee, Employee>().ForMember(dto => dto.Designations, opt => opt.Ignore());
