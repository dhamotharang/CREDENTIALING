...
namespace AHC.CD.WebUI.MVC.Areas.Profile.Models.ProfessionalReference
{
    public class ProfessionalReferenceViewModel
    {
        ...
        [RegularExpression(RegularExpression.FOR_ALPHABETS_SPACE_COMMA_HYPHEN, ErrorMessage = "Please enter valid First Name. Only alphabets, space, comma and hyphen accepted")]
        public string FirstName { get; set; }

        [Display(Name="Middle Name ")]
        [RegularExpression(RegularExpression.FOR_ALPHABETS_SPACE_COMMA_HYPHEN, ErrorMessage = "Please enter valid Middle Name. Only alphabets, space, comma, hyphen accepted")]
        ...
        [RegularExpression(RegularExpression.FOR_ALPHABETS_SPACE_COMMA_HYPHEN, ErrorMessage = "Please enter valid Last Name. Only alphabets, space, comma, hyphen accepted")]
