...
namespace AHC.CD.WebUI.MVC.Areas.Profile.Models.Demographic
{
    public class PersonalIdentificationViewModel
    {
        ...
        //[Required(ErrorMessage = ValidationErrorMessage.REQUIRED_ENTER)]
        [RegularExpression(RegularExpression.FOR_ALPHABETS_NUMBER_HYPHEN_FRWD_SLASH_DOT, ErrorMessage = ValidationErrorMessage.CHARACTERS_ONLY_ALPHABETS_NUMBERS_HYPHEN_FRWD_SLASH_DOT)]
