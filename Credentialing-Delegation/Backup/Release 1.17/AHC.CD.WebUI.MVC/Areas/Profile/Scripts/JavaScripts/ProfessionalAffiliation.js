...
profileApp.controller('professionalAppCtrl', ['$scope', '$rootScope', '$http', 'masterDataService', 'messageAlertEngine', function ($scope, $rootScope, $http, masterDataService, messageAlertEngine) {
