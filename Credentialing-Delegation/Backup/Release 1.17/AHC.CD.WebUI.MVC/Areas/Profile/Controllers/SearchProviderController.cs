...
namespace AHC.CD.WebUI.MVC.Areas.Profile.Controllers
{
    public class SearchProviderController : Controller
    {
        ...
        public JsonResult SearchProviderJson(SearchProviderViewModel search)
        {
            ...
            searchResults = searchManager.SearchProviderProfileForViewEdit(search.NPINumber, search.FirstName, search.LastName, search.ProviderRelationship, search.IPAGroupName);
