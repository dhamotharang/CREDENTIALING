        ...
        public async Task Seed()
        {
            try
            {
                ...
                context.ProviderLevels.AddRange(new List<ProviderLevel>
                {
                    ...
                    new ProviderLevel{Name="Supervisor", StatusType= StatusType.Active},
                    new ProviderLevel{Name="Not Available", StatusType= StatusType.Active}
                });
                ...
                var midLevel = context.ProviderLevels.Where(p => p.Name.Equals("Mid-Level")).FirstOrDefault();
                var supervisor = context.ProviderLevels.Where(p => p.Name.Equals("Supervisor")).FirstOrDefault();
                var NA = context.ProviderLevels.Where(p => p.Name.Equals("Not Available")).FirstOrDefault();

                context.ProviderTypes.AddRange(new List<ProviderType>
                {
                    new ProviderType{Title = "Medical Doctor", Code="MD", ProviderLevel=supervisor , StatusType=StatusType.Active},
                    new ProviderType{Title = "Doctor of Dental Surgery", Code="DDS",ProviderLevel=supervisor, StatusType=StatusType.Active},
                    new ProviderType{Title = "Doctor of Dental Medicine", Code="DMD", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Doctor of Podiatric Medicine", Code="DPM", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Doctor of Chiropractic", Code="DC", ProviderLevel=NA,StatusType=StatusType.Active},
                    new ProviderType{Title = "Osteopathic Doctor", Code="DO", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Acupuncturist",  ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Audiologist", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Biofeedback Technician", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Certified Registered Nurse Anaesthetist", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Christian Science Practitioner", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Clinical Nurse Specialist", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Clinical Psychologist", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Clinical Social Worker", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Dietician", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Licensed Practical Nurse", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Marriage/Family Therapist", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Massage Therapist", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Naturopath", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Neuropsychologist", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Midwife", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Nurse Midwife", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Nurse Practitioner", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Nutritionist", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Occupational Therapist", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Optician", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Optometrist", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Pharmacist", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Physical Therapist", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Physician Assistant", ProviderLevel=midLevel ,StatusType=StatusType.Active},
                    new ProviderType{Title = "Professional Counsellor", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Registered Nurse", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Registered Nurse First Assistant", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Respiratory Therapist", ProviderLevel=NA, StatusType=StatusType.Active},
                    new ProviderType{Title = "Speech Pathologist", ProviderLevel=NA, StatusType=StatusType.Active}
                });
