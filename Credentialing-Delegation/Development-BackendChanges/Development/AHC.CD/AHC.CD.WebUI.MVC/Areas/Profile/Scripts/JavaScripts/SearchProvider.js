...
providerapp.controller('ProviderCtrl', function ($scope, $http, $location, $filter, ngTableParams, messageAlertEngine) {
    ...
    //For Advance Search ajax call
    $scope.new_Advance_Search = function () {
        $scope.data = [];
        $scope.error_message = "";
        ...
        $http({
            method: "POST",
            url: rootDir + "/SearchProvider/AdvancedSearchProviderJson?search=" + $scope.advancedSearch,
    ...
    $scope.new_search = function () {
        ...
        $http({
            method: "POST",
            url: rootDir + "/SearchProvider/SearchProviderJson",
            data: {
