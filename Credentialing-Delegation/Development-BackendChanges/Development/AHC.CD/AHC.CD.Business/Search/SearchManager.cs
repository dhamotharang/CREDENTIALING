    ...
    internal class SearchManager : ISearchManager
    {
        ...
        public List<ProviderSearchResultDTO> SearchProviderProfileForViewEdit(string NPINumber = null, string firstName = null, string lastName = null, string providerRelationship = null, string IPAGroupName = null, string providerLevel = null, string providerType = null)
        {
            ...
            try
            {
                ...
                {
                    var providerSearchResult = from provider in profileRepository.GetAll(includeProperties)
                                               where provider.ContractInfoes.Any(ci => ci.ProviderRelationship.ToLower().Contains(providerRelationship.ToLower()) && ci.ContractStatusOption == AHC.CD.Entities.MasterData.Enums.ContractStatus.Accepted && provider.Status == AHC.CD.Entities.MasterData.Enums.StatusType.Active.ToString())
                                                && provider.Status != AHC.CD.Entities.MasterData.Enums.StatusType.Inactive.ToString()
                                               select ConstructProviderSearchResult(provider);
                ...
                {
                    var providerSearchResult = from provider in profileRepository.GetAll(includeProperties)
                                               where provider.ContractInfoes.Any(ci => ci.ContractGroupInfoes.Any(cgi => cgi.PracticingGroup.Group.Name.ToLower().Contains(IPAGroupName.ToLower())) && ci.ContractStatusOption == AHC.CD.Entities.MasterData.Enums.ContractStatus.Accepted && provider.Status == AHC.CD.Entities.MasterData.Enums.StatusType.Active.ToString())
                                                && provider.Status != AHC.CD.Entities.MasterData.Enums.StatusType.Inactive.ToString()
                                               select ConstructProviderSearchResult(provider);
                ...
                {
                    var providerSearchResult = from provider in profileRepository.GetAll(includeProperties)
                                               where provider.PersonalDetail.ProviderLevel.Name.ToLower().Contains(providerLevel.ToLower())
                                                && provider.Status != AHC.CD.Entities.MasterData.Enums.StatusType.Inactive.ToString()
                                               select ConstructProviderSearchResult(provider);
                ...
                {
                    var providerSearchResult = from provider in profileRepository.GetAll(includeProperties)
                                               where provider.PersonalDetail.ProviderTitles.Any(ci => ci.ProviderType.Title.ToLower().Contains(providerType.ToLower()))
                                                && provider.Status != AHC.CD.Entities.MasterData.Enums.StatusType.Inactive.ToString()
                                               select ConstructProviderSearchResult(provider);
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
        public List<ProviderSearchResultDTO> SearchProviderProfileForViewEditByAnyValue(string AdvancedSearch = null)
        {
            //string includeProperties = "OtherIdentificationNumber,PersonalDetail.ProviderTitles.ProviderType,PersonalDetail.ProviderLevel,ContractInfoes.ContractGroupInfoes.PracticingGroup.Group";
            List<ProviderSearchResultDTO> result=new List<ProviderSearchResultDTO>();
            //bool Found=false;
            string[] SearchParameters = { null, null, null, null, null, null, null };//7 parameters for the "SearchProviderProfileForViewEdit" function
            try
            {

                for (int i = 0; i < 7 && !result.Any(); i++)//Iterating for different parameters And Calling the "SearchProviderProfileForViewEdit" Funtion
                {
                    SearchParameters[i] = AdvancedSearch;  //changing the position of the string searched in Advanced Search Option
                    if (i != 0)
                    { SearchParameters[i - 1] = null; }    //Making Previous Parameters Null
                    result = SearchProviderProfileForViewEdit(SearchParameters[0], SearchParameters[1], SearchParameters[2], SearchParameters[3], SearchParameters[4], SearchParameters[5], SearchParameters[6]);//Calling the "SearchProviderProfileForViewEdit" function
                ...
                //{
                              ...
                              ////var profiles = profileRepository.Get(_ => 1 == 1, "OtherIdentificationNumber").Where(p => p.OtherIdentificationNumber.NPINumber.Equals(NPINumber));
                              ////var npi = profiles.First().OtherIdentificationNumber.NPINumber;
                              //var npi = profiles.Any(a => a.OtherIdentificationNumber.NPINumber.Equals(AdvancedSearch) && a.Status != AHC.CD.Entities.MasterData.Enums.StatusType.Inactive.ToString());
                              ////if (string.IsNullOrWhiteSpace(npi) && npi != NPINumber)
                              //if (npi)
                              //    Found=true;
                              ////var providerSearchResult = (from provider in profileRepository.Get(_ => 1 == 1, includeProperties)
                              ...
                              //{
                              //   var providerSearchResult = (from provider in profiles
                              //                               where provider.OtherIdentificationNumber.NPINumber.Equals(AdvancedSearch)
               ...
               //                  var providerSearchResult = from provider in profileRepository.GetAll(includeProperties)
               //                                             where provider.PersonalDetail.LastName.ToLower().Contains(AdvancedSearch.ToLower())
               //                                              && provider.Status != AHC.CD.Entities.MasterData.Enums.StatusType.Inactive.ToString()
               //                                             select ConstructProviderSearchResult(provider);
                                 
               //                  //return providerSearchResult.ToList<ProviderSearchResultDTO>();
               //                  result = providerSearchResult.ToList<ProviderSearchResultDTO>();
               //                  if (result.Any())
               //                  { Found = true;  }
               ...
               //                    var providerSearchResult = from provider in profileRepository.GetAll(includeProperties)
               //                                               where provider.PersonalDetail.FirstName.ToLower().Contains(AdvancedSearch.ToLower())
               //                                                && provider.Status != AHC.CD.Entities.MasterData.Enums.StatusType.Inactive.ToString()
               //                                               select ConstructProviderSearchResult(provider);
               ...
               //                     var providerSearchResult = from provider in profileRepository.GetAll(includeProperties)
               //                                                where provider.ContractInfoes.Any(ci => ci.ProviderRelationship.ToLower().Contains(AdvancedSearch.ToLower()) && ci.ContractStatusOption == AHC.CD.Entities.MasterData.Enums.ContractStatus.Accepted && provider.Status == AHC.CD.Entities.MasterData.Enums.StatusType.Active.ToString())
               //                                                 && provider.Status != AHC.CD.Entities.MasterData.Enums.StatusType.Inactive.ToString()
               //                                                select ConstructProviderSearchResult(provider);
               ...
               //                     var providerSearchResult = from provider in profileRepository.GetAll(includeProperties)
               //                                                where provider.ContractInfoes.Any(ci => ci.ContractGroupInfoes.Any(cgi => cgi.PracticingGroup.Group.Name.ToLower().Contains( AdvancedSearch.ToLower())) && ci.ContractStatusOption == AHC.CD.Entities.MasterData.Enums.ContractStatus.Accepted && provider.Status == AHC.CD.Entities.MasterData.Enums.StatusType.Active.ToString())
               //                                                 && provider.Status != AHC.CD.Entities.MasterData.Enums.StatusType.Inactive.ToString()
               //                                                select ConstructProviderSearchResult(provider);
               ...
               //                      var providerSearchResult = from provider in profileRepository.GetAll(includeProperties)
               //                                                where provider.PersonalDetail.ProviderLevel.Name.ToLower().Contains(AdvancedSearch.ToLower())
               //                                                 && provider.Status != AHC.CD.Entities.MasterData.Enums.StatusType.Inactive.ToString()
               //                                                select ConstructProviderSearchResult(provider);
               ...
               //                      var providerSearchResult = from provider in profileRepository.GetAll(includeProperties)
               //                                                  where provider.PersonalDetail.ProviderTitles.Any(ci => ci.ProviderType.Title.ToLower().Contains( AdvancedSearch.ToLower()))
               //                                                   && provider.Status != AHC.CD.Entities.MasterData.Enums.StatusType.Inactive.ToString()
               //                                                  select ConstructProviderSearchResult(provider);
