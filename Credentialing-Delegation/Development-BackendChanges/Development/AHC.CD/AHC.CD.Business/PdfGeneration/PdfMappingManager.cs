...
namespace AHC.CD.Business.PdfGeneration
{
    internal class PdfMappingManager : IPdfMappingManager
    {
        ...
        private Profile GetProfileObject(int profileID)
        {
            try
            {
                profileId = profileID;
        ...
        public string GeneratePlanFormPDF(int profileId, string templateName, string UserAuthId)
        {
            Profile profile = GetProfileObject(profileId);
            ...
            if (profile.PracticeLocationDetails.Count > 0)
            {
                if (profile.PracticeLocationDetails.ElementAt(profile.PracticeLocationDetails.Count - 1).OfficeHour != null)
                {
                    if (profile.PracticeLocationDetails.ElementAt(profile.PracticeLocationDetails.Count - 1).OfficeHour.PracticeDays.Count > 0 && profile.PracticeLocationDetails.ElementAt(profile.PracticeLocationDetails.Count - 1).OfficeHour.PracticeDays.First().DailyHours.Count > 0)
                    {
                        ...
                        pmodel.OfficeHour_StartMonday1 = profile.PracticeLocationDetails.ElementAt(profile.PracticeLocationDetails.Count - 1).OfficeHour.PracticeDays.ElementAt(0).DailyHours.First().StartTime;
                        ...
                        pmodel.OfficeHour_StartTuesday1 = profile.PracticeLocationDetails.ElementAt(profile.PracticeLocationDetails.Count - 1).OfficeHour.PracticeDays.ElementAt(1).DailyHours.First().StartTime;
                        ...
                        pmodel.OfficeHour_StartWednesday1 = profile.PracticeLocationDetails.ElementAt(profile.PracticeLocationDetails.Count - 1).OfficeHour.PracticeDays.ElementAt(2).DailyHours.First().StartTime;
                        ...
                        pmodel.OfficeHour_StartThursday1 = profile.PracticeLocationDetails.ElementAt(profile.PracticeLocationDetails.Count - 1).OfficeHour.PracticeDays.ElementAt(3).DailyHours.First().StartTime;
                        ...
                        pmodel.OfficeHour_StartFriday1 = profile.PracticeLocationDetails.ElementAt(profile.PracticeLocationDetails.Count - 1).OfficeHour.PracticeDays.ElementAt(4).DailyHours.First().StartTime;
                        ...
                        pmodel.OfficeHour_StartSaturday1 = profile.PracticeLocationDetails.ElementAt(profile.PracticeLocationDetails.Count - 1).OfficeHour.PracticeDays.ElementAt(5).DailyHours.First().StartTime;
                        ...
                        pmodel.OfficeHour_StartSunday1 = profile.PracticeLocationDetails.ElementAt(profile.PracticeLocationDetails.Count - 1).OfficeHour.PracticeDays.ElementAt(6).DailyHours.First().StartTime;
        ...
        public string CombinePdfs(int profileID, List<string> pdflist, string UserAuthId)
        {
            profileId = profileID;
            ...
            writer.Close();
            document.Close();
            SaveGeneratedPackage(profileID, "Generated Package", "\\ApplicationDocument\\GeneratedPackagePdf\\" + outputFileName, CDUserId);
            return outputFileName;

        }


        public List<PackageGeneratorBusinessModel> GenerateBulkPackage(List<int> ProfileIDs, List<string> GenricList, string UserAuthId)
        {
            var profileRepo = uow.GetGenericRepository<Profile>();
            ...
            foreach (var id in ProfileIDs)
            {
                if (id != 0)
                {
                    ...
                    string GeneratedPackagePath = CombinePdfs(id, pdfList, UserAuthId);
        ...
        public List<PlanFormGenerationBusinessModel> GenerateBulkForm(List<int> ProfileIDs, List<string> templateNames, string UserAuthId)
        {
                ...
                if (id != 0)
                {
                    ...
                    foreach (var template in templateNames)
                    {
                        ...
                        {   
                            ...
                            string filePath = "\\ApplicationDocument\\GeneratedTemplatePdf\\"+GeneratePlanFormPDF(id, template, UserAuthId);
