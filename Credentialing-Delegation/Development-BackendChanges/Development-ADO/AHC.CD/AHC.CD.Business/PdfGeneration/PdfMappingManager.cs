    ...
    internal class PdfMappingManager : IPdfMappingManager
    {
        ...
        private string readXml(PDFMappingDataBusinessModel pmodel, string templateName)
        {
            try
            {
                ...
                string fileName = pmodel.Personal_ProviderName + "_" + templateName + "_" + date;
        ...
        public string GeneratePlanFormPDF(int profileId, string templateName)
        {
            ...
            if (profile.LanguageInfo != null && profile.LanguageInfo.KnownLanguages != null)
            {
            ...
            if (profile.OtherLegalNames.Count > 0 && profile.OtherLegalNames != null)
            {
                ...
                pmodel.OtherLegalName_StartDate1 = profile.OtherLegalNames.ElementAt(otherLegalNameCount - 1).StartDate.ToString();
                pmodel.OtherLegalName_EndDate1 = profile.OtherLegalNames.ElementAt(otherLegalNameCount - 1).EndDate.ToString();
            ...
            if (profile.HomeAddresses.Count > 0)
            {
                ...
                pmodel.Personal_LivingStartDate1 = profile.HomeAddresses.ElementAt(homeCount - 1).LivingFromDate.ToString();
                pmodel.Personal_LivingEndDate1 = profile.HomeAddresses.ElementAt(homeCount - 1).LivingEndDate.ToString();
            }
            ...
            if (profile.ContactDetail != null)
            {
                if (profile.ContactDetail.PhoneDetails.Count > 0)
                {
                    ...
                    pmodel.Personal_HomePhone1 = profile.ContactDetail.PhoneDetails.Last().PhoneNumber.ToString();
                    pmodel.Personal_HomeFax1 = profile.ContactDetail.PhoneDetails.Last().PhoneNumber;
                    pmodel.Personal_EmailId1 = profile.ContactDetail.EmailIDs.Last().EmailAddress.ToString();
                }
            }
            ...
            if (profile.VisaDetail != null)
            {
                ...
                if (profile.VisaDetail.VisaInfo != null)
                {
                    ...
                    pmodel.Personal_VisaExpiration = profile.VisaDetail.VisaInfo.VisaExpirationDate.ToString();
            ...
            if (profile.SpecialtyDetails.Count > 0)
            {
                ...
                if (primaryInfo != null)
                {
                    ...
                    if (primaryInfo.SpecialtyBoardCertifiedDetail != null && primaryInfo.SpecialtyBoardCertifiedDetail.SpecialtyBoard != null)
                    {
                    ...
                    if (secondaryInfo.Count > 0)
                    {
                        ...
                        if (secondaryInfo.ElementAt(secondaryCount - 1).SpecialtyBoardCertifiedDetail != null && secondaryInfo.ElementAt(secondaryCount - 1).SpecialtyBoardCertifiedDetail.SpecialtyBoard != null)
                        {
            ...
            if (profile.PracticeLocationDetails.Count > 0)
            {
                ...
                if (practiceLocation.Count > 0 && practiceLocation[practiceLocationCount - 1] != null)
                {
                    ...
                    {
                        pmodel.General_PracticeLocationAddress1 = practiceLocation[practiceLocationCount - 1].Facility.Street + ", " + practiceLocation[practiceLocationCount - 1].Facility.City + ", " + practiceLocation[practiceLocationCount - 1].Facility.State + ", " + practiceLocation[practiceLocationCount - 1].Facility.ZipCode + ", " + practiceLocation[practiceLocationCount - 1].Facility.Country;
                        pmodel.General_Phone1 = practiceLocation[practiceLocationCount - 1].Facility.MobileNumber;
                        pmodel.General_Email1 = practiceLocation[practiceLocationCount - 1].Facility.EmailAddress;
                        pmodel.General_Fax1 = practiceLocation[practiceLocationCount - 1].Facility.FaxNumber;
                    ...
                    if (practiceLocation[practiceLocationCount - 1].BillingContactPerson != null)
                    {
                        ...
                        pmodel.BillingContact_Email1 = practiceLocation[0].BillingContactPerson.EmailAddress;
                        pmodel.BillingContact_Phone1 = practiceLocation[0].BillingContactPerson.MobileNumber;
                        pmodel.BillingContact_Fax1 = practiceLocation[0].BillingContactPerson.FaxNumber;
                    ...
                    {
                        //pmodel.OfficeHour_IsReuseInformation1=practiceLocation[practiceLocationCount - 1].OfficeHour.i
                    }
                ...
                if (practiceLocation.Count > 1 && practiceLocation[practiceLocationCount - 2] != null)
                {
                    ...
                    {
                        pmodel.General_PracticeLocationAddress2 = practiceLocation[practiceLocationCount - 2].Facility.Street + ", " + practiceLocation[practiceLocationCount - 2].Facility.City + ", " + practiceLocation[practiceLocationCount - 2].Facility.State + ", " + practiceLocation[practiceLocationCount - 2].Facility.ZipCode + ", " + practiceLocation[practiceLocationCount - 2].Facility.Country;
            ...
            if (profile.FederalDEAInformations.Count > 0)
            {
                ...
                if (federalDEAInformations.ElementAt(federalDEAInformationCount - 1) != null)
                {
                    ...
                    pmodel.DEA_IssueDate1 = federalDEAInformations.ElementAt(federalDEAInformationCount - 1).IssueDate.ToString();
                    pmodel.DEA_ExpirationDate1 = federalDEAInformations.ElementAt(federalDEAInformationCount - 1).ExpiryDate.ToString();
            ...
            if (profile.CDSCInformations.Count > 0)
            {
                ...
                if (profile.CDSCInformations.ElementAt(CDSCInformationsCount - 1) != null)
                {
                    ...
                    pmodel.CDS_IssueDate1 = profile.CDSCInformations.ElementAt(CDSCInformationsCount - 1).IssueDate.ToString();
                    pmodel.CDS_ExpirationDate1 = profile.CDSCInformations.ElementAt(CDSCInformationsCount - 1).ExpiryDate.ToString();
            ...
            if (profile.EducationDetails.Count > 0)
            {
                ...
                if (educationDetails.ElementAt(educationDetailsCount - 1) != null && educationDetails.ElementAt(educationDetailsCount - 1).SchoolInformation != null)
                {
                    ...
                    pmodel.UnderGraduation_StartDate1 = educationDetails.ElementAt(educationDetailsCount - 1).StartDate.ToString();
                    pmodel.UnderGraduation_EndDate1 = educationDetails.ElementAt(educationDetailsCount - 1).EndDate.ToString();
            ...
            if (profile.EducationDetails.Count > 0)
            {
                ...
                if (educationDetails.ElementAt(educationDetailsCount - 1) != null && educationDetails.ElementAt(educationDetailsCount - 1).SchoolInformation != null)
                {
                    ...
                    pmodel.Graduation_StartDate1 = educationDetails.ElementAt(educationDetailsCount - 1).StartDate.ToString();
                    pmodel.Graduation_EndDate1 = educationDetails.ElementAt(educationDetailsCount - 1).EndDate.ToString();
            ...
            if (profile.ECFMGDetail != null)
            {
                ...
                pmodel.ECFMG_IssueDate = profile.ECFMGDetail.ECFMGIssueDate.ToString();
            ...
            if (profile.TrainingDetails.Count > 0)
            {
                ...
                if (trainingDetails.ElementAt(trainingDetailsCount - 1) != null && trainingDetails.ElementAt(trainingDetailsCount - 1).SchoolInformation != null)
                {
                    ...
                    pmodel.TrainingProgram_StartDate1 = trainingDetails.ElementAt(trainingDetailsCount - 1).StartDate.ToString();
                    pmodel.TrainingProgram_EndDate1 = trainingDetails.ElementAt(trainingDetailsCount - 1).EndDate.ToString();
                ...
                if (primaryHospitalInfo != null)
                {
                    ...
                    if (secondaryHospitalInfo.Count > 0)
                    {
                        if (secondaryHospitalInfo.ElementAt(secondaryHospitalCount - 1) != null && secondaryHospitalInfo.ElementAt(secondaryHospitalCount - 1).Hospital != null )
                        {
                            ...
                            pmodel.HospitalPrivilege_StartDate1 = secondaryHospitalInfo.ElementAt(secondaryHospitalCount - 1).AffilicationStartDate.ToString();
                            pmodel.HospitalPrivilege_HospitalStatus1 = secondaryHospitalInfo.ElementAt(secondaryHospitalCount - 1).Hospital.Status;
                            pmodel.HospitalPrivilege_EndDate1 = secondaryHospitalInfo.ElementAt(secondaryHospitalCount - 1).AffiliationEndDate.ToString();
                            ...
                            pmodel.HospitalPrivilege_AffiliationStartDate1 = secondaryHospitalInfo.ElementAt(secondaryHospitalCount - 1).AffilicationStartDate.ToString();
                            pmodel.HospitalPrivilege_AffiliationEndDate1 = secondaryHospitalInfo.ElementAt(secondaryHospitalCount - 1).AffiliationEndDate.ToString();
            ...
            if (profile.ProfessionalLiabilityInfoes.Count > 0)
            {
                ...
                if (professionalLiabilities.ElementAt(professionalLiabilitiesCount - 1) != null && professionalLiabilities.ElementAt(professionalLiabilitiesCount - 1).InsuranceCarrier != null)
                {
                ...
                pmodel.ProfLiability_OriginalEffectiveDate1 = professionalLiabilities.ElementAt(professionalLiabilitiesCount - 1).OriginalEffectiveDate.ToString();
                pmodel.ProfLiability_EffectiveDate1 = professionalLiabilities.ElementAt(professionalLiabilitiesCount - 1).EffectiveDate.ToString();
                pmodel.ProfLiability_ExpiryDate1 = professionalLiabilities.ElementAt(professionalLiabilitiesCount - 1).ExpirationDate.ToString();
                ...
                if (professionalLiabilities.ElementAt(professionalLiabilitiesCount - 1) != null && professionalLiabilities.ElementAt(professionalLiabilitiesCount - 1).InsuranceCarrierAddress != null)
                {
