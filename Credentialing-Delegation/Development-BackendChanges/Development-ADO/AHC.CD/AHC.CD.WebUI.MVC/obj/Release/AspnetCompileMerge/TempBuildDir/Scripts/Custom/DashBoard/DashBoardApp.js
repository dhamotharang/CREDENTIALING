...
dashBoardApp.controller("GraphController", function ($scope, $http) {
    ...
    function getOccupationData(providerType) {
        ...
        $http.get(rootDir + '/Dashboard/GetProviderOccupationData?providerType=' + providerType + "&ProviderRelation=" + $scope.SelectedRelationId + "&year=" + $scope.selectedYear).success(function (recData) {
            $scope.pieReady = true;
            $scope.progressbar = false;
            barData = [];
            var tempObj = {};
    ...
    function getProviderTypesData() {
        $scope.progressbar = true;
        $http.get(rootDir + '/Dashboard/GetProviderTypesGraphData').success(function (recData) {
            $scope.progressbar = false;
            data = recData;
    ...
    $scope.updatePie = function () {
        $scope.progressbar = true;
        $http.get(rootDir + '/Dashboard/GetProviderTypesGraphData?ProviderRelation=' + $scope.SelectedRelationId).success(function (recData) {
