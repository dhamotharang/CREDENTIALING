                ...
                for (var i = 0; i < Docs.length; i++) {
                    ...
                    if (Docs != null) {
                        ...
                        for (var j = 0; j < Docs.length; j++) {
                            ...
                            if (Docs[j].CredentialingAppointmentDetail != null && Docs[i].CredentialingAppointmentDetail.Status == "Active") {

                                if (Docs[j].CredentialingAppointmentDetail != null && Docs[j].CredentialingAppointmentDetail.FileUploadPath != null) {
