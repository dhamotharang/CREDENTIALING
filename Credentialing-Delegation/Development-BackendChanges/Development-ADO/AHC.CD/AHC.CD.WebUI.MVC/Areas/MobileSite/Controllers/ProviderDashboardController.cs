...
namespace AHC.CD.WebUI.MVC.Areas.MobileSite.Controllers
{
    public class ProviderDashboardController : Controller
    {
        ...
        public ProviderDashboardController(IExpiryNotificationManager expiryNotification, IProfileManager profileManager, IUserManager userManager)
	    {
        ...
        public async Task<ActionResult> ProviderControllerMobile()
        {
            try
            {
