...
namespace AHC.CD.WebUI.MVC.Areas.Credentialing.Controllers
{
    public class CnDController : Controller
    {
        ...
        public CnDController(IMasterDataManager masterDataManager, ICredentialingContractManager credentialingContractManager, IChangeNotificationManager notificationManager, IApplicationManager applicationManager, IApplicationRepositoryManager formManager, IProfileManager profileManager, IAppointmentManager appointmentManager,IPlanManager planManager, IErrorLogger errorLogger)
        {
        ...
        {
            var data = await credentialingContractManager.GetAllContractGrid();
            return JsonConvert.SerializeObject(data);
        }
        ...
        public async Task<JsonResult> SaveReport(ContractGridViewModel contractGrid)
        {
            ...
            try
            {
                ...
                dataContractGrid = await credentialingContractManager.AddContractInfoFromPlan(dataContractGrid, welcomeLetterDocument, UserAuthId);
            }
            catch (Exception ex)
            {
                throw ex;
