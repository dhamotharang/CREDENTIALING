...
namespace AHC.CD.WebUI.MVC.Areas.Credentialing.Controllers
{
    public class CCMController : Controller
    {
        ...
        public CCMController(IAppointmentManager appointmentManager, IChangeNotificationManager notificationManager, IApplicationManager applicationManager, IProfileManager profileManager)
        {
