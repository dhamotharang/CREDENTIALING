...
namespace AHC.CD.Resources.Messages
{
    public static class ExceptionMessage
    {
        ...
        #region Profile
        public static string PROFILE_NOT_FOUND_ForEmail = "Profile not found with the given Credentials"; 
        ...
        public static string PROFILE_SUBSECTION_MASTER_DATA_ADD_EXCEPTION = "Sorry Unable To Add Profile Sub Section";
        public static string PROFILE_SUBSECTION_MASTER_DATA_UPDATE_EXCEPTION = "Sorry Unable To Update Profile Sub Section";
        ...
        public static string VERIFICATION_LINK_MASTER_DATA_ADD_EXCEPTION = "Sorry Unable To Add Verification Link";
        public static string VERIFICATION_LINK_MASTER_DATA_UPDATE_EXCEPTION = "Sorry Unable To Update Verification Link";
        ...
        public static string SCHOOL_CONTACT_UPDATE_EXCEPTION = "Sorry Unable To Update School Contact Details";
        public static string SCHOOLCONTACT_ADD_EXCEPTION = "Sorry Unable To Add School Contact";
        ...
        public static string Insuarance_Company_Name_ADD_EXCEPTION = "Sorry Unable To Add New Insuarance Company";
        public static string Insuarance_Company_Name_UPDATE_EXCEPTION = "Sorry Unable To Update New Insuarance Company";
        ...
        public static string CITY_ADD_EXCEPTION = "Sorry Unable To Add City";
        public static string CITY_UPDATE_EXCEPTION = "Sorry Unable To Update City";
        ...
        public static string CDSC_LICENSE_NUMBER_EXISTS_EXCEPTION = "CDS number already exists";
        ...
        public static string PLAN_FORM_EXCEPTION = "Unable to Add Plan Form.";
