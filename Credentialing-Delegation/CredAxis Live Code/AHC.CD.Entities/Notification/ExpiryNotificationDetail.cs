...
namespace AHC.CD.Entities.Notification
{
    public class ExpiryNotificationDetail
    {
        public ExpiryNotificationDetail()
        {
            ...
            this.MedicareExpiries = new List<MedicareExpiry>();
            this.MedicaidExpiries = new List<MedicaidExpiry>();            
            this.UpComingRecredentials = new List<UpcomingRecredential>();
            this.CAQHExpiries = new List<CAQHExpiry>();
        ...
        public virtual ICollection<MedicareExpiry> MedicareExpiries { get; set; }
        public virtual ICollection<MedicaidExpiry> MedicaidExpiries { get; set; }        
        public virtual ICollection<UpcomingRecredential> UpComingRecredentials { get; set; }
        public virtual ICollection<CAQHExpiry> CAQHExpiries { get; set; }
