...
namespace AHC.CD.Business.MasterData
{
    public class MasterDataAddEdit : IMasterDataAddEdit
    {
        ...
        public int AddSchoolContactInfo(int SchoolID, SchoolContactInfo ContactInfo)
        {
            try
            {
                
                var School = uof.GetGenericRepository<School>();
                var SchoolData = School.Find(SchoolID);
                SchoolData.SchoolContactInfoes.Add(ContactInfo);
                School.Save();
            ...
            //catch (Exception ex)
            //{
            //    throw new MasterDataAddException(ExceptionMessage.SCHOOLCONTACT_ADD_EXCEPTION, ex);
            //}
        }
        ...
        public void UpdateSchoolContactInfo(SchoolContactInfo ContactInfo)
        {
            try
            {
                var schoolContactRepo = uof.GetGenericRepository<SchoolContactInfo>();
                schoolContactRepo.Update(ContactInfo);
                schoolContactRepo.Save();
            }
            catch (ApplicationException)
            {
                throw;
        ...
        private void AddOrganizationGroup(Group group)
        {
            try
            {
                if(group != null)
                {
                    ...
                    orgGroup.GroupTaxId = group.TaxId;
                    orgGroup.GroupNPI = group.NPINumber;
                    var organizationgroupRepo = uof.GetGenericRepository<OrganizationGroup>();
        ...
        public void UpdateHospitalContact(HospitalContactInfo hospitalContactInfo)
        {
            try
            {
        ...
        public void UpdateHospitalContactPerson(HospitalContactPerson hospitalContactPerson)
        {
            try
            {
        ...
        public void UpdateCity(Entities.Location.City city)
        {
            try
            {
                var cityRepo = uof.GetGenericRepository<City>();
            ...
            {
                throw new MasterDataUpdateException(ExceptionMessage.CITY_UPDATE_EXCEPTION, ex);
            }      
        }

        public int AddNotestemplate(NotesTemplate Template)
        {
            try
            {
                var Templat = uof.GetGenericRepository<NotesTemplate>();
                Templat.Create(Template);
                Templat.Save();
                return Template.NotesTemplateID;
            }
            catch (ApplicationException)
            {
                throw;
        ...
        public bool UpdateNotestemplate(NotesTemplate Template)
        {
            try
            {
                var Templat = uof.GetGenericRepository<NotesTemplate>();
                
                Templat.Update(Template);
                Templat.Save();
                return true;
            }
            catch (Exception)
        ...
        public async Task UpdateProfileSubSection(ProfileSubSection profileSubSection)
        {
            try
            {                       
                var profilesubsectionrepo = uof.GetGenericRepository<ProfileSubSection>();
                profilesubsectionrepo.Update(profileSubSection);
                await profilesubsectionrepo.SaveAsync();                
            }
            catch (Exception)
            {
        ...
        public async Task<VerificationLink> SaveVerificationLink(VerificationLink verificationlink)
        {
            try
            {
                ...
                link.Status = AHC.CD.Entities.MasterData.Enums.StatusType.Active.ToString();
                link.Name = verificationlink.Name;
        ...
        public async Task<DecredentialingReason> SaveDecredentialingReason(DecredentialingReason decredentialingreason) 
        {
            try
            {
                DecredentialingReason reason = new DecredentialingReason();
                reason.Status = AHC.CD.Entities.MasterData.Enums.StatusType.Active.ToString();
                reason.Reason = decredentialingreason.Reason;
                var decredentialingreasonrepo = uof.GetGenericRepository<DecredentialingReason>();
                decredentialingreasonrepo.Create(decredentialingreason);
                await decredentialingreasonrepo.SaveAsync();
                return decredentialingreason;
            }
            catch (Exception)
            {
                throw;
        ...
        public async Task<DecredentialingReason> UpdateDecredentialingReason(DecredentialingReason decredentialingreason)
        {
            try
            {
                DecredentialingReason reason = new DecredentialingReason();
                ...
                reason.Reason = decredentialingreason.Reason;
                var decredentialingreasonrepo = uof.GetGenericRepository<DecredentialingReason>();
                decredentialingreasonrepo.Update(decredentialingreason);
                await decredentialingreasonrepo.SaveAsync();
                return decredentialingreason;
            }
            catch (Exception)
