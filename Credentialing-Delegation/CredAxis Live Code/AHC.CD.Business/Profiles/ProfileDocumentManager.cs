...
namespace AHC.CD.Business.Profiles
{
    internal class ProfileDocumentManager
    {
        ...
        public string AddOtherDocument(int profileId, DocumentDTO document, OtherDocument otherDocument)
        {
            string newDocPath = document.OldFilePath;
            ...
            {
                //Save the document in the path
                newDocPath = otherDocument.DocumentPath = DocumentManager.SaveDocument(document, document.DocRootPath);
            }
        ...
        public string AddCCMSignatureDocument(DocumentDTO document, ProfileDocument profileDocument)
        {
            string newDocPath = document.OldFilePath;
