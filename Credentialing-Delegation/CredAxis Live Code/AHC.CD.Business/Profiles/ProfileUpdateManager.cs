...
namespace AHC.CD.Business.Profiles
{
    internal class ProfileUpdateManager : IProfileUpdateManager
    {
        ...
        public void SetApproval(List<ApprovalSubmission> trackers, string userAuthId)
        {
            ...
            where T : class
        {
            ...
            try
            {
                ...
                tracker.UniqueData = trackerBuss.UniqueData;
        ...
        public int GetAllRequestCounts()
        {
            var trackerRepo = uow.GetGenericRepository<ProfileUpdatesTracker>();
            var requestCounts = trackerRepo.Get(p => p.ApprovalStatus == AHC.CD.Entities.MasterData.Enums.ApprovalStatusType.Pending.ToString() || p.ApprovalStatus == AHC.CD.Entities.MasterData.Enums.ApprovalStatusType.OnHold.ToString()).Count();
            return requestCounts;
        }


        public int GetAllProviderApprovalCounts(int profileId)
        {
            var trackerRepo = uow.GetGenericRepository<ProfileUpdatesTracker>();
