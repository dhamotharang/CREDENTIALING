...
userApp.controller("userController", ['$scope', '$timeout', '$http', '$filter', '$rootScope','messageAlertEngine', function ($scope, $timeout, $http, $filter, $rootScope, messageAlertEngine) {
