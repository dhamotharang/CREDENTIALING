    ...
    class PracticeLocationRepository : EFGenericRepository<PracticeLocationDetail>, IPracticeLocationRepository
    {
        ...
        public void UpdatePracticeLocation(PracticeLocationDetail practiceLocationDetail)
        {
            try
            {
                ...
                var PrimaryPracticeLocation = DbSet.Where(x => x.IsPrimary == AHC.CD.Entities.MasterData.Enums.YesNoOption.YES.ToString()).FirstOrDefault();
                if(PrimaryPracticeLocation!=null && practiceLocationDetail.PracticeLocationDetailID!=PrimaryPracticeLocation.PracticeLocationDetailID && practiceLocationDetail.PrimaryYesNoOption==AHC.CD.Entities.MasterData.Enums.YesNoOption.YES)
                {
                    PrimaryPracticeLocation.PrimaryYesNoOption = AHC.CD.Entities.MasterData.Enums.YesNoOption.NO;
                    Update(PrimaryPracticeLocation);
                }
        ...
        public void AddPracticeLocationHistory(int profileId, int practiceLocationDetailID,int CDUserID)
        {
            try
            {
                ...
                if (IsPracticeLocationDetailExists(practiceLocationDetailID, updatePracticeLocationDetail))
                {
                    ...
                    addPracticeLocationDetailHistory.DeletedById = CDUserID;
        ...
        public void UpdateOpenPracticeStatus(int practiceLocationDetailId, OpenPracticeStatus openPracticeStatus)
        {
            try
            {
                PracticeLocationDetail updatePracticeLocationDetail = this.Find(p => p.PracticeLocationDetailID == practiceLocationDetailId, "OpenPracticeStatus.PracticeQuestionAnswers");
                ...
                if (IsPracticeLocationDetailExists(practiceLocationDetailId, updatePracticeLocationDetail))
                {
                    ...
                    {
                        updatePracticeLocationDetail.OpenPracticeStatus = AutoMapper.Mapper.Map<OpenPracticeStatus, OpenPracticeStatus>(updatePracticeLocationDetail.OpenPracticeStatus,openPracticeStatus);
                        Update(updatePracticeLocationDetail);
                    }
                }
            }
