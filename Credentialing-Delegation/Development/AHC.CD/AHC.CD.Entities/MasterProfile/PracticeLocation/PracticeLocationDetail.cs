...
namespace AHC.CD.Entities.MasterProfile.PracticeLocation
{
    public class PracticeLocationDetail
    {
        ...
        public virtual AHC.CD.Entities.MasterData.Account.Branch.Facility Facility { get; set; }
        ...
        public ICollection<PracticeLocationDetailHistory> PracticeLocationDetailHistory { get; set; }
