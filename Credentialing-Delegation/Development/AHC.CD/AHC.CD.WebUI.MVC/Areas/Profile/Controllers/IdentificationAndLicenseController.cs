...
namespace AHC.CD.WebUI.MVC.Areas.Profile.Controllers
{
    public class IdentificationAndLicenseController : Controller
    {
        ...
        public async Task<ActionResult> UpdateStateLicenseAsync(int profileId, AHC.CD.WebUI.MVC.Areas.Profile.Models.IdentificationAndLicenses.StateLicenseViewModel stateLicense,int CDUserID=0)
        {
            string status = "true";
            StateLicenseInformation dataModelStateLicense = null;
            bool isCCO = await GetUserRole();
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    //await notificationManager.SaveNotificationDetailAsync(notification);
                     if (stateLicense.StateLicenseDocumentFile != null && stateLicense.StateLicenseDocumentPath != null)
                        {
                            dynamic UH = JsonConvert.DeserializeObject(stateLicense.UpdateHistory);
                            UH.SupportingDocument = stateLicense.StateLicenseDocumentPath;
                            stateLicense.UpdateHistory = JsonConvert.SerializeObject(UH);
                        }
                    ...
                    if (isCCO)
                    {
                        ...
                        await profileManager.UpdateStateLicenseAsync(profileId, dataModelStateLicense, document);
                        #region Update History Code
                        if (stateLicense.UpdateHistory != "{}")
                        {
                           // string ChangedObject = null;
                           // string UserAuthID = null;
                            string UserName = null;
                            string SectionName = "StateLicenseInformationID";
                            if (CDUserID == 0)
                            {
                                ApplicationUser UserDetail = await GetUser();
                                UserAuthID = await GetUserAuthId();
                               
                            }
                            else
                            {
                                UserAuthID = profileManager.GetAuthID(CDUserID);
                            ...
                            int StateLicenseInformationID = 0;
                            if (stateLicense.StateLicenseInformationID != null)
                            {
                                StateLicenseInformationID = (int)stateLicense.StateLicenseInformationID;
                            }
                            await profileManager.SaveUpdateHistory(stateLicense.UpdateHistory, UserAuthID, SectionName, StateLicenseInformationID, profileId);
                        }
                        #endregion
                        ...
                        await notificationManager.SaveNotificationDetailAsync(notification);
                        //await profileManager.SaveUpdateHistory(stateLicense.UpdateHistory, UserAuthID, "StateLicenseInformationID", stateLicense.StateLicenseInformationID, profileId);
                    }
                    else
                    {
        ...
        [AjaxAction]
        [ProfileAuthorize(ProfileActionType.Edit, false)]
        public async Task<ActionResult> UpdateFederalDEALicenseAsync(int profileId, FederalDEAInformationViewModel federalDea,int CDUserID=0)
        {
            string status = "true";
            FederalDEAInformation dataModelFederalDEA = null;
            bool isCCO = await GetUserRole();
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    DocumentDTO document = CreateDocument(federalDea.DEALicenceCertFile);
                    if (federalDea.DEALicenceCertFile != null && federalDea.DEALicenceCertPath != null)
                    {
                        dynamic UH = JsonConvert.DeserializeObject(federalDea.UpdateHistory);
                        UH.SupportingDocument = dataModelFederalDEA.DEALicenceCertPath;
                        federalDea.UpdateHistory = JsonConvert.SerializeObject(UH);

                        //dynamic UH=federalDea.UpdateHistory.Des
                    }
                    ...
                    if (isCCO)
                    {
                        ...
                        await profileManager.UpdateFederalDEALicenseAsync(profileId, dataModelFederalDEA, document);
                        #region Update History Code
                        if (federalDea.UpdateHistory != "{}")
                        {
                           
                            string UserAuthID = null;
                           
                            string SectionName = "FederalDEAInformationID";
                            if (CDUserID == 0)
                            {
                                ApplicationUser UserDetail = await GetUser();
                                UserAuthID = await GetUserAuthId();
                            ...
                            int FederalDEAInformationID = 0;
                            if (federalDea.FederalDEAInformationID!=null)//.StateLicenseInformationID != null)
                            {
                                FederalDEAInformationID = (int)federalDea.FederalDEAInformationID;
                            }
                           
                            await profileManager.SaveUpdateHistory(federalDea.UpdateHistory, UserAuthID, SectionName, FederalDEAInformationID, profileId);
                        }
                        #endregion
        ...
        [HttpPost]
        public async Task<ActionResult> RenewFederalDEALicenseAsync(int profileId, FederalDEAInformationViewModel federalDea,int CDUserID=0)
        {
        ...
        [AjaxAction]
        [ProfileAuthorize(ProfileActionType.Edit, false)]
        public async Task<ActionResult> UpdateCDSCLicenseAsync(int profileId, AHC.CD.WebUI.MVC.Areas.Profile.Models.IdentificationAndLicenses.CDSCInformationViewModel CDSCInformation,int CDUserID=0)
        {
            string status = "true";
            CDSCInformation dataModelCDSCLicense = null;
            bool isCCO = await GetUserRole();
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    DocumentDTO document = CreateDocument(CDSCInformation.CDSCCerificateFile);
                    if (CDSCInformation.CDSCCerificateFile != null && CDSCInformation.CDSCCerificatePath != null)
                    {
                        dynamic UH = JsonConvert.DeserializeObject(CDSCInformation.UpdateHistory);
                        UH.SupportingDocument = dataModelCDSCLicense.CDSCCerificatePath;
                        CDSCInformation.UpdateHistory = JsonConvert.SerializeObject(UH);
                    ...
                    if (isCCO)
                    {
                        ...
                        await profileManager.UpdateCDSCLicenseAsync(profileId, dataModelCDSCLicense, document);
                        #region Update History Code
                        if (CDSCInformation.UpdateHistory != "{}")
                        {
                            string ChangedObject = null;
                            string UserAuthID = null;
                            string UserName = null;
                            string SectionName = "CDSCInformationID";
                            if (CDUserID == 0)
                            {
                                ApplicationUser UserDetail = await GetUser();
                                UserAuthID = await GetUserAuthId();
                            ...
                            int CDSCInformationID = 0;
                            if (CDSCInformation.CDSCInformationID != null)//.StateLicenseInformationID != null)
                            {
                                CDSCInformationID = (int)CDSCInformation.CDSCInformationID;
                            }
                            await profileManager.SaveUpdateHistory(CDSCInformation.UpdateHistory, UserAuthID, SectionName, CDSCInformationID, profileId);
                        }
                        #endregion
        ...
        [HttpPost]
        public async Task<ActionResult> RenewCDSCLicenseAsync(int profileId, AHC.CD.WebUI.MVC.Areas.Profile.Models.IdentificationAndLicenses.CDSCInformationViewModel CDSCInformation,int CDUserID=0)
        {
        ...
        [AjaxAction]
        [ProfileAuthorize(ProfileActionType.Edit, false)]
        public async Task<ActionResult> UpdateMedicareInformationAsync(int profileId, AHC.CD.WebUI.MVC.Areas.Profile.Models.IdentificationAndLicenses.MedicareInformationViewModel MedicareInformation,int CDUserID=0)
        {
            string status = "true";
            MedicareInformation dataModelMedicareInformation = null;
            bool isCCO = await GetUserRole();
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    DocumentDTO document = CreateDocument(MedicareInformation.CertificateFile);
                    if (MedicareInformation.CertificateFile != null && MedicareInformation.CertificatePath != null)
                    {
                        dynamic UH = JsonConvert.DeserializeObject(MedicareInformation.UpdateHistory);
                        UH.SupportingDocument = dataModelMedicareInformation.CertificatePath;
                        MedicareInformation.UpdateHistory = JsonConvert.SerializeObject(UH);
                    ...
                    if (isCCO)
                    {
                        ...
                        #region Update History Code
                        if (MedicareInformation.UpdateHistory != "{}")
                        {
                            string ChangedObject = null;
                            string UserAuthID = null;
                            string UserName = null;
                            string SectionName = "MedicareInformationID";
                            if (CDUserID == 0)
                            {
                                ApplicationUser UserDetail = await GetUser();
                                UserAuthID = await GetUserAuthId();
                            ...
                            int MedicareInformationID = 0;

                            if (MedicareInformation.MedicareInformationID != null)//.StateLicenseInformationID != null)
                            {
                                MedicareInformationID = (int)MedicareInformation.MedicareInformationID;
                            }
                            await profileManager.SaveUpdateHistory(MedicareInformation.UpdateHistory, UserAuthID, SectionName, MedicareInformationID, profileId);
                        }
                        #endregion
        ...
        [AjaxAction]
        [ProfileAuthorize(ProfileActionType.Edit, false)]
        public async Task<ActionResult> UpdateMedicaidInformationAsync(int profileId, AHC.CD.WebUI.MVC.Areas.Profile.Models.IdentificationAndLicenses.MedicaidInformationViewModel MedicaidInformation,int CDUserID=0)
        {
            string status = "true";
            MedicaidInformation dataModelMedicaidInformation = null;
            bool isCCO = await GetUserRole();
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    DocumentDTO document = CreateDocument(MedicaidInformation.CertificateFile);
                    if (MedicaidInformation.CertificateFile != null && MedicaidInformation.CertificatePath != null)
                    {
                        dynamic UH = JsonConvert.DeserializeObject(MedicaidInformation.UpdateHistory);
                        UH.SupportingDocument = dataModelMedicaidInformation.CertificatePath;
                        MedicaidInformation.UpdateHistory = JsonConvert.SerializeObject(UH);
                    ...
                    if (isCCO)
                    {
                        ...
                        if (MedicaidInformation.UpdateHistory != "{}")
                        {
                            string ChangedObject = null;
                            string UserAuthID = null;
                            string UserName = null;
                            string SectionName = "MedicaidInformationID";
                            if (CDUserID == 0)
                            {
                                ApplicationUser UserDetail = await GetUser();
                                UserAuthID = await GetUserAuthId();
                            ...
                            int MedicaidInformationID = 0;
                            if (MedicaidInformation.MedicaidInformationID != null)//.StateLicenseInformationID != null)
                            {
                                MedicaidInformationID = (int)MedicaidInformation.MedicaidInformationID;
                            }
                            await profileManager.SaveUpdateHistory(MedicaidInformation.UpdateHistory, UserAuthID, SectionName, MedicaidInformationID, profileId);
                        }
                        #endregion
        ...
        public async Task<ActionResult> UpdateOtherIdentificationNumberAsync(int profileId, AHC.CD.WebUI.MVC.Areas.Profile.Models.IdentificationAndLicenses.OtherIdentificationNumberViewModel OtherIdentificationNumber, int CDUserID = 0)
        {
            string status = "true";
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (OtherIdentificationNumber.OtherIdentificationNumberID == 0)
                    {
                        ...
                        await notificationManager.SaveNotificationDetailAsync(notification);
                        await profileManager.SaveUpdateHistory(OtherIdentificationNumber.UpdateHistory, UserAuthID, "OtherIdentificationNumberID", OtherIdentificationNumber.OtherIdentificationNumberID, profileId);
                    }
