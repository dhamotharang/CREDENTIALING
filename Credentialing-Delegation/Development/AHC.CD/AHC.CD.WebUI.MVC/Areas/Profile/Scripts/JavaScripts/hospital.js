...
profileApp.controller('hospitalcltr', ['$scope', '$rootScope', '$http', 'messageAlertEngine', '$filter', 'profileUpdates', function ($scope, $rootScope, $http, messageAlertEngine, $filter, profileUpdates) {
    ...
    $scope.searchCumDropDown = function (divId) {
        ...
        if ($scope.tempObject.HospitalContactPerson != undefined) {
    ...
    $scope.ConstructOldandNewObject = function () {
        ...
        var newObject = angular.copy($scope.tempObject);
        var tempSpecialties = $rootScope.getSpecilityForThisUser();
        if (angular.isDefined(oldObject)) {
            oldObject.AdmittingPrivilege != null ? oldObject.AdmittingPrivilegeID = oldObject.AdmittingPrivilege.Title : null; oldObject.AdmittingPrivilege = null;
            newObject.AdmittingPrivilege != null ? newObject.AdmittingPrivilegeID = jQuery.grep($scope.admittingPrivileges, function (ele) { return ele.AdmittingPrivilegeID == newObject.AdmittingPrivilege.AdmittingPrivilegeID })[0].Title : null; newObject.AdmittingPrivilege = null;
            oldObject.FullUnrestrictedPrevilagesYesNoOption = oldObject.FullUnrestrictedPrevilagesYesNoOption != null ? (oldObject.FullUnrestrictedPrevilagesYesNoOption == 1 ? "Yes" : "No") : null;
            newObject.FullUnrestrictedPrevilagesYesNoOption = newObject.FullUnrestrictedPrevilagesYesNoOption != null ? (newObject.FullUnrestrictedPrevilagesYesNoOption == 1 ? "Yes" : "No") : null;
            ...
            newObject.PrevilegesTemporaryYesNoOption = newObject.PrevilegesTemporaryYesNoOption != null ? (newObject.PrevilegesTemporaryYesNoOption == 1 ? "Yes" : "No") : null;
            oldObject.PrevilegesTemporaryYesNoOption = oldObject.PrevilegesTemporaryYesNoOption != null ? (oldObject.PrevilegesTemporaryYesNoOption == 1 ? "Yes" : "No") : null;
            oldObject.StaffCategoryID != null ? oldObject.StaffCategoryID = oldObject.StaffCategory.Title : null; oldObject.StaffCategory = null;
            newObject.StaffCategoryID != null ? newObject.StaffCategoryID = jQuery.grep($scope.staffCategories, function (ele) { return ele.StaffCategoryID == newObject.StaffCategory.StaffCategoryID })[0].Title : null; newObject.StaffCategory = null;
            if (oldObject.Hospital != undefined) {
                oldObject.Hospital.HospitalID = null; newObject.Hospital.HospitalID = null; oldObject.Hospital.HospitalContactInfoes = null; newObject.Hospital.HospitalContactInfoes = null; oldObject.HospitalContactInfo.HospitalContactPersons = null; newObject.HospitalContactInfo.HospitalContactPersons = null;
            }
            oldObject.HospitalContactPerson != null ? oldObject.HospitalContactPerson.HospitalContactPersonID = oldObject.HospitalContactPerson.ContactPersonName : null;
            newObject.HospitalContactPerson != null ? newObject.HospitalContactPerson.HospitalContactPersonID = newObject.HospitalContactPerson.ContactPersonName : null;
            oldObject.HospitalContactInfo != null ? oldObject.HospitalContactInfo.HospitalContactInfoID = oldObject.HospitalContactInfo.LocationName : null;
            newObject.HospitalContactInfo != null ? newObject.HospitalContactInfo.HospitalContactInfoID = newObject.HospitalContactInfo.LocationName : null;
            (oldObject.SpecialtyID != null && oldObject.SpecialtyID != "") ? oldObject.SpecialtyID = $.grep(tempSpecialties, function (ele) { return ele.SpecialtyID == oldObject.SpecialtyID })[0].Specialty.Name : null;
            (newObject.SpecialtyID != null && newObject.SpecialtyID != "") ? newObject.SpecialtyID = $.grep(tempSpecialties, function (ele) { return ele.SpecialtyID == newObject.SpecialtyID })[0].Specialty.Name : null;
    ...
    $scope.saveHospitalPrivilegeDetail = function (hospitalPrivilegeInformation, IndexValue) {
        ...
        if ($scope.visibilityControl == 'addhospitalPrivilegeInformation') {
            ...
            //ResetFormForValidation($formDataHospitalPrivilege);
            $('#UpdateHistoryHiddenHospitalPrivilege').val(JSON.stringify($rootScope.TrackObjectChanges(result.oldObject, result.newObject)));
            ...
            //ResetFormForValidation($formDataHospitalPrivilege);
            $('#UpdateHistoryHiddenHospitalPrivilegeRenew').val(JSON.stringify($rootScope.TrackObjectChanges(result.oldObject, result.newObject)));
