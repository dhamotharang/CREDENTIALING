...
profileApp.controller('educationController', ['$scope', '$rootScope', '$http', 'masterDataService', 'locationService', 'messageAlertEngine', '$filter', 'profileUpdates', function ($scope, $rootScope, $http, masterDataService, locationService, messageAlertEngine, $filter, profileUpdates) {
    ...
    $scope.setResidencyInternshipProgramType = function (ResidencyInternshipProgramTypeID) {
        switch (ResidencyInternshipProgramTypeID.toString()) {
            case "1": ResidencyInternshipProgramTypeID = "Internship"; break;
            case "2": ResidencyInternshipProgramTypeID = "Fellowship"; break;
            case "3": ResidencyInternshipProgramTypeID = "Residency"; break;
            case "4": ResidencyInternshipProgramTypeID = "Other"; break;
            default: break;
        }
        return ResidencyInternshipProgramTypeID;
    }
    //--------------------------------- End-------------------------------------
    $scope.ConstructOldandNewObjectUG = function () {
        var oldObject = angular.copy($rootScope.OldObject);
        if ($scope.tempObject.SchoolInformation != undefined)
       $scope.tempdata=$scope.tempObject.SchoolInformation.SchoolName;
       var newObject = angular.copy($scope.tempObject);
       
        oldObject.USGraduateYesNoOption = oldObject.USGraduateYesNoOption != null ? (oldObject.USGraduateYesNoOption == 1 ? "Yes" : "No") : null;
        newObject.USGraduateYesNoOption = newObject.USGraduateYesNoOption != null ? (newObject.USGraduateYesNoOption == 1 ? "Yes" : "No") : null;
        oldObject.CompletedYesNoOption = oldObject.CompletedYesNoOption != null ? (oldObject.CompletedYesNoOption == 1 ? "Yes" : "No") : null;
        newObject.CompletedYesNoOption = newObject.CompletedYesNoOption != null ? (newObject.CompletedYesNoOption == 1 ? "Yes" : "No") : null;
        oldObject.ResidencyInternshipProgramType != null ? oldObject.ResidencyInternshipProgramType = $scope.setResidencyInternshipProgramType(oldObject.ResidencyInternshipProgramType) : null;
        newObject.ResidencyInternshipProgramType != null ? newObject.ResidencyInternshipProgramType = $scope.setResidencyInternshipProgramType(newObject.ResidencyInternshipProgramType) : null;        
    ...
    $scope.saveUG = function (educationDetailViewModel, IndexValue) {
        educationDetailViewModel.LastModifiedDate = "";
        educationDetailViewModel.SchoolInformation.LastModifiedDate = "";
        educationDetailViewModel.SchoolContactInfo.LastModifiedDate = "";
        loadingOn();
        ...
        if ($scope.visibilityControl == 'addeducationDetailViewModel') {
            ...
            var result = $scope.ConstructOldandNewObjectUG();
            delete result.oldObject.LastModifiedDate;
            delete result.oldObject.SchoolInformation.LastModifiedDate;
            delete result.newObject.LastModifiedDate;
            delete result.newObject.SchoolContactInfo.LastModifiedDate;
            delete result.newObject.SchoolInformation.LastModifiedDate;
            $('#UpdateHistoryHiddenUG').val(JSON.stringify($rootScope.TrackObjectChanges(result.oldObject, result.newObject)));            
            //result.newObject.LastModifiedDate = "";
            //result.oldObject.LastModifiedDate = "";
            //result.newObject.SchoolInformation.LastModifiedDate = "";
            //result.oldObject.SchoolInformation.LastModifiedDate = "";
    ...
    $scope.saveGraduation = function (graduationDetailViewModel, IndexValue) {
        ...
        if ($scope.visibilityControl == 'addgraduationDetailViewModel') {
            ...
            var result = $scope.ConstructOldandNewObjectUG();
            $('#UpdateHistoryHiddenG').val(JSON.stringify($rootScope.TrackObjectChanges(result.oldObject, result.newObject)));
            //Update Details - Denote the URL            
    ...
    $scope.saveECFMGDetails = function (ecfmgDetail) {
        ...
        var $formData;
        var result = $scope.ConstructOldandNewObjectUG();
        $('#UpdateHistoryHiddenECFMGDetail').val(JSON.stringify($rootScope.TrackObjectChanges(result.oldObject, result.newObject)));
    ...
    $scope.saveResidencyInternshipFellowshipProgram = function (residencyInternshipViewModel, IndexValue) {
        ...
        if ($scope.visibilityControl == 'addProgramDetail') {
            ...
            var result = $scope.ConstructOldandNewObjectUG();
            $('#UpdateHistoryHiddenProgramDetail').val(JSON.stringify($rootScope.TrackObjectChanges(result.oldObject, result.newObject)));
    ...
    $scope.saveCertificate = function (certificationCMEViewModel, IndexValue) {
        ...
        if ($scope.visibilityControl == 'addcertificationCMEViewModel') {
            ...
            var result = $scope.ConstructOldandNewObjectUG();
            $('#UpdateHistoryHiddenCMECertification').val(JSON.stringify($rootScope.TrackObjectChanges(result.oldObject, result.newObject)));
            //Update Details - Denote the URL
