...
profileApp.controller('identificationLicenseController', ['$scope', '$rootScope', '$http', 'masterDataService', 'locationService', 'messageAlertEngine', '$filter', '$timeout', 'profileUpdates', function ($scope, $rootScope, $http, masterDataService, locationService, messageAlertEngine, $filter, $timeout, profileUpdates) {
    ...
    $scope.saveStateLicense = function (stateLicense, index) {
        ...
        if (oldObject != null) {
            oldObject.CurrentPracticeStateYesNoOption = oldObject.CurrentPracticeStateYesNoOption != null ? (oldObject.CurrentPracticeStateYesNoOption == 1 ? "Yes" : "No") : null;
            newObject.CurrentPracticeStateYesNoOption = newObject.CurrentPracticeStateYesNoOption != null ? (newObject.CurrentPracticeStateYesNoOption == 1 ? "Yes" : "No") : null;
            oldObject.GoodStandingYesNoOption = oldObject.GoodStandingYesNoOption != null ? (oldObject.GoodStandingYesNoOption == 1 ? "Yes" : "No") : null;
            newObject.GoodStandingYesNoOption = newObject.GoodStandingYesNoOption != null ? (newObject.GoodStandingYesNoOption == 1 ? "Yes" : "No") : null;
            if (oldObject.ProviderType != null)
                oldObject.ProviderTypeID = oldObject.ProviderTypeID == "" ? "" : oldObject.ProviderType.Title; oldObject.ProviderType = null;
            newObject.ProviderTypeID = providerTypeobj == undefined ? "" : providerTypeobj.Title; newObject.ProviderType = null;
            if (oldObject.StateLicenseStatus != undefined)
                oldObject.StateLicenseStatusID = oldObject.StateLicenseStatusID == "" ? "" : oldObject.StateLicenseStatus.Title; oldObject.StateLicenseStatus = null;
            newObject.StateLicenseStatusID = LicenseStatusobj == undefined ? "" : LicenseStatusobj.Title; newObject.StateLicenseStatus = null;
        }
        if ($scope.visibilityControl == 'addStateLicenseInformation') {
            ...
            try {
                $('#UpdateHistoryHidden').val(JSON.stringify($rootScope.TrackObjectChanges(oldObject, newObject)));
            ...
            //Update Details - Denote the URL
            try {
                $('#UpdateHistoryHidden').val(JSON.stringify($rootScope.TrackObjectChanges($rootScope.OldObject, $rootScope.tempObject)));
    ...
    $scope.saveFederalDEALicense = function (FederalDEALicense, index) {
        ...
        if ($scope.visibilityControl == 'addDEAInformation') {
            ...
            try {
                // $rootScope.ChangedObj = "";
                var newObj = angular.copy($rootScope.tempObject);
                //newObj.IssueDate = newObj.IssueDate != null ? moment(newObj.IssueDate).format('MM/DD/YYYY, h:mm:ss a') : null;
                //newObj.ExpiryDate = newObj.ExpiryDate != null ? moment(newObj.ExpiryDate).format('MM/DD/YYYY, h:mm:ss a') : null;
                var oldObj = angular.copy($rootScope.OldObject);
                //oldObj.IssueDate = oldObj.IssueDate != null ? moment(oldObj.IssueDate).format('MM/DD/YYYY, h:mm:ss a') : null;
                //oldObj.ExpiryDate = oldObj.ExpiryDate != null ? moment(oldObj.ExpiryDate).format('MM/DD/YYYY, h:mm:ss a') : null;
                oldObj.GoodStandingYesNoOption = oldObj.GoodStandingYesNoOption != null ? (oldObj.GoodStandingYesNoOption == 1 ? "Yes" : "No") : null;
                newObj.GoodStandingYesNoOption = newObj.GoodStandingYesNoOption != null ? (newObj.GoodStandingYesNoOption == 1 ? "Yes" : "No") : null;
                $('#UpdateHistoryHiddenForFederalDEA').val(JSON.stringify($rootScope.TrackObjectChanges(oldObj, newObj)));
            ...
            try {
                var newObjForren = angular.copy($rootScope.tempObject);
                //newObj.IssueDate = newObj.IssueDate != null ? moment(newObj.IssueDate).format('MM/DD/YYYY, h:mm:ss a') : null;
                //newObj.ExpiryDate = newObj.ExpiryDate != null ? moment(newObj.ExpiryDate).format('MM/DD/YYYY, h:mm:ss a') : null;
                var oldObjForRen = angular.copy($rootScope.OldObject);
                //oldObj.IssueDate = oldObj.IssueDate != null ? moment(oldObj.IssueDate).format('MM/DD/YYYY, h:mm:ss a') : null;
                //oldObj.ExpiryDate = oldObj.ExpiryDate != null ? moment(oldObj.ExpiryDate).format('MM/DD/YYYY, h:mm:ss a') : null;
                oldObjForRen.GoodStandingYesNoOption = oldObjForRen.GoodStandingYesNoOption != null ? (oldObjForRen.GoodStandingYesNoOption == 1 ? "Yes" : "No") : null;
                newObjForren.GoodStandingYesNoOption = newObjForren.GoodStandingYesNoOption != null ? (newObjForren.GoodStandingYesNoOption == 1 ? "Yes" : "No") : null;
                $('#UpdateHistoryHiddenForFederalDEARenew').val(JSON.stringify($rootScope.TrackObjectChanges(oldObjForRen, newObjForren)));
    ...
    $scope.saveCDSCInformation = function (cDSCInformation, index) {
        ...
        if ($scope.visibilityControl == 'addCDSCInformation') {
            ...
            try {
                // var CDSCnewObj = angular.copy($rootScope.tempObject);
                //CDSCnewObj.IssueDate = CDSCnewObj.IssueDate != null ? moment(CDSCnewObj.IssueDate).format('MM/DD/YYYY, h:mm:ss a') : null;
                //CDSCnewObj.ExpiryDate = CDSCnewObj.ExpiryDate != null ? moment(CDSCnewObj.ExpiryDate).format('MM/DD/YYYY, h:mm:ss a') : null;
                // var CDSCOldObj = angular.copy($rootScope.OldObject);
                //CDSCOldObj.IssueDate = CDSCOldObj.IssueDate != null ? moment(CDSCOldObj.IssueDate).format('MM/DD/YYYY, h:mm:ss a') : null;
                //CDSCOldObj.ExpiryDate = CDSCOldObj.ExpiryDate != null ? moment(CDSCOldObj.ExpiryDate).format('MM/DD/YYYY, h:mm:ss a') : null;
                $('#UpdateHistoryHiddenForCDSC').val(JSON.stringify($rootScope.TrackObjectChanges($rootScope.OldObject, $rootScope.tempObject)));
            ...
            try {
                $('#UpdateHistoryHiddenForCDSCRenew').val(JSON.stringify($rootScope.TrackObjectChanges($rootScope.OldObject, $rootScope.tempObject)));
    ...
    $scope.saveMedicareInformation = function (MedicareInformation, index) {
        ...
        if ($scope.visibilityControl == 'addMedicareInformation') {
            ...
            try {
                //var MedicarenewObj = angular.copy($rootScope.tempObject);
                //MedicarenewObj.IssueDate = MedicarenewObj.IssueDate != null ? moment(MedicarenewObj.IssueDate).format('MM/DD/YYYY, h:mm:ss a') : null;
                //MedicarenewObj.ExpirationDate = MedicarenewObj.ExpirationDate != null ? moment(MedicarenewObj.ExpirationDate).format('MM/DD/YYYY, h:mm:ss a') : null;
                //var MedicareOldObj = angular.copy($rootScope.OldObject);
                //MedicareOldObj.IssueDate = MedicareOldObj.IssueDate != null ? moment(MedicareOldObj.IssueDate).format('MM/DD/YYYY, h:mm:ss a') : null;
                //MedicareOldObj.ExpirationDate = MedicareOldObj.ExpirationDate != null ? moment(MedicareOldObj.ExpirationDate).format('MM/DD/YYYY, h:mm:ss a') : null;
                $('#UpdateHistoryHiddenForMedicare').val(JSON.stringify($rootScope.TrackObjectChanges($rootScope.OldObject, $rootScope.tempObject)));
    ...
    $scope.saveMedicaidInformation = function (MedicaidInformation, index) {
        ...
        if ($scope.visibilityControl == 'addMedicaidInformation') {
            ...
            try {
                //var MedicaidnewObj = angular.copy($rootScope.tempObject);
                //MedicaidnewObj.IssueDate = MedicaidnewObj.IssueDate != null ? moment(MedicaidnewObj.IssueDate).format('MM/DD/YYYY, h:mm:ss a') : null;
                //MedicaidnewObj.ExpirationDate = MedicaidnewObj.ExpirationDate != null && MedicaidnewObj.ExpirationDate != undefined && MedicaidnewObj.ExpirationDate.conta ? moment(MedicaidnewObj.ExpirationDate).format('MM/DD/YYYY, h:mm:ss a') : null;
                //var MedicaidOldObj = angular.copy($rootScope.OldObject);
                //MedicaidOldObj.IssueDate = MedicaidOldObj.IssueDate != null ? moment(MedicaidOldObj.IssueDate).format('MM/DD/YYYY, h:mm:ss a') : null;
                //MedicaidOldObj.ExpirationDate = MedicaidOldObj.ExpirationDate != null ? moment(MedicaidOldObj.ExpirationDate).format('MM/DD/YYYY, h:mm:ss a') : null;
                $('#UpdateHistoryHiddenForMedicaid').val(JSON.stringify($rootScope.TrackObjectChanges($rootScope.OldObject, $rootScope.tempObject)));
    ...
    $scope.saveOtherIdentificationNumber = function (Form_Id, otherIdentificationNumber) {
        ...
        $('#UpdateHistoryOtherIdentificationNumber').val(JSON.stringify($rootScope.TrackObjectChanges($rootScope.OldObject, $rootScope.tempObject)));
        if ($("#" + Form_Id).valid()) {
            $.ajax({
    ...
    $scope.AutoFillMedicaidExpirationDate = function (objstart) {
        if (objstart != null && objstart != undefined) {
            $scope.tempObject.ExpirationDate = $scope.ConvertDateBy5Years($scope.tempObject.IssueDate);
        }
        else {
            $scope.tempObject.ExpirationDate = null;
