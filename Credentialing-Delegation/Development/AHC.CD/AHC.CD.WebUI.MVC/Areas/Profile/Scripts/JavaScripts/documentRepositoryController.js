...
profileApp.controller('DocumentRepositoryController', ['$scope', '$rootScope', '$timeout', '$http', 'messageAlertEngine', 'profileUpdates',
    function ($scope, $rootScope, $timeout, $http, messageAlertEngine, profileUpdates) {

        $scope.DocumentRepositoryPendingRequest = profileUpdates.getUpdates('Document Repository', 'Other Document');
        ...
        $rootScope.$on('DocumentRepository', function () {
            ...
            if (!$scope.dataLoaded) {
                ...
                $http({
                    method: 'GET',
                    url: rootDir + '/Profile/DocumentRepository/GetDocumentRepositoryProfileDataAsync?profileId=' + profileId
        ...
        $scope.FormatProfileVerificationInfo = function (Docs) {
            ...
            $scope.MPSVLicenses = { LicenseTypeID: 21, LicenseTypeName: "OIG/Medicare", Licenses: $scope.SLicenses };

            $scope.PSVLicenses = { LicenseTypeID: 22, LicenseTypeName: "PSV Document", Licenses: $scope.Licenses };
        ...
        $scope.FormatCredentialLog = function (Docs) {
                                ...
                                if (Docs[j].CredentialingAppointmentDetail.Status == "Active") {
                                    ...
                                    if (Docs[j].CredentialingAppointmentDetail != null) {
                                        ...
                                        if (Docs[j].CredentialingAppointmentDetail.FileUploadPath != null) {
                                            ...
                                            $scope.Licenses.push({ LicenseID: Docs[j].CredentialingAppointmentDetail.CredentialingAppointmentDetailID, LicenseName: "CCM" + (count), LicenseDocPath: Docs[j].CredentialingAppointmentDetail.FileUploadPath, VerificationDate: Docs[j].CredentialingAppointmentDetail.LastModifiedDate });
            ...
            $scope.CCMLicenses = { LicenseTypeID: 22, LicenseTypeName: "CCM Document", Licenses: $scope.Licenses };
        ...
        $scope.saveOtherDocument = function (Form_Div_Id) {
            ...
            if ($('#filename').text() == "") { $scope.errormessage = true;}
            //var status = false;
                    ...
                    success: function (data) {
                        try {
                            ...
                            if (data.status == "true") {
                                ...
                                $scope.errormsgforfile = data.status;
                                messageAlertEngine.callAlertMessage("alertOtherDocumentError", data.status, "danger", true);
                            }
                        } catch (e) {
            ...
            if ($form.valid() || status) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        try {
                            if (data.status == "true") {
                                $scope.DocumentRepositoryPendingRequest = true;
                                //$rootScope.visibilityControl = "";
            ...
            if (data.professionalWorkExperience != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                ...
                if (count02 == 0) {
                    ...
                    if (data.professionalWorkExperience.WorkExperienceDocPath != null) {
                        ...
                        $scope.LicenseTypes[17].Licenses.push({ LicenseID: data.professionalWorkExperience.ProfessionalWorkExperienceID, LicenseName: "Work Exp" + ($scope.LicenseTypes[17].Licenses.length + 1), LicenseDocPath: data.professionalWorkExperience.WorkExperienceDocPath, ModifiedDate: $scope.ConvertDateFormat(data.professionalWorkExperience.LastModifiedDate), Description: "Work Experience Document" });
