profileApp.controller('practiceLocationController', ['$scope', '$rootScope', '$http', '$filter', 'masterDataService', 'locationService', 'messageAlertEngine', 'profileUpdates', function ($scope, $rootScope, $http, $filter, masterDataService, locationService, messageAlertEngine, profileUpdates) {
    ...
    $scope.ToggleScript = function () {
       // $('#ViewMore_PracticeLocationHistory').prop('title', 'View Less');
    ...
    $rootScope.$on("LoadRequireMasterDataPracticeLocation", function () {
        ...
        masterDataService.getMasterData(rootDir + "/Profile/MasterData/GetAllServiceQuestions").then(function (GetAllServiceQuestions) {
            ...
            console.log($scope.masterServiceQuestions);
        });
        ...
        masterDataService.getMasterData(rootDir + "/MasterDataNew/GetAllMasterBusinessContactPerson").then(function (GetAllOfficeManager) {
            $scope.managers = GetAllOfficeManager;
        });

        //Calling master data service to get all Billing Contact from master data
        masterDataService.getMasterData(rootDir + "/MasterDataNew/GetAllMasterBillingContactPerson").then(function (GetAllBillingContact) {
            $scope.billings = GetAllBillingContact;
            billingsTempo = angular.copy($scope.billings);
        });

        // Calling master data service to get all Payment And Remittance from master data
        masterDataService.getMasterData(rootDir + "/MasterDataNew/GetAllMasterPaymentRemittancePerson").then(function (GetAllPaymentAndRemittance) {
            $scope.payments = GetAllPaymentAndRemittance;
            paymentsTempo = angular.copy($scope.payments);
        });

        masterDataService.getMasterData(rootDir + "/MasterDataNew/GetAllMasterCredentialingContactPerson").then(function (GetAllCredentialingContact) {
    ...
    $scope.showPLHistory = function (loadingId) {
        if ($scope.PracticeLocationDetailsHistory.length == 0) {
            ...
            $http.get(url).success(function (data) {
                ...
                for (var j = 0; j < $scope.PracticeLocationDetailsHistory.length; j++) {
                    for (var i = 0; i < $rootScope.userslist.length; i++) {
                        if ($scope.PracticeLocationDetailsHistory[j].DeletedById != null) {
                            if ($rootScope.userslist[i].CDUserID == $scope.PracticeLocationDetailsHistory[j].DeletedById) {
                                if ($rootScope.userslist[i].FullName != null) {
                                    $scope.PracticeLocationDetailsHistory[j].DeletedBy = $rootScope.userslist[i].FullName;
                                    break;
                                }
                                else {
                                    $scope.PracticeLocationDetailsHistory[j].DeletedBy = $rootScope.userslist[i].UserName;
                                    break;
                                }
                            }
                        }
                    }
                    if ($scope.PracticeLocationDetailsHistory[j].DeletedDate != null) {
                        var date = moment.utc($scope.PracticeLocationDetailsHistory[j].DeletedDate).toDate();
                        $scope.PracticeLocationDetailsHistory[j].DeletedDate = moment(date).format('MM/DD/YYYY, h:mm:ss a');
                    }
                }
    ...
    $scope.saveOfficeManager = function (PracticeLocationDetail, index) {
        ...
        $('#UpdateHistoryHiddenOfficeManager').val(JSON.stringify($rootScope.TrackObjectChanges($rootScope.OldObject, $rootScope.tempSecondObject)));
    ...
    $scope.saveBillingContact = function (PracticeLocationDetail, index) {
        ...
        $('#UpdateHistoryHiddenBillingContract').val(JSON.stringify($rootScope.TrackObjectChanges($rootScope.OldObject, $rootScope.tempSecondObject)));
    ...
    $scope.savePayment = function (PracticeLocationDetail, index) {
        ...
        $('#UpdateHistoryHiddenPayment').val(JSON.stringify($rootScope.TrackObjectChanges($rootScope.OldObject, $rootScope.tempSecondObject)));
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.status == "true") {
                        ...
                        if (data.practiceLocationDetail.PrimaryYesNoOption == 1) {
                            for (i = 0; i < $scope.PracticeLocationDetails.length; i++) {

                                if ($scope.PracticeLocationDetails[i].PrimaryYesNoOption == 1) {
                                    $scope.PracticeLocationDetails[i].PrimaryYesNoOption = 2;
                                    $scope.PracticeLocationDetails[i].IsPrimary = "NO";
    ...
    $scope.updateWorkersCompensationInformation = function (PracticeLocationDetail, index) {
        ...
        $('#UpdateHistoryHiddenWorkerCompensation').val(JSON.stringify($rootScope.TrackObjectChanges($rootScope.OldObject, $rootScope.tempSecondObject)));
    ...
    $scope.saveOpenPracticeStatus = function (PracticeLocationDetail, index) {
        ...
        $('#UpdateHistoryHiddenOpenStatus').val(JSON.stringify($rootScope.TrackObjectChanges($rootScope.OldObject, $rootScope.tempSecondObject)));
    ...
    $scope.updatePracticeLocationDetailInformaton = function (index) {
        ...
        $('#UpdateHistoryHiddenOtherInformation').val(JSON.stringify($rootScope.TrackObjectChanges($rootScope.OldObject, $rootScope.tempSecondObject)));
                    ...
                    if (data.status == "true") {
                        for (var i in $scope.facilities) {
                            if ($scope.facilities[i].FacilityID == data.practiceLocationDetail.FacilityId) {
                                ...
                                $scope.PracticeLocationDetails[index].Facility.Building = $scope.facilities[i].Building;
                                $scope.PracticeLocationDetails[index].Facility.City = $scope.facilities[i].City;
                                $scope.PracticeLocationDetails[index].Facility.Code = $scope.facilities[i].Code;
                                $scope.PracticeLocationDetails[index].Facility.Country = $scope.facilities[i].Country;
                                $scope.PracticeLocationDetails[index].Facility.CountryCodeFax = $scope.facilities[i].CountryCodeFax;
                                $scope.PracticeLocationDetails[index].Facility.CountryCodeTelephone = $scope.facilities[i].CountryCodeTelephone;
                                $scope.PracticeLocationDetails[index].Facility.County = $scope.facilities[i] .County;
                                $scope.PracticeLocationDetails[index].Facility.EmailAddress = $scope.facilities[i].EmailAddress;
                                $scope.PracticeLocationDetails[index].Facility.Fax = $scope.facilities[i].Fax;
                                $scope.PracticeLocationDetails[index].Facility.FaxNumber = $scope.facilities[i].FaxNumber;
                                $scope.PracticeLocationDetails[index].Facility.MobileNumber = $scope.facilities[i].MobileNumber;
                                $scope.PracticeLocationDetails[index].Facility.Name = $scope.facilities[i].Name;
                                $scope.PracticeLocationDetails[index].Facility.State = $scope.facilities[i].State;
                                $scope.PracticeLocationDetails[index].Facility.Street = $scope.facilities[i].Street;
                                $scope.PracticeLocationDetails[index].Facility.Telephone = $scope.facilities[i].Telephone;
                                $scope.PracticeLocationDetails[index].Facility.ZipCode = $scope.facilities[i].ZipCode;
                                //for (var j in $scope.facilities[i].FacilityDetail.Accessibility.FacilityAccessibilityQuestionAnswers) {                                    
                                //        $scope.PracticeLocationDetails[index].Facility.FacilityDetail.Accessibility.FacilityAccessibilityQuestionAnswers[j].Answer = $scope.facilities[i].FacilityDetail.Accessibility.FacilityAccessibilityQuestionAnswers[j].Answer;                                    
                                //}
                                $scope.PracticeLocationDetails[index].Facility.FacilityDetail.Accessibility = $scope.facilities[i].FacilityDetail.Accessibility;
                                $scope.PracticeLocationDetails[index].Facility.FacilityDetail.Service = $scope.facilities[i].FacilityDetail.Service;
                                $scope.PracticeLocationDetails[index].Facility.FacilityDetail.Language = $scope.facilities[i].FacilityDetail.Language;
                                $scope.PracticeLocationDetails[index].Facility.FacilityDetail.PracticeOfficeHour = $scope.facilities[i].FacilityDetail.PracticeOfficeHour;
                                $scope.PracticeLocationDetails[index].Facility.FacilityDetail.FacilityPracticeProviders = $scope.facilities[i].FacilityDetail.FacilityPracticeProviders;
                            }
                        }                        
                        ...
                        if ($scope.PracticeLocationDetails[index].PrimaryYesNoOption == 1) {
                            for (i = 0; i < $scope.PracticeLocationDetails.length; i++) {
                                if (i != index) {
                                    if ($scope.PracticeLocationDetails[i].PrimaryYesNoOption == 1) {
                                        $scope.PracticeLocationDetails[i].PrimaryYesNoOption = 2;
    ...
    $scope.saveCredentialingContact = function (index) {
        ...
        if ($scope.visibilityControl == 'addCc') {
            ...
            $('#UpdateHistoryHiddenCredentialingContract').val(JSON.stringify($rootScope.TrackObjectChanges($rootScope.OldObject, $rootScope.tempObject)));
    ...
    $scope.setValue = function (partner) {
        ...
        $scope.searchSpecialty = null;
        $scope.searchproviderType = null;
        $scope.PracticeSpecialties = [];
        $scope.PracticeProviderTypes = [];
    ...
    $scope.savePatner = function (PracticeLocationDetail, index) {
        ...
        $('#UpdateHistoryHiddenPartners').val(JSON.stringify($rootScope.TrackObjectChanges($rootScope.OldObject, $rootScope.tempSecondObject)));
