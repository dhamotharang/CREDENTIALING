...
profileApp.controller('LiabilityCtrl', ['$scope', '$rootScope', '$http', 'masterDataService', 'messageAlertEngine', '$filter', 'profileUpdates', function ($scope, $rootScope, $http, masterDataService, messageAlertEngine, $filter, profileUpdates) {
    ...
    $scope.ConstructOldandNewObject = function () {
        var PLOldObj = angular.copy($rootScope.OldObject);
        var PLnewObj = angular.copy($rootScope.tempObject);
        PLnewObj.PolicyIncludesTailCoverageOption = PLnewObj.PolicyIncludesTailCoverageOption != null ? (PLnewObj.PolicyIncludesTailCoverageOption == 1 ? "Yes" : "No") : null;
        PLnewObj.UnlimitedCoverageWithInsuranceCarrierOption = PLnewObj.UnlimitedCoverageWithInsuranceCarrierOption != null ? (PLnewObj.UnlimitedCoverageWithInsuranceCarrierOption == 1 ? "Yes" : "No") : null;
        PLnewObj.SelfInsuredYesNoOption = PLnewObj.SelfInsuredYesNoOption != null ? (PLnewObj.SelfInsuredYesNoOption == 1 ? "Yes" : "No") : null;
        PLOldObj.PolicyIncludesTailCoverageOption = PLOldObj.PolicyIncludesTailCoverageOption != null ? (PLOldObj.PolicyIncludesTailCoverageOption == 1 ? "Yes" : "No") : null;
        PLOldObj.UnlimitedCoverageWithInsuranceCarrierOption = PLOldObj.UnlimitedCoverageWithInsuranceCarrierOption != null ? (PLOldObj.UnlimitedCoverageWithInsuranceCarrierOption == 1 ? "Yes" : "No") : null;
        PLOldObj.SelfInsuredYesNoOption = PLOldObj.SelfInsuredYesNoOption != null ? (PLOldObj.SelfInsuredYesNoOption == 1 ? "Yes" : "No") : null;        
        PLOldObj.InsuranceCarrier != null ? PLOldObj.InsuranceCarrierID = PLOldObj.InsuranceCarrier.Name : null; PLOldObj.InsuranceCarrier = null;
        PLnewObj.InsuranceCarrier != null ? PLnewObj.InsuranceCarrierID = PLnewObj.InsuranceCarrier.Name : null; PLnewObj.InsuranceCarrier = null;
        PLOldObj.InsuranceCarrierAddress != null ? PLOldObj.InsuranceCarrierAddressID = PLOldObj.InsuranceCarrierAddress.LocationName : null; delete PLOldObj.InsuranceCarrierAddress.InsuranceCarrierAddressID; delete PLOldObj.InsuranceCarrierAddress.LastModifiedDate;
        PLnewObj.InsuranceCarrierAddress != null ? PLnewObj.InsuranceCarrierAddressID = PLnewObj.InsuranceCarrierAddress.LocationName : null; delete PLnewObj.InsuranceCarrierAddress.InsuranceCarrierAddressID; delete PLnewObj.InsuranceCarrierAddress.LastModifiedDate;
        PLOldObj.InsuranceCoverageType != null ? PLOldObj.InsuranceCoverageType == 1 ? PLOldObj.InsuranceCoverageType = "Individual" : PLOldObj.InsuranceCoverageType = "Shared" : null; delete PLOldObj.CoverageType; delete PLOldObj.LastModifiedDate;
        PLnewObj.InsuranceCoverageType != null ? PLnewObj.InsuranceCoverageType == 1 ? PLnewObj.InsuranceCoverageType = "Individual" : PLnewObj.InsuranceCoverageType = "Shared" : null; delete PLnewObj.CoverageType; delete PLnewObj.LastModifiedDate;
        return { "oldObject": PLOldObj, "newObject": PLnewObj };
    }
    ...
    $scope.saveProfessionalLiabilty = function (professionalLiabilty, index) {
        ...
        var myData = {};
        var formData1;
        var result = $scope.visibilityControl != 'addLi' ? $scope.ConstructOldandNewObject() : null;
        if ($scope.visibilityControl == 'addLi') {
            ...
            $('#UpdateHistoryHiddenForPL').val(JSON.stringify($rootScope.TrackObjectChanges(result.oldObject, result.newObject)));
