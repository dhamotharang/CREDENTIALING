...
using AHC.CD.Business.NPPESService;
...
namespace AHC.CD.WebUI.MVC.Areas.Initiation.Controllers
{
    public class ProviderController : Controller
    {
        ...
        public string GetProviderDatafromNPIRegistry(string key, string value)
        {
            NPPESService nppesservice = new NPPESService();//sample NPI -- "1922125038"
            var result = nppesservice.GetProviderDataFromNPI(key, value);
            return result;
        }
        ...
        private void SendEmail(string authUserId, string emailAddress,int profileId)
        {
            ...
            if (profile.PersonalDetail.ProviderLevel.Name.Equals("Doctor"))
            {
                ...
                confirmationLink = string.Format("Dear Provider,<br/><br/>"+
            ...
            string emailBody = string.Format("Dear All,<br/><br/>" +
                "Welcome " + profile.PersonalDetail.FirstName + " " + profile.PersonalDetail.LastName + " to the Access Family!<br/><br/>" +
