...
namespace AHC.CD.Data.Repository.Profiles
{
    public interface IProfileRepository : IGenericRepository<Profile>
    {
        ...
        void AddOtherLegalNameHistory(int profileId, int OtherLegalNameId,int CDUserID);
        ...
        void AddHomeAddressHistory(int profileId, int HomeAddressId,int CDUserID);
        ...
        void AddStateLicenseHistoryForRemoval(int profileId, int stateLicenseInformationID,int CDUserID);
        ...
        void AddFederalDEALicenseHistoryForRemoval(int profileId, int federalDEAInformationID,int CDUserID);
        FederalDEAInformation RemoveFederalDEALicense(int profileId, FederalDEAInformation federalDEALicense);
        ...
        void AddCDSCLicenseHistoryForRemoval(int profileId, int cDSCInformationID,int CDUserID);
        ...
        void AddMedicareInformationHistory(int profileId, int medicareInformationID,int CDUserID);
        ...
        void AddMedicaidInformationHistory(int profileId, int medicaidInformationID,int CDUserID);
        ...
        void AddHospitalPrivilegeHistory(int profileId, int hospitalPrivilegeDetailId,int CDUserID);
        ...
        void AddProfessionalAffiliationHistory(int profileId, int professionalAffiliationInfoID,int CDUserID);
        ...
        void AddProfessionalReferenceHistory(int profileId, int professionalReferenceInfoID,int CDUserID);
        void AddProfessionalLiabilityHistoryOnRemoval(int profileId, int professionalReferenceInfoID,int CDUserID);
        ...
        void AddCVAsync(int profileId, CVInformation cvInformation);
        void UpdateCVAsync(int profileId, CVInformation cvInformation);
        void RemoveCVAsync(int profileId, CVInformation cvInformation);
        ...
        void AddProfessionalWorkExperienceHistory(int profileId, int professionalWorkExperienceID,int CDUserID);
        ...
        void AddMilitaryServiceInformationHistory(int profileId, int militaryServiceInformationID,int CDUserID);
        ...
        void AddPublicHealthServiceHistory(int profileId, int publicHealthServiceID,int CDUserID);
        ...
        void AddWorkGapHistory(int profileId, int workGapID,int CDUserID);
        ...
        void AddEducationDetailHistory(int profileId, int educationDetailID,int CDUserID);
        ...
        void AddProgramDetailHistory(int profileId, int programDetailID,int CDUserID);
        ...
        void AddCertificationDetailHistory(int profileId, int cmeCertificationID,int userid);
        ...
        bool SetPracticeLocationPriority(int profileID);
        ...
        void AddContractGroupInformationHistory(int profileId, int contractInfoId, int contractGroupInfoId,int CDUserID);
        ...
        void AddOtherDocumentHistory(int profileId, int p,int CDUsreID);

        #endregion
        #region HelperMethod
        List<int> GetProfileIDsOfUltimateProviders();
        #endregion
        ...
        ICollection<Entities.DTO.ProfileReport> LoadProfilesForReport();
    }
}
