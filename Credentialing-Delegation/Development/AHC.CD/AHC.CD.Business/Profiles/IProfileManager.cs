...
namespace AHC.CD.Business
{
    public interface IProfileManager
    {
        ...
        string GetUserStatus(int cduserId);
        ProfileDocumentConfig GetProfileDocumentConfig(int profileID);
        ProfileDocumentConfig SaveProfileDocumentConfig(int profileID, ProfileDocumentConfig config);
        Task<List<int>> GetCCMUserID();
        List<ProfileDocument> GetAllProfileDocuments(int ProfileId);
        ...
        Task RemoveOtherLegalNameAsync(int profileId, OtherLegalName otherLegalName, string UserAuthID);
        ...
        Task RemoveHomeAddressAsync(int profileId, HomeAddress homeAddress, string UserAuthID);
        ...
        Task RemoveStateLicenseAsync(int profileId, StateLicenseInformation stateLicense, string UserAuthID);
        ...
        Task<FederalDEAInformation> RemoveFederalDEALicenseAsync(int profileId, FederalDEAInformation federalDEALicense, string UserAuthID);
        ...
        Task RemoveCDSCLicenseAsync(int profileId, CDSCInformation cdscLicense, string UserAuthID);
        ...
        Task RemoveMedicareInformationAsync(int profileId, MedicareInformation medicareInformation, string UserAuthID);
        ...
        Task RemoveMedicaidInformationAsync(int profileId, MedicaidInformation medicaidInformation, string UserAuthID);
        ...
        Task RemoveHospitalPrivilegeAsync(int profileId, HospitalPrivilegeDetail hospitalPrivilegeDetail, string UserAuthID);
        ...
        Task RemoveProfessionalLiabilityAsync(int profileId, ProfessionalLiabilityInfo professionalLiabilityInfo, string UserAuthID);
        ...
        Task RemoveProfessionalAffiliationAsync(int profileId, ProfessionalAffiliationInfo professionalAffiliation, string UserAuthID);
        ...
        Task RemoveProfessionalReferenceAsync(int profileId, ProfessionalReferenceInfo professionalReference, string UserAuthID);

        #endregion

        #region CV Upload

        Task<CVInformation> AddCVAsync(int profileId, CVInformation cvInformation, DocumentDTO document);
        ...
        Task RemoveProfessionalWorkExperienceAsync(int profileId, ProfessionalWorkExperience professionalWorkExperience, string UserAuthID);
        ...
        Task RemoveMilitaryServiceInformationAsync(int profileId, MilitaryServiceInformation militaryServiceInformation, string UserAuthID);
        ...
        Task RemovePublicHealthServiceAsync(int profileId, PublicHealthService publicHealthService, string UserAuthID);

        Task<int> AddWorkGapAsync(int profileId, WorkGap workGap);
        Task UpdateWorkGapAsync(int profileId, WorkGap workGap);
        Task RemoveWorkGapAsync(int profileId, WorkGap workGap, string UserAuthID);
        Task CheckWorkGapUpdates(int profileId, WorkGap workGap);
        ...
        Task RemoveEducationDetailAsync(int profileId, EducationDetail educationDetail, string UserAuthID);
        ...
        Task RemoveProgramDetailAsync(int profileId, ProgramDetail programDetail, string UserAuthID);
        ...
        Task RemoveCertificationDetailAsync(int profileId, CMECertification cmeCertification, string UserAuthID);
        ...
        Task RemoveContractGroupInformationAsync(int profileId, int contractInfoId, ContractGroupInfo contractGroupInfo, string UserAuthID);
        ...
        string UpdateOtherDocumentAsync(int profileId, Entities.DocumentRepository.OtherDocument dataModelOtherDocument, DocumentDTO document);

        Task RemoveOtherDocumentAsync(int profileId, Entities.DocumentRepository.OtherDocument dataModelOtherDocument, string UserAuthID);
        ...
        ProviderLevelCountStatsDTO GetAllProvidersCountByProviderLevels();

        #region DashBoard Task Expiry Count
        Task<object> GetTaskExpiryCounts(int? cdUserID);
        #endregion
        int GetUserId(string userAuthId);
        Task<bool> SaveUpdateHistory(string OldRecord, string UserAuthID, string SectionName, int SectionTableID, int ProfileIDOfRecord);
        Task<List<UpdateHistory>> GetUpdateHistoryOfARecord(string SectionName, int SectionTableID, int ProfileID);
        Task<List<UpdateHistory>> GetUpdateHistoryOfDisclosureRecord(string SectionName, int SectionTableID, int ProfileID);
    }
}
