                ...
                foreach (var profile in profiles)
                {
                    if (profile != null)
                    {
                        if (profile.PersonalDetail != null && profile.PersonalDetail.MiddleName != null)
                            providers.Add(new { ProfileId = profile.ProfileID, Status= profile.Status, Name = profile.PersonalDetail.FirstName.Trim() + " " + profile.PersonalDetail.MiddleName.Trim() + " " + profile.PersonalDetail.LastName.Trim() + "-" + profile.OtherIdentificationNumber.NPINumber, HospitalInfo = profile.HospitalPrivilegeInformation });
                        else
                            providers.Add(new { ProfileId = profile.ProfileID, Status= profile.Status, Name = profile.PersonalDetail.FirstName.Trim() + " " + profile.PersonalDetail.LastName.Trim() + "-" + profile.OtherIdentificationNumber.NPINumber, HospitalInfo = profile.HospitalPrivilegeInformation });
                    }
