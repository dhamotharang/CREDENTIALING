...
namespace AHC.CD.Data.EFRepository.Profiles
{
    internal class ProfileEFRepository : EFGenericRepository<Profile>, IProfileRepository
    {
        ...
        public void AddOtherLegalNameHistory(int profileId, int OtherLegalNameId,int CDUserID)
        {
            try
            {
                Profile profile = FindProfile(profileId);
                if (IsProviderExists(profileId, profile))
                {
                    ...
                    addOtherLegalNameHistory = AutoMapper.Mapper.Map<OtherLegalName, OtherLegalNameHistory>(updateOtherLegalName, addOtherLegalNameHistory);
                        ...
                        addOtherLegalNameHistory.DeletedById = CDUserID;
        ...
        public void AddHomeAddressHistory(int profileId, int HomeAddressId,int CDUserID)
        {
            try
            {
                Profile profile = FindProfile(profileId);
                if (IsProviderExists(profileId, profile))
                {
                    ...
                    addHomeAddressHistory.DeletedById = CDUserID;
        ...
        public void AddStateLicenseHistoryForRemoval(int profileId, int stateLicenseInformationID,int CDUserID)
        {
            try
            {
                Profile profile = FindProfile(profileId);
                if (IsProviderExists(profileId, profile))
                {
                    ...
                    addStateLicenseInformationHistory.DeletedById = CDUserID;
        ...
        public void AddFederalDEALicenseHistoryForRemoval(int profileId, int federalDEAInformationID,int CDUserID)
        {
            try
            {
                Profile profile = FindProfile(profileId);
                if (IsProviderExists(profileId, profile))
                {
                    ...
                    addFederalDEAInformationHistory.DeletedById = CDUserID;
        ...
        public void AddCDSCLicenseHistoryForRemoval(int profileId, int cDSCInformationID,int CDUserID)
        {
            try
            {
                Profile profile = FindProfile(profileId);
                if (IsProviderExists(profileId, profile))
                {
                    ...
                    addCDSCInformationHistory.DeletedById = CDUserID;
        ...
        public void AddMedicareInformationHistory(int profileId, int medicareInformationID,int CDUserID)
        {
            try
            {
                Profile profile = FindProfile(profileId);
                if (IsProviderExists(profileId, profile))
                {
                    ...
                    addMedicareInformationHistory.DeletedById = CDUserID;
        ...
        public void AddMedicaidInformationHistory(int profileId, int medicaidInformationID,int CDUserID)
        {
            try
            {
                Profile profile = FindProfile(profileId);
                if (IsProviderExists(profileId, profile))
                {
                    ...
                    addMedicaidInformationHistory.DeletedById = CDUserID;
        ...
        public void AddHospitalPrivilegeHistory(int profileId, int hospitalPrivilegeDetailId,int CDUserID)
        {
            try
            {
                Profile profile = FindProfile(profileId);
                if (IsProviderExists(profileId, profile))
                {
                    ...
                    addHospitalPrivilegeDetailHistory.DeletedById = CDUserID;
        ...
        public void AddProfessionalLiabilityHistoryOnRemoval(int profileId, int professionalLiabilityInfoId,int CDUserID)
        {
            try
            {
                Profile profile = FindProfile(profileId);
                if (IsProviderExists(profileId, profile))
                {
                    ...
                    addProfessionalLiabilityInfoHistory.DeletedById = CDUserID;
        ...
        public void AddProfessionalAffiliationHistory(int profileId, int professionalAffiliationInfoID,int CDUserID)
        {
            try
            {
                Profile profile = FindProfile(profileId);
                if (IsProviderExists(profileId, profile))
                {
                    ...
                    addProfessionalAffiliationInfoHistory.DeletedById = CDUserID;
        ...
        public void AddProfessionalReferenceHistory(int profileId, int professionalReferenceInfoID,int CDUserID)
        {
            try
            {
                Profile profile = FindProfile(profileId);
                if (IsProviderExists(profileId, profile))
                {
                    ...
                    addProfessionalReferenceInfoHistory.DeletedById = CDUserID;
        ...
        public void UpdateCVAsync(int profileId, CVInformation cvInformation)
        {
            try
            {
                Profile profile = FindProfile(profileId);
                profile.CVInformation = cvInformation;
               // updateCVInformation = AutoMapper.Mapper.Map<CVInformation, CVInformation>(cvInformation, updateCVInformation);
                Update(profile);
            }
            catch (Exception ex)
            {
        ...
        public void AddProfessionalWorkExperienceHistory(int profileId, int professionalWorkExperienceID,int CDUserID)
        {
            try
            {
                Profile profile = FindProfile(profileId);
                if (IsProviderExists(profileId, profile))
                {
                    ...
                    addProfessionalWorkExperienceHistory.DeletedById = CDUserID;
        ...
        public void AddMilitaryServiceInformationHistory(int profileId, int militaryServiceInformationID,int CDUserID)
        {
            try
            {
                Profile profile = FindProfile(profileId);
                if (IsProviderExists(profileId, profile))
                {
                    ...
                    addMilitaryServiceInformationHistory.DeletedById = CDUserID;
        ...
        public void AddPublicHealthServiceHistory(int profileId, int publicHealthServiceID,int CDUserID)
        {
            try
            {
                Profile profile = FindProfile(profileId);
                if (IsProviderExists(profileId, profile))
                {
                    ...
                    addPublicHealthServiceHistory.DeletedById = CDUserID;
        ...
        public void AddWorkGapHistory(int profileId, int workGapID,int CDUserID)
        {
            try
            {
                Profile profile = FindProfile(profileId);
                if (IsProviderExists(profileId, profile))
                {
                    ...
                    addWorkGapHistory.DeletedById = CDUserID;
        ...
        public void AddEducationDetailHistory(int profileId, int educationDetailID,int CDUserID)
        {
            try
            {
                ...
                if (IsProviderExists(profileId, profile))
                {
                    ...
                    addEducationDetailHistory.DeletedById = CDUserID;
        ...
        public void AddCertificationDetailHistory(int profileId, int cmeCertificationID,int CDUserId)
        {
            try
            {
                Profile profile = FindProfile(profileId);
                if (IsProviderExists(profileId, profile))
                {
                    ...
                    addCertificationDetailHistory.DeletedById = CDUserId;
        ...
        public void AddProgramDetailHistory(int profileId, int programDetailID,int CDUserID)
        {
            try
            {
                Profile profile = FindProfile(profileId);
                if (IsProviderExists(profileId, profile))
                {
                    ...
                    addProgramDetailHistory.DeletedById = CDUserID;
        ...
        public bool SetPracticeLocationPriority(int profileID)
        {
            try
            {
                var Profile = Find(x => x.ProfileID == profileID, "PracticeLocationDetails");
                var PrimaryPracticeLocation = Profile.PracticeLocationDetails.Where(x => x.PrimaryYesNoOption == AHC.CD.Entities.MasterData.Enums.YesNoOption.YES).FirstOrDefault();
                if (PrimaryPracticeLocation != null)
                {
                    PrimaryPracticeLocation.PrimaryYesNoOption = AHC.CD.Entities.MasterData.Enums.YesNoOption.NO;
                    Update(Profile);
                    Save();
                }
                return true;
        ...
        public void AddPracticeLocation(int profileId, PracticeLocationDetail practiceLocationDetail)
        {
            try
            {
                ...
                if (IsProviderExists(profileId, profile))
                {
                    ...
                    else   if(practiceLocationDetail.IsPrimary==AHC.CD.Entities.MasterData.Enums.YesNoOption.YES.ToString())
                    {
                        var PrimaryPracticeLocation = profile.PracticeLocationDetails.Where(x => x.IsPrimary == AHC.CD.Entities.MasterData.Enums.YesNoOption.YES.ToString()).FirstOrDefault();
                        if (PrimaryPracticeLocation != null)
                        {
                            PrimaryPracticeLocation.PrimaryYesNoOption = AHC.CD.Entities.MasterData.Enums.YesNoOption.NO;
                        }
        ...
        public void AddContractGroupInformationHistory(int profileId, int contractInfoId, int contractGroupInfoId,int CDUserID)
        {
            try
            {
                Profile profile = FindProfile(profileId);
                if (IsProviderExists(profileId, profile))
                {
                    ...
                    addContractGroupInfoHistory.DeletedById = CDUserID;
        ...
        public void AddOtherDocumentHistory(int profileId, int OtherDocumentId,int CDUserID)
        {
            try
            {
                Profile profile = FindProfile(profileId);
                if (IsProviderExists(profileId, profile))
                {
                    ...
                    addOtherDocumentHistory.DeletedById = CDUserID;
        ...
        #endregion
           public List<int> GetProfileIDsOfUltimateProviders()
            {
                EFEntityContext context=new EFEntityContext();
                 List<int?> CredentialingInfoIds=(from x in context.ContractGrids.Where(x=>x.Status==AHC.CD.Entities.MasterData.Enums.StatusType.Active.ToString()).Where( x=>x.ContractGridStatus==AHC.CD.Entities.MasterData.Enums.StatusType.Active.ToString()) select x.CredentialingInfoID).ToList();
                    List<int?> ProfileIds=(from con in context.CredentialingInfoes where (con.PlanID==49 ||con.PlanID== 58)  && con.Status==AHC.CD.Entities.MasterData.Enums.StatusType.Active.ToString() && CredentialingInfoIds.Contains(con.CredentialingInfoID) select con.ProfileID).ToList(); 
                return ProfileIds.Select(x=>x).OfType<int>().ToList();
        
             }
           #region MobileApp Service
           public object GetAllExpiriesForAProvider(int ProfileID)
           {
               try
               {
                   string IncludeProperties = @"HospitalPrivilegeInformation,
...
CDSCInformations,
SpecialtyDetails,
SpecialtyDetails.SpecialtyBoardCertifiedDetail,
...
ProfessionalLiabilityInfoes.InsuranceCarrier,";
                   Profile profile = Find(x => x.ProfileID == ProfileID, IncludeProperties);

                   List<DEALicenseExpiry> FederalDEAExpiry = new List<DEALicenseExpiry>();
                   List<SpecialtyDetailExpiry> SpecialityExpiry = new List<SpecialtyDetailExpiry>();
                   List<StateLicenseExpiry> StateLicenseExpiry = new List<StateLicenseExpiry>();
                   List<ProfessionalLiabilityExpiry> ProfessionalLiability = new List<ProfessionalLiabilityExpiry>();
                   List<MedicareExpiry> medicare = new List<MedicareExpiry>();
                   List<MedicaidExpiry> Medicaid = new List<MedicaidExpiry>();
                   List<HospitalPrivilegeExpiry> HospitalPrivileage = new List<HospitalPrivilegeExpiry>();
                   List<CDSCInfoExpiry> CDSC = new List<CDSCInfoExpiry>();
                 
                   foreach (var fdexpiry in profile.FederalDEAInformations)
                   {
                       DEALicenseExpiry FD = new DEALicenseExpiry();
                       FD.DEANumber = fdexpiry.DEANumber;
                       FD.StateOfReg = fdexpiry.StateOfReg;
                       FD.ExpiryDate = fdexpiry.ExpiryDate;
                       FederalDEAExpiry.Add(FD);
                   }
                   foreach (var SpExpiry in profile.SpecialtyDetails)
                   {
                       if (SpExpiry.IsBoardCertified == "YES")
                       {
                           SpecialtyDetailExpiry spd = new SpecialtyDetailExpiry();
                           spd.ExpiryDate = SpExpiry.SpecialtyBoardCertifiedDetail != null ? SpExpiry.SpecialtyBoardCertifiedDetail.ExpirationDate : null;
                           spd.SpecialtyName = SpExpiry.Specialty != null ? SpExpiry.Specialty.Name : null;
                           spd.SpecialtyBoardName = SpExpiry.SpecialtyBoardCertifiedDetail != null ? SpExpiry.SpecialtyBoardCertifiedDetail.SpecialtyBoard != null ? SpExpiry.SpecialtyBoardCertifiedDetail.SpecialtyBoard.Name : null : null;
                           spd.CertificateNumber = SpExpiry.SpecialtyBoardCertifiedDetail != null ? SpExpiry.SpecialtyBoardCertifiedDetail.CertificateNumber : null;
                           SpecialityExpiry.Add(spd);
                       }
                   }
                   foreach (var StateLicense in profile.StateLicenses)
                   {
                       StateLicenseExpiry sle = new StateLicenseExpiry();
                       sle.ExpiryDate = StateLicense.ExpiryDate;
                       sle.IssueDate = StateLicense.IssueDate;
                       sle.IssueState = StateLicense.IssueState;
                       sle.LicenseNumber = StateLicense.LicenseNumber;
                       StateLicenseExpiry.Add(sle);
                   }
                   foreach (var ProfLiab in profile.ProfessionalLiabilityInfoes)
                   {
                       ProfessionalLiabilityExpiry ple = new ProfessionalLiabilityExpiry();
                       ple.EffectiveDate = ProfLiab.EffectiveDate;
                       ple.ExpirationDate = ProfLiab.ExpirationDate;
                       ple.InsuranceCarrier = ProfLiab.InsuranceCarrier != null ? ProfLiab.InsuranceCarrier.Name : null;
                       ple.PolicyNumber = ProfLiab.PolicyNumber;
                       
                       ProfessionalLiability.Add(ple);

                   }
                   foreach (var Medicare in profile.MedicareInformations)
                   {
                       MedicareExpiry me = new MedicareExpiry();
                       me.ExpirationDate = Medicare.ExpirationDate;
                       me.LicenseNumber = Medicare.LicenseNumber;
                       medicare.Add(me);
                   }
                   foreach (var Medc in profile.MedicaidInformations)
                   {
                       MedicaidExpiry me = new MedicaidExpiry();
                       me.LicenseNumber = Medc.LicenseNumber;
                       me.ExpirationDate = Medc.ExpirationDate;
                       Medicaid.Add(me);
                   }
                   foreach (var Hosp in profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails)
                   {
                       HospitalPrivilegeExpiry he = new HospitalPrivilegeExpiry();
                       //he.AffiliationEndDate=Hosp
                       he.AffiliationEndDate = Hosp.AffiliationEndDate;
                       he.AffilicationStartDate = Hosp.AffilicationStartDate;
                       he.HospitalName = Hosp.Hospital != null ? Hosp.Hospital.HospitalName : null;
                       HospitalPrivileage.Add(he);
                   }
                   foreach (var cdsc in profile.CDSCInformations)
                   {
                       CDSCInfoExpiry ce = new CDSCInfoExpiry();
                       ce.CertNumber = cdsc.CertNumber;
                       ce.State = cdsc.State;
                       ce.ExpiryDate = cdsc.ExpiryDate;
                       CDSC.Add(ce);


                   }

                   object expiry = new { MedicaidExpiry = Medicaid, MedicareExpiry = medicare, HospitalPrivilageExpiry = HospitalPrivileage, StateExpiry = StateLicenseExpiry, FederalDEAExpiry = FederalDEAExpiry, CDSExpiry = CDSC, SpecialityExpiry = SpecialityExpiry, ProvisionalLiablity = ProfessionalLiability };
                   return expiry;
           ...
           public object GetAccountInfo(int ProfileID)
           {
               try
               {
                   ...
                   string IncludeProperties = "PersonalDetail,HomeAddresses,ContactDetail,ContactDetail.EmailIDs,ContactDetail.PhoneDetails,PersonalDetail,PersonalDetail.ProviderLevel";

                   Profile profile = Find(x => x.ProfileID == ProfileID, IncludeProperties);
                   HomeAddress HomeAddress = profile.HomeAddresses.Where( x=>x.StatusType == AHC.CD.Entities.MasterData.Enums.StatusType.Active ).FirstOrDefault();
                 
                   object ProviderAccountInfo = new
                   {
                       ...
                       Salutation=profile.PersonalDetail!=null?profile.PersonalDetail.Salutation:null,
                       Address = HomeAddress != null ? new { UnitNumber = HomeAddress.UnitNumber, Street = HomeAddress.Street, Country = HomeAddress.Country, State = HomeAddress.State, County = HomeAddress.County, ZipCode = HomeAddress.ZipCode } : null,
                       Email = profile.ContactDetail != null ? profile.ContactDetail.EmailIDs != null ? profile.ContactDetail.EmailIDs.Where(x => x.StatusType == AHC.CD.Entities.MasterData.Enums.StatusType.Active && x.PreferenceType == AHC.CD.Entities.MasterData.Enums.PreferenceType.Primary).Select(x => x.EmailAddress).FirstOrDefault() : null : null,
                       PhoneNumber = profile.ContactDetail != null ? (profile.ContactDetail.PhoneDetails != null ? profile.ContactDetail.PhoneDetails.Where(x => x.PhoneTypeEnum == AHC.CD.Entities.MasterData.Enums.PhoneTypeEnum.Home).Select(x => x.PhoneNumber).FirstOrDefault() : null) : null,
                       NPI = profile.OtherIdentificationNumber != null ? profile.OtherIdentificationNumber.NPINumber : null,
                       Title = profile.PersonalDetail != null ? (profile.PersonalDetail.ProviderLevel != null ? profile.PersonalDetail.ProviderLevel.Name : null) : null,
                   };
           ...
           public object GetProfileIDByEmail(string EmailID)
           {
               try
               {
                   ...
                   int profileID = context.Profiles.Where(x => x.ContactDetail.EmailIDs.Any(y => y.EmailAddress == EmailID)).Select(x => x.ProfileID).FirstOrDefault();
                   if (profileID != 0)
                   {
                       var PersonalDetails = context.Profiles.Where(x => x.ContactDetail.EmailIDs.Any(y => y.EmailAddress == EmailID)).Select(x => x.PersonalDetail).FirstOrDefault();
                       string ProfilePicPath = context.Profiles.Where(x => x.ProfileID == profileID).Select(x => x.ProfilePhotoPath).FirstOrDefault();
                       string Name = null;
                       if (PersonalDetails != null)
                       {
                           ...
                           // string.Concat(PersonalDetails.Salutation?+"."+PersonalDetails.FirstName+" "+" "+PersonalDetails.MiddleName)

                       }
                       return new { ProfileID = profileID, Name = Name,ProfilePicPath=ProfilePicPath };//Find(x => x.ContactDetail.EmailIDs.Any(x=>x.EmailAddress==EmailID), "ContactDetail,ContactDetail.EmailIDs");
                   }
                   else
                   {
                       throw new  ProfileNotFoundException(ExceptionMessage.PROFILE_NOT_FOUND_ForEmail);
                   }
               }
               catch (Exception)
               {
       ...
       public object GetAllExpiryDates(int ProfileID)
           {
               try
               {
                   ...
                   EFEntityContext context = new EFEntityContext();
                   var Expiries = (from profile in context.Profiles.Where(x => x.ProfileID == ProfileID)
                                   select new
                                   {
                                       specialityexpiries = profile.SpecialtyDetails.Where(x => x.IsBoardCertified == "YES" && x.Status == AHC.CD.Entities.MasterData.Enums.StatusType.Active.ToString()).Select(x => x.SpecialtyBoardCertifiedDetail.ExpirationDate).ToList(),
                                       StateLicenseExpiries = profile.StateLicenses.Where(x => x.Status == AHC.CD.Entities.MasterData.Enums.StatusType.Active.ToString()).Select(x => x.ExpiryDate).ToList(),
                                       HospitalPrivileageExpiry = profile.HospitalPrivilegeInformation.HospitalPrivilegeDetails.Where(x => x.Status == AHC.CD.Entities.MasterData.Enums.StatusType.Active.ToString()).Select(x => x.AffiliationEndDate).ToList(),
                                       MedicareExpiries = profile.MedicareInformations.Where(x => x.Status == AHC.CD.Entities.MasterData.Enums.StatusType.Active.ToString()).Select(x => x.ExpirationDate).ToList(),
                                       MedicaidExpiries = profile.MedicaidInformations.Where(x => x.Status == AHC.CD.Entities.MasterData.Enums.StatusType.Active.ToString()).Select(x => x.ExpirationDate).ToList(),
                                       DEAExpiries = profile.FederalDEAInformations.Where(x => x.Status == AHC.CD.Entities.MasterData.Enums.StatusType.Active.ToString()).Select(x => x.ExpiryDate).ToList(),
                                       CDSCExpiries = profile.CDSCInformations.Where(x => x.Status == AHC.CD.Entities.MasterData.Enums.StatusType.Active.ToString()).Select(x => x.ExpiryDate).ToList(),
                                       ProfessionalLiabiltyExpiries = profile.ProfessionalLiabilityInfoes.Where(x => x.Status == AHC.CD.Entities.MasterData.Enums.StatusType.Active.ToString()).Select(x => x.ExpirationDate).ToList()
                                   }).ToList();
                   return Expiries;
               }
               catch (Exception)
        ...
        public int GetCountOfPlansForAProvider(int ProfileID)
       {
           ...
           {
               EFEntityContext context = new EFEntityContext();
               var count = (from credentialinginfo in context.ContractGrids.Where(x=>x.Status==AHC.CD.Entities.MasterData.Enums.StatusType.Active.ToString() && x.ContractGridStatus==AHC.CD.Entities.MasterData.Enums.StatusType.Active.ToString() && x.CredentialingInfo.ProfileID==ProfileID).Select(x=>x.CredentialingInfo) select credentialinginfo.PlanID).Distinct().Count();
        ...
        public int GetCDUserIDByProfileID(int ProfileID)
        {
            ...
            {
                EFEntityContext context = new EFEntityContext();
                return context.Users.Where(x => x.ProfileId == ProfileID).Select(x => x.CDUserID).FirstOrDefault();
            }
            catch
            {
                return 0;
        ...
        public ICollection<ProfileReport> LoadProfilesForReport() {


            var obj = from t in context.Set<CredentialingInfo>().Include("Profile.LanguageInfo")
                 
                      select  new ProfileReport { PersonalDetail = t.Profile.PersonalDetail,
                                                  PracticeLocationDetails = t.Profile.PracticeLocationDetails,
                                                  LanguageDetails = t.Profile.LanguageInfo,
                                                  SpecialityDetails = t.Profile.SpecialtyDetails,
        ...
        {
            ProfileEFRepository ef = new ProfileEFRepository();
            Console.WriteLine(ef.LoadProfilesForReport());
            return 0;
        }
        /// <summary>
