...
{
    public class ProviderDrilldownReportService : IProviderDrilldownReportService
    {
        ...
        public ProviderDrilldownReportService()
        {
            ...
            cPayerList.Add(new CPayerListViewModel { ID = 1, Payer = "FREEDOM HEALTH PLAN", BillingProviderCount = "10", ClaimsSubmitted = "542", ClaimsAccepted = "0", ClaimsPending = "0", ClaimsRejected = "542" });
            cPayerList.Add(new CPayerListViewModel { ID = 2, Payer = "ULTIMATE HEALTH PLAN", BillingProviderCount = "10", ClaimsSubmitted = "542", ClaimsAccepted = "0", ClaimsPending = "532", ClaimsRejected = "10" });
            cPayerList.Add(new CPayerListViewModel { ID = 3, Payer = "COVENTRY HEALTH PLAN", BillingProviderCount = "10", ClaimsSubmitted = "542", ClaimsAccepted = "0", ClaimsPending = "0", ClaimsRejected = "542" });
            cPayerList.Add(new CPayerListViewModel { ID = 4, Payer = "HUMANA HEALTH PLAN", BillingProviderCount = "10", ClaimsSubmitted = "542", ClaimsAccepted = "0", ClaimsPending = "0", ClaimsRejected = "542" });
            cPayerList.Add(new CPayerListViewModel { ID = 1, Payer = "FREEDOM HEALTH PLAN", BillingProviderCount = "10", ClaimsSubmitted = "542", ClaimsAccepted = "0", ClaimsPending = "0", ClaimsRejected = "542" });
            cPayerList.Add(new CPayerListViewModel { ID = 2, Payer = "ULTIMATE HEALTH PLAN", BillingProviderCount = "10", ClaimsSubmitted = "542", ClaimsAccepted = "0", ClaimsPending = "532", ClaimsRejected = "10" });
            cPayerList.Add(new CPayerListViewModel { ID = 3, Payer = "COVENTRY HEALTH PLAN", BillingProviderCount = "10", ClaimsSubmitted = "542", ClaimsAccepted = "0", ClaimsPending = "0", ClaimsRejected = "542" });
            cPayerList.Add(new CPayerListViewModel { ID = 4, Payer = "HUMANA HEALTH PLAN", BillingProviderCount = "10", ClaimsSubmitted = "542", ClaimsAccepted = "0", ClaimsPending = "0", ClaimsRejected = "542" });
            ...
            aPayerList.Add(new APayerListViewModel { ID = 1, Payer = "FREEDOM HEALTH PLAN", BillingProviderCount = "10", Billed = "542", Allowed = "0", Paid = "0", Adj = "542", Ded = "0", Pending = "0", Denied = "0" });
            aPayerList.Add(new APayerListViewModel { ID = 2, Payer = "ULTIMATE HEALTH PLAN", BillingProviderCount = "10", Billed = "542", Allowed = "0", Paid = "0", Adj = "542", Ded = "0", Pending = "0", Denied = "0" });
            aPayerList.Add(new APayerListViewModel { ID = 3, Payer = "COVENTRY HEALTH PLAN", BillingProviderCount = "10", Billed = "542", Allowed = "0", Paid = "0", Adj = "542", Ded = "0", Pending = "0", Denied = "0" });
            aPayerList.Add(new APayerListViewModel { ID = 4, Payer = "HUMANA HEALTH PLAN", BillingProviderCount = "10", Billed = "542", Allowed = "0", Paid = "0", Adj = "542", Ded = "0", Pending = "0", Denied = "0" });
            aPayerList.Add(new APayerListViewModel { ID = 1, Payer = "FREEDOM HEALTH PLAN", BillingProviderCount = "10", Billed = "542", Allowed = "0", Paid = "0", Adj = "542", Ded = "0", Pending = "0", Denied = "0" });
            aPayerList.Add(new APayerListViewModel { ID = 2, Payer = "ULTIMATE HEALTH PLAN", BillingProviderCount = "10", Billed = "542", Allowed = "0", Paid = "0", Adj = "542", Ded = "0", Pending = "0", Denied = "0" });
            aPayerList.Add(new APayerListViewModel { ID = 3, Payer = "COVENTRY HEALTH PLAN", BillingProviderCount = "10", Billed = "542", Allowed = "0", Paid = "0", Adj = "542", Ded = "0", Pending = "0", Denied = "0" });
            aPayerList.Add(new APayerListViewModel { ID = 4, Payer = "HUMANA HEALTH PLAN", BillingProviderCount = "10", Billed = "542", Allowed = "0", Paid = "0", Adj = "542", Ded = "0", Pending = "0", Denied = "0" });
            ...
            cRenderingProvider.Add(new CRenderingProviderListViewModel { ID = 1, RenderingProvider = "CHRISTOPHER COPPOLA", MemberCount = "1", ClaimsSubmitted = "23", ClaimsAccepted = "12", ClaimsRejected = "0", ClaimsPending = "11" });
            cRenderingProvider.Add(new CRenderingProviderListViewModel { ID = 2, RenderingProvider = "CHRISTOPHER COPPOLA", MemberCount = "1", ClaimsSubmitted = "36", ClaimsAccepted = "22", ClaimsRejected = "11", ClaimsPending = "3" });
            cRenderingProvider.Add(new CRenderingProviderListViewModel { ID = 3, RenderingProvider = "ASIF MASOOD", MemberCount = "1", ClaimsSubmitted = "12", ClaimsAccepted = "0", ClaimsRejected = "0", ClaimsPending = "12" });
            cRenderingProvider.Add(new CRenderingProviderListViewModel { ID = 4, RenderingProvider = "BONNIE GIAMMATTEI", MemberCount = "1", ClaimsSubmitted = "34", ClaimsAccepted = "24", ClaimsRejected = "0", ClaimsPending = "10" });
            cRenderingProvider.Add(new CRenderingProviderListViewModel { ID = 5, RenderingProvider = "BONNIE GIAMMATTEI", MemberCount = "1", ClaimsSubmitted = "3", ClaimsAccepted = "1", ClaimsRejected = "0", ClaimsPending = "2" });
            cRenderingProvider.Add(new CRenderingProviderListViewModel { ID = 7, RenderingProvider = "ASIF MASOOD", MemberCount = "1", ClaimsSubmitted = "22", ClaimsAccepted = "11", ClaimsRejected = "11", ClaimsPending = "0" });
            cRenderingProvider.Add(new CRenderingProviderListViewModel { ID = 6, RenderingProvider = "CHRISTOPHER COPPOLA", MemberCount = "1", ClaimsSubmitted = "20", ClaimsAccepted = "9", ClaimsRejected = "6", ClaimsPending = "5" });
            cRenderingProvider.Add(new CRenderingProviderListViewModel { ID = 8, RenderingProvider = "CHRISTOPHER COPPOLA", MemberCount = "1", ClaimsSubmitted = "28", ClaimsAccepted = "11", ClaimsRejected = "8", ClaimsPending = "9" });
            cRenderingProvider.Add(new CRenderingProviderListViewModel { ID = 9, RenderingProvider = "ASIF MASOOD", MemberCount = "1", ClaimsSubmitted = "23", ClaimsAccepted = "23", ClaimsRejected = "0", ClaimsPending = "0" });

            aRenderingProvider.Add(new ARenderingProviderListViewModel { ID = 1, RenderingProvider = "CHRISTOPHER COPPOLA", MemberCount = "1", Billed = "186.15", Allowed = "0.00", Adj = "0.00", Ded = "0.00", Denied = "0.00", Paid = "121.00", Pending = "65.15" });
            aRenderingProvider.Add(new ARenderingProviderListViewModel { ID = 2, RenderingProvider = "CHRISTOPHER COPPOLA", MemberCount = "1", Billed = "186.15", Allowed = "0.00", Adj = "0.00", Ded = "0.00", Denied = "0.00", Paid = "121.00", Pending = "65.15" });
            aRenderingProvider.Add(new ARenderingProviderListViewModel { ID = 3, RenderingProvider = "ASIF MASOOD", MemberCount = "1", Billed = "186.15", Allowed = "0.00", Adj = "0.00", Ded = "0.00", Denied = "0.00", Paid = "121.00", Pending = "65.15" });
            aRenderingProvider.Add(new ARenderingProviderListViewModel { ID = 4, RenderingProvider = "BONNIE GIAMMATTEI", MemberCount = "1", Billed = "186.15", Allowed = "0.00", Adj = "0.00", Ded = "0.00", Denied = "0.00", Paid = "121.00", Pending = "65.15" });
            aRenderingProvider.Add(new ARenderingProviderListViewModel { ID = 5, RenderingProvider = "BONNIE GIAMMATTEI", MemberCount = "1", Billed = "186.15", Allowed = "0.00", Adj = "0.00", Ded = "0.00", Denied = "0.00", Paid = "121.00", Pending = "65.15" });
            aRenderingProvider.Add(new ARenderingProviderListViewModel { ID = 7, RenderingProvider = "ASIF MASOOD", MemberCount = "1", Billed = "186.15", Allowed = "0.00", Adj = "0.00", Ded = "0.00", Denied = "0.00", Paid = "121.00", Pending = "65.15" });
            aRenderingProvider.Add(new ARenderingProviderListViewModel { ID = 8, RenderingProvider = "CHRISTOPHER COPPOLA", MemberCount = "1", Billed = "186.15", Allowed = "0.00", Adj = "0.00", Ded = "0.00", Denied = "0.00", Paid = "121.00", Pending = "65.15" });
            aRenderingProvider.Add(new ARenderingProviderListViewModel { ID = 9, RenderingProvider = "ASIF MASOOD", MemberCount = "1", Billed = "186.15", Allowed = "0.00", Adj = "0.00", Ded = "0.00", Denied = "0.00", Paid = "121.00", Pending = "65.15" });
            aRenderingProvider.Add(new ARenderingProviderListViewModel { ID = 10, RenderingProvider = "BONNIE GIAMMATTEI", MemberCount = "1", Billed = "186.15", Allowed = "0.00", Adj = "0.00", Ded = "0.00", Denied = "0.00", Paid = "121.00", Pending = "65.15" });
            aRenderingProvider.Add(new ARenderingProviderListViewModel { ID = 11, RenderingProvider = "CHRISTOPHER COPPOLA", MemberCount = "1", Billed = "186.15", Allowed = "0.00", Adj = "0.00", Ded = "0.00", Denied = "0.00", Paid = "121.00", Pending = "65.15" });
        ...
        public Models.PayerDrilldownReport.CPayerReportViewModel GetPayerClaimsCountReport(int BillingProviderId, int RenderingProviderId)
        {
        ...
        public Models.PayerDrilldownReport.APayerReportViewModel GetPayerClaimsAmountReport(int BillingProviderId, int RenderingProviderId)
        {
        ...
        public Models.PayerDrilldownReport.CRenderingProviderReportViewModel GetRenderingProviderCountReport()
        {
        ...
        public Models.PayerDrilldownReport.ARenderingProviderReportViewModel GetRenderingProviderAmountReport()
        {
        ...
        public Models.PayerDrilldownReport.CBillingProviderReportViewModel GetBillingClaimsCountReport(int RenderingProviderId)
        {
        ...
        public Models.PayerDrilldownReport.ABillingProviderReportViewModel GetBillingClaimsAmountReport(int RenderingProviderId)
        {
