...
{
    public class Cms1500ViewModels
    {
        [DisplayName("FROM")]
        ...
        [DisplayName("DATE OF CURRENT ILLNESS/INJURY/PREGANANCY")]
        ...
        [DisplayName("INSURED'S POLICY GROUP OR FECA NUMBER")]
        public string SubscriberGroup_PolicyNo { get; set; }

        [DisplayName("INSURED'S BIRTH DATE")]
        ...
        [DisplayName("IS THERE ANOTHER HEALTH BENEFIT PLAN?")]
        ...
        [DisplayName("RESERVED FOR NUCC USE")]
        ...
        [DisplayName("ORDERING PHYSICIAN NPI")]
        public string OrderingProviderIdentifier1 { get; set; }

        [DisplayName("ORDERING PHYSICIAN ID")]
        public string OrderingProviderIdentifier2 { get; set; }
