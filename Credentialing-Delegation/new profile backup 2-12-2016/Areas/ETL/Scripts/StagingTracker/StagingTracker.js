function LoadTableStagingTracker(sel) {


    var url_path = "/ETL/StagingTracker/LoadStagingTrackerTable";
    $.ajax({
        type: 'GET',
        url: url_path,
        data: { ProjectName: sel },
        success: function (data) {
            appendTabContent(data, "ProjectInfoTableStagingTracker");
...
function LoadStagingTrackerTable()
{
// $('#StagingTracker').DataTable();
