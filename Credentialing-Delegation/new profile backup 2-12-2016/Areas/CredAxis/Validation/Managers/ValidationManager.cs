...
namespace PortalTemplate.Areas.CredAxis.Validation.Managers
{
        ...
        private static Validators validatorLib
        {
            get
            {
                if (_validatorLib == null)
                {
                    ...
                    string path = HttpContext.Current.ApplicationInstance.Server.MapPath("/Areas/CredAxis/Validation/Controls/Validator.xml");
