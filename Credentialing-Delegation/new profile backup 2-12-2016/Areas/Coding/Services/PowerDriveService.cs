...
namespace PortalTemplate.Areas.Coding.Services
{
    ...
    {
        public FileUploadResponse UploadFileService(Models.PowerDriveService.FileService fileService)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                using (MultipartFormDataContent mpfdc = new MultipartFormDataContent())
                {
                    ...
                    var requestUri = ConfigurationManager.AppSettings["PowerDriveWebAPIURL"] + "api/UploadFiles";//?UserID=1";
        ...
        public string DownLoadFile(string Path, Models.PowerDriveService.UserInfo User)
        {
            //string FileName = "";
            string FilePath = "";
            string PathOfFile = "";
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                using (var formData = new MultipartFormDataContent())
                {
                    ...
                    var requestUri = ConfigurationManager.AppSettings["PowerDriveWebAPIURL"] + "api/DownLoadFile";
        ...
        public void SubscribeToGroupService(Models.PowerDriveService.UserInfo userInfo, string GroupUsers, bool IsNewGroup)
        {
            //SbscribeUserToGroup
            HttpResponseMessage result;
            using (HttpClient client = new HttpClient())
        ...
        public static async Task<Stream> PreviewFile(string Path, UserInfo User)
        {
