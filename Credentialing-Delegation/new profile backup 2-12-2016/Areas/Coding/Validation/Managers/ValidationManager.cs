...
namespace PortalTemplate.Areas.Coding.Validation.Managers
{
        ...
        private static Validators validatorLib
        {
            get
            {
                if (_validatorLib == null)
                {
                    ...
                    string path = HttpContext.Current.ApplicationInstance.Server.MapPath("/Areas/Coding/Validation/Controls/Validator.xml");
