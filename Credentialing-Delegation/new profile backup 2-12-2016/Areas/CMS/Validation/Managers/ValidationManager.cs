...
namespace PortalTemplate.Areas.CMS.Validation.Managers
{
        ...
        private static Validators validatorLib
        {
            get
            {
                if (_validatorLib == null)
                {
                    ...
                    string path = HttpContext.Current.ApplicationInstance.Server.MapPath("/Areas/CMS/Validation/Controls/Validator.xml");
