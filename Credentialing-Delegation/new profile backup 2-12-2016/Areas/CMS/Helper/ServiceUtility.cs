...
namespace PortalTemplate.Areas.CMS.Helper
{
    public class ServiceUtility
    {
        ...
        public async Task<string> PostDataToService(string URL, object data)
        {
            string result = null;
            using (var client = new HttpClient())
            {
        ...
        internal async Task<string> GetDataFromService(string baseURL, string URL)
        {
            string result = null;
            using (var client = new HttpClient())
            {
