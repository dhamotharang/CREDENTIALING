...
namespace PortalTemplate.Areas.Auditing.Validation.Managers
{
        ...
        private static Validators validatorLib
        {
            get
            {
                if (_validatorLib == null)
                {
                    ...
                    string path = HttpContext.Current.ApplicationInstance.Server.MapPath("/Areas/Auditing/Validation/Controls/Validator.xml");
