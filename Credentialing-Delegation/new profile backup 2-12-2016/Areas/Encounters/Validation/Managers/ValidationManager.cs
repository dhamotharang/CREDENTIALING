...
namespace PortalTemplate.Areas.Encounters.Validation.Managers
{
        ...
        private static Validators validatorLib
        {
            get
            {
                if (_validatorLib == null)
                {
                    ...
                    string path = HttpContext.Current.ApplicationInstance.Server.MapPath("/Areas/Encounters/Validation/Controls/Validator.xml");
