...
{
    public class EncounterCodingDetailsViewModel
    {
        ...
        public List<PortalTemplate.Areas.Coding.Models.ICDCodes.ICDCodeViewModel> ICDCodes { get; set; }
        public List<PortalTemplate.Areas.Coding.Models.ICDCPTMapping.ICDCPTCodemappingViewModel> CPTCodes { get; set; }
