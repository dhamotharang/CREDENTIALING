...
namespace PortalTemplate.Areas.UM.Services
{
    ...
    {
        public QueueModuleViewModel GetAuthList(string QueueType, string QueueSubTab, string UserID = null, string RequestType = "", int? StartIndex = null, int? DataLength = null, List<string> filterData = null, string from = null, string to = null)
        {
            QueueModuleViewModel QueueModule = new QueueModuleViewModel();
        ...
        public FacilityQueueModuleViewModel GetFacilityAuthList(string QueueType, string QueueSubTab, string UserID = null, string RequestType = "", int? StartIndex = null, int? DataLength = null, List<string> filterData = null, string from = null, string to = null)
        {
            FacilityQueueModuleViewModel QueueModule = new FacilityQueueModuleViewModel();
            QueueModule.AuthorizationsList = GetFacilityQueueData(QueueType, QueueSubTab);
            //QueueModule.AuthorizationsCount = GetFacilityQueueCount(QueueModule.AuthorizationsList);
            //QueueModule.QueueSubTab = GetSubTabView(QueueType, "");
            //if (RequestType != "")
            //{
            //    QueueModule.AuthorizationsList = GetFacilityFilterDataOnRequest(QueueModule.AuthorizationsList, RequestType);
            //}
            return QueueModule;
        }

        private List<FacilityQueueViewModel> GetFacilityQueueData(string QueueType, string QueueTab)
        {
            string file = HostingEnvironment.MapPath(GetResourceLink(QueueType, QueueTab));
            string json = System.IO.File.ReadAllText(file);
            JavaScriptSerializer serial = new JavaScriptSerializer();
            List<FacilityQueueViewModel> QueueModal = new List<FacilityQueueViewModel>();
            QueueModal = serial.Deserialize<List<FacilityQueueViewModel>>(json);
            return QueueModal;
        }
        ...
        //}
        //private List<FacilityQueueViewModel> GetFacilityFilterDataOnRequest(List<FacilityQueueViewModel> QueueModel, string RequestType)
        //{
        //    return QueueModel.FindAll(e => e.RequestType.ToLower() == RequestType.ToLowerInvariant());
        //}
        ...
        //    return CountObject;
        //}
        //private QueueCountViewModel GetFacilityQueueCount(List<FacilityQueueViewModel> QueueModel)
        //{
        //    QueueCountViewModel CountObject = new QueueCountViewModel(42);
        //    CountObject.TotalCount = QueueModel.Count();
        //    CountObject.StandardCount = QueueModel.Count(e => e.RequestType.ToLower() == "standard");
        ...
        private bool HasAccessToTab(string QueueType, string QueueTab)
        {
            return true;
        }
