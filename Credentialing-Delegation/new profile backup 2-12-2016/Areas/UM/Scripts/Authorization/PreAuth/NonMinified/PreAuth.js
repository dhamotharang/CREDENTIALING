...
$(function () {
    ...
    $('#PrimaryDXArea').off('click', '.icd_add_btn').on('click', '.icd_add_btn', function () {
        ...
        var PrimaryDxRow = '<div class="PrimaryDXRow">' +
                           ...
                           '<button class="btn btn-danger btn-xs icd_delete_btn"><i class="fa fa-minus"></i></button>' +
                           '<button class="btn btn-success btn-xs icd_add_btn"><i class="fa fa-plus"></i></button>' +
                           '</div>' +
    ...
    $('#PreAuthCPTArea').off('click', '.cpt_add_btn').on('click', '.cpt_add_btn', function () {
        ...
        var CPTRow = '<div class="col-lg-12 PreAuthCPTRow">' +
                                ...
                                '<div class="col-lg-2 col-md-2 button-styles-xs">' +
                                    '<button class="btn btn-danger btn-xs cpt_delete_btn"><i class="fa fa-minus"></i></button>' +
                                    '<button class="btn btn-success btn-xs cpt_add_btn"><i class="fa fa-plus"></i></button>' +
                                '</div>' +
                            '</div>'
    ...
    $('#PreAuthCPTArea').off('click', '.cpt_delete_btn').on('click', '.cpt_delete_btn', function () {
        ...
        if (childCount > 2) {
            if (childCount == (rowIndex + 1)) {
                $(this).parents('.PreAuthCPTRow').prev().children('.button-styles-xs').children('.cpt_add_btn').removeClass('hidden')
                $(this).parents('.PreAuthCPTRow').remove();
            }
            else {
                $(this).parents('.PreAuthCPTRow').remove();
            }
            ...
            $(this).parents('.PreAuthCPTRow').remove();
            $('.cpt_delete_btn').addClass("hidden");
            $('.cpt_add_btn').removeClass("hidden");
        }
    });
    //-----------------------------------------------------------------------------------------------------------//
    ...
    $('#PreAuthCPTArea2').off('click', '.cpt_delete_btn').on('click', '.cpt_delete_btn', function () {
        ...
        if (childCount > 2) {
            if (childCount == (rowIndex + 1)) {
                $(this).parents('.PreAuthCPTRowSecondary').prev().children('.button-styles-xs').children('.cpt_add_btn').removeClass('hidden')
    ...
    $('#PreAuthDocumentArea').off('click', '.addDocumentBtn').on('click', '.addDocumentBtn', function () {
        ...
        var DocRow = '<div class="preAuthDocumentRow">' +
                                    ...
                                    '<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1 pull-left button-styles-xs">' +
                                        '<button class="btn btn-danger btn-xs deleteDocumentBtn1 hidden"><i class="fa fa-minus"></i></button>' + 
                                        '<button class="btn btn-danger btn-xs deleteDocumentBtn"><i class="fa fa-minus"></i></button>' +
                                        '<button class="btn btn-success btn-xs addDocumentBtn"><i class="fa fa-plus"></i></button>' +
                                    '</div>' +
                     '</div>'
