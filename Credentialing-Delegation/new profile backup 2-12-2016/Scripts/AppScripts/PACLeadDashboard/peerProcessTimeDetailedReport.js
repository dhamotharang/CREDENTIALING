...
function getData(DataOfThis) {
    ...
    var data1 = {
        ...
        "Average": ['Average', 89, 68, 08, 58, 33, 49, 16, 5, 25, 44, 14, 9, 15, 8, 5],
        "Lowest": ['Lowest', 15, 30, 25, 35, 15, 4, 3, 2, 5, 4, 1, 5, 0, 3, 1]
    };
    var data2 = {
        ...
        "Average": ['Average', 93, 85, 61, 76, 37, 36, 30, 25, 20, 18, 10, 9, 3, 2, 1],
        "Lowest": ['Lowest', 15, 30, 25, 15, 15, 14, 13, 12, 5, 4, 1,3, 0, 0, 1]
