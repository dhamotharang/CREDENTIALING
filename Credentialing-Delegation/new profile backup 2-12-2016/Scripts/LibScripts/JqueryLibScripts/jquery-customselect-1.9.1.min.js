...
!function (a) {
    a.fn.customselect = function (b, c)
    {
        ...
        b && "object" == typeof b && a.extend(d, b);
        var e = "function" == typeof d.mobilecheck ? d.mobilecheck.call() : d.mobilecheck, f = e ? a(this).filter("select") : a(this).filter("select:not([multiple])");
