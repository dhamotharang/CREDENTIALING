...
namespace AHC.CD.Business.Profiles
{
    internal class ProfileDelegationManager : IProfileDelegationManager
    {
        ...
        /// <returns></returns>
        public async Task<object> GetProfileData(int profileId)
        {
            try
            {
        ...
        /// <param name="profileId"></param>
        /// <returns></returns>
        public async Task<List<CDUserRole>> GetRolesForUser(int profileId)
        {
            try
            {
        ...
        public async Task<CDUserRole> AddRole(int profileId, int roleID)
        {
            try
            {
