...
namespace AHC.CD.Entities.ProviderInfo
{
    public class IndividualProvider 
    {
        ...
        //public virtual ICollection<AHC.CD.Entities.MasterProfile.EducationHistory.SpecialtyDetail> SpecialtyDetails { get; set; }
        ...
        public virtual ICollection<AHC.CD.Entities.MasterProfile.DisclosureQuestions.ProfileDisclosureQuestionAnswer> ProviderDisclosureQuestionAnswer { get; set; }
