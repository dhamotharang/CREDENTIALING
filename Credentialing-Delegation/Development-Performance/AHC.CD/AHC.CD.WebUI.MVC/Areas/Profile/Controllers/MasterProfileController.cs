...
namespace AHC.CD.WebUI.MVC.Areas.Profile.Controllers
{
    public class MasterProfileController : Controller
    {
        ...
        //----------- Get Partial Page Global Method -------------
        [Authorize(Roles = "ADM,CCO,CRA,TL,CCM,MGT,HR")]
        [OutputCache(Duration = int.MaxValue, VaryByParam = "none")] //(Duration = 3600), current intMaxValue = 2147483647
        public async Task<PartialViewResult> GetPartialPage(string PartialPageURL)
        {
            ...
            return PartialView(PartialPageURL);
        }
