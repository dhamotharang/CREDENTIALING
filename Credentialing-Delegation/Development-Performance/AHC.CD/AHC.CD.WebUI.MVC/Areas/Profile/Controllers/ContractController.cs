...
namespace AHC.CD.WebUI.MVC.Areas.Profile.Controllers
{
    public class ContractController : Controller
    {
        ...
        public ContractController(IContractManager contractmanager,IProfileManager profileManager, IErrorLogger errorLogger, IChangeNotificationManager notificationManager, IProfileUpdateManager profileUpdateManager)
        {
