...
define(['Util/MasterProfileApp'], function (app) {
    'use strict';
    app.register.controller('TasksController', ['$scope', '$http', 'httpq', '$q', '$rootScope', 'Resource', 'messageAlertEngine', 'ProfileSubData',
      function ($scope, $http, httpq, $q, $rootScope, Resource, messageAlertEngine, ProfileSubData) {
         ...
         error(function (data, status, headers, config) {
          ...
          $(function () {
              $scope.Tasks = angular.copy(ProfileSubData);
              $scope.LoadData();
          });
