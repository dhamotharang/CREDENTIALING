...
define(['Util/MasterProfileApp'], function (app) {
    'use strict';
    app.register.controller('WorkHistoryController', ['$scope', '$rootScope', '$http', 'httpq', '$filter', '$timeout', 'masterDataService', 'locationService', 'messageAlertEngine', 'profileUpdates',
      function ($scope, $rootScope, $http, httpq, $filter, $timeout, masterDataService, locationService, messageAlertEngine, profileUpdates) {
          ...
          $(function () {
              ...
              if (!$rootScope.MasterData.MilitaryBranches) {
                  httpq.get(rootDir + "/Profile/MasterData/GetAllMilitaryBranches").then(function (data) {
                      $rootScope.MasterData.MilitaryBranches = data;
                      //$scope.militaryBranches = data;
                  });
              }
              if (!$rootScope.MasterData.MilitaryRanks) {
                  httpq.get(rootDir + "/Profile/MasterData/GetAllMilitaryRanks").then(function (data) {
                      $rootScope.MasterData.MilitaryRanks = data;
                      //$scope.militaryRanks = data;
                  });
              }
              if (!$rootScope.MasterData.MilitaryPresentDuties) {
                  httpq.get(rootDir + "/Profile/MasterData/GetAllMilitaryPresentDuties").then(function (data) {
                      $rootScope.MasterData.MilitaryPresentDuties = data;
                      //$scope.militaryPresentDuties = data;
                  });
              }
              if (!$rootScope.MasterData.MilitaryDischarges) {
                  httpq.get(rootDir + "/Profile/MasterData/GetAllMilitaryDischarges").then(function (data) {
                      $rootScope.MasterData.MilitaryDischarges = data;
                      //$scope.militaryDischarges = data;
                  });
              }
          });
