...
define(['Util/MasterProfileApp'], function (app) {
    'use strict';
    app.register.controller('DemographicsController', ['$scope', '$rootScope', '$http', 'httpq', '$filter', 'locationService', 'messageAlertEngine', 'profileUpdates', '$timeout',
      function ($scope, $rootScope, $http, httpq, $filter, locationService, messageAlertEngine, profileUpdates, $timeout) {
          ////////////////////////// JAI MATA DI /////////////////////////
          ...
          $(function () {
              ...
              if (!$rootScope.MasterProfile.Demographics.PersonalDetail.MaritalStatusType) {
                  $rootScope.MasterProfile.Demographics.MaritalStatusType = "";
              }
              if ($rootScope.MasterProfile.Demographics.ContactDetail) {
                  for (var i in $rootScope.MasterProfile.Demographics.ContactDetail.PreferredContacts) {
                      if ($rootScope.MasterProfile.Demographics.ContactDetail.PreferredContacts[i].PreferredWrittenContactType == 1) {
                          $rootScope.MasterProfile.Demographics.ContactDetail.PreferredContacts[i].ContactType = "Home Phone"
                      }
                  }
              }
              if ($rootScope.MasterProfile.Demographics.BirthInformation) {
                  var TemporaryVariable = ($rootScope.MasterProfile.Demographics.BirthInformation.DateOfBirth.split(" ")[0]).split("-");
                  if (TemporaryVariable.length == 1) {
                      var TemporaryVariable1 = TemporaryVariable[0].split("/");
                      $rootScope.MasterProfile.Demographics.BirthInformation.DateOfBirth = TemporaryVariable1[0] + "/" + TemporaryVariable1[1] + "/" + TemporaryVariable1[2];
                  }
                  else { $rootScope.MasterProfile.Demographics.BirthInformation.DateOfBirth = TemporaryVariable[0] + "/" + TemporaryVariable[1] + "/" + TemporaryVariable[2]; }
              }
              if ($rootScope.MasterProfile.Demographics.VisaDetail && $rootScope.MasterProfile.Demographics.VisaDetail.VisaInfo) {
                  if (!$rootScope.MasterProfile.Demographics.VisaDetail.VisaInfo.VisaTypeID) {
                      $rootScope.MasterProfile.Demographics.VisaDetail.VisaInfo.VisaTypeID = "";
                  }
                  if (!$rootScope.MasterProfile.Demographics.VisaDetail.VisaInfo.VisaStatusID) {
                      $rootScope.MasterProfile.Demographics.VisaDetail.VisaInfo.VisaStatusID = "";
                  }
                  if (!$rootScope.MasterProfile.Demographics.VisaDetail.VisaInfo.CountryOfIssue) {
                      $rootScope.MasterProfile.Demographics.VisaDetail.VisaInfo.CountryOfIssue = "";
                  }
              }
          ...
          $(function () {
              ...
              if (!$rootScope.MasterData.VisaTypes) {
                  httpq.get(rootDir + "/Profile/MasterData/getallvisatypes").then(function (data) {
                      $rootScope.MasterData.VisaTypes = data;
                      //$scope.VisaTypes = data;
                  });
              }
              if (!$rootScope.MasterData.VisaStatuses) {
                  httpq.get(rootDir + "/Profile/MasterData/getallvisastatus").then(function (data) {
                      $rootScope.MasterData.VisaStatuses = data;
                      //$scope.VisaStatuses = data;
                  });
              }
              if (!$rootScope.MasterData.ProviderLevels) {
                  httpq.get(rootDir + "/Profile/MasterData/GetAllProviderLevels").then(function (data) {
                      $rootScope.MasterData.ProviderLevels = data;
          ...
          $scope.getProviderTypesAndTempData = function () {
              $scope.TempPersonalDetailsForEdit = angular.copy($rootScope.MasterProfile.Demographics.PersonalDetail);
              $scope.tempProviderTypes = angular.copy($rootScope.MasterData.ProviderTypes);
              ...
              if ($("#" + Form_Id).valid()) {
                  ...
                  $.ajax({
                      ...
                      success: function (data) {
                          ...
                          try {
                              if (data.status == "true") {
                                  $rootScope.MasterProfile.Demographics.ProfilePhotoPath = data.ProfileImagePath;
                              ...
                              if (data.status == "true") {
                                  ...
                                  if (data.personalDetail.ProviderTitles.length > 0) {
                                      for (var i in data.personalDetail.ProviderTitles) {
                                          for (var j = 0; j < $rootScope.MasterData.ProviderTypes.length; j++) {
                                              if (data.personalDetail.ProviderTitles[i].ProviderTypeId == $rootScope.MasterData.ProviderTypes[j].ProviderTypeID) {
                                                  data.personalDetail.ProviderTitles[i].ProviderType = angular.copy($rootScope.MasterData.ProviderTypes[j]);
                                              }
                                          }
                                      }
                                  }
                                  data.personalDetail.ProviderLevel = $filter('filter')($rootScope.MasterData.ProviderLevels, { ProviderLevelID: data.personalDetail.ProviderLevelID })[0];
                                  $rootScope.MasterProfile.Demographics.PersonalDetail = data.personalDetail;
                                  if (!$rootScope.MasterProfile.Demographics.MaritalStatusType) {
                                      $rootScope.MasterProfile.Demographics.MaritalStatusType = "";
                                  }
                                  FormReset($("#" + Form_Id));
                                  $rootScope.visibilityControl = "";
                      ...
                      success: function (data) {
                          ...
                          try {
                              if (data.status == "true") {
                                  ...
                                  $rootScope.MasterProfile.Demographics.OtherLegalNames.push(data.otherLegalName);
                                  $rootScope.visibilityControl = "";
                                  //$rootScope.visibilityControl = $rootScope.MasterProfile.Demographics.OtherLegalNames.length-1 + "_ViewOtherLegalName";
                                  myData = data;
                                  FormReset($form);
                      ...
                      success: function (data) {
                          try {
                              ...
                              if (data.status == "true") {
                                  data.otherLegalName.EndDate = ConvertDateFormat(data.otherLegalName.EndDate);
                                  data.otherLegalName.StartDate = ConvertDateFormat(data.otherLegalName.StartDate);
                                  for (var i in $rootScope.MasterProfile.Demographics.OtherLegalNames) {
                                      if ($rootScope.MasterProfile.Demographics.OtherLegalNames[i].OtherLegalNameID == data.otherLegalName.OtherLegalNameID) {
                                          $rootScope.MasterProfile.Demographics.OtherLegalNames[i] = data.otherLegalName;
                                          break;
                                      }
                                  }
                                  //$rootScope.visibilityControl = "";
                  ...
                  $.ajax({
                      ...
                      success: function (data) {
                          ...
                          try {
                              if (data.status == "true") {
                                  $scope.OtherLegalNamesPendingRequest = true;
                                  var obj = $filter('filter')($rootScope.MasterProfile.Demographics.OtherLegalNames, { OtherLegalNameID: data.otherLegalName.OtherLegalNameID })[0];
                                  $rootScope.MasterProfile.Demographics.OtherLegalNames.splice($rootScope.MasterProfile.Demographics.OtherLegalNames.indexOf(obj), 1);
                          ...
                          try {
                              if (data.status == "true") {
                                  if (data.homeAddress.AddressPreferenceType == 1) {
                                      for (var i in $rootScope.MasterProfile.Demographics.HomeAddresses) {
                                          if ($rootScope.MasterProfile.Demographics.HomeAddresses[i].AddressPreferenceType == 1) {
                                              $rootScope.MasterProfile.Demographics.HomeAddresses[i].AddressPreferenceType = 2;
                                              $rootScope.MasterProfile.Demographics.HomeAddresses[i].AddressPreference = "Secondary";
                                              break;
                                          }
                                      }
                                  }
                                  ...
                                  $rootScope.MasterProfile.Demographics.HomeAddresses.push(data.homeAddress);
                      ...
                      success: function (data) {
                          ...
                          try {
                              if (data.status == "true") {
                                  ...
                                  for (var i in $rootScope.MasterProfile.Demographics.HomeAddresses) {
                                      if ($rootScope.MasterProfile.Demographics.HomeAddresses[i].HomeAddressID == data.homeAddress.HomeAddressID)
                                          $rootScope.MasterProfile.Demographics.HomeAddresses[i] = data.homeAddress;
                                  }
                                  if (data.homeAddress.AddressPreferenceType == 1) {
              ...
              if (validationStatus) {
                  ...
                  $.ajax({
                      ...
                      success: function (data) {
                          ...
                          try {
                              if (data.status == "true") {
                                  var obj = $filter('filter')($rootScope.MasterProfile.Demographics.HomeAddresses, { HomeAddressID: data.homeAddress.HomeAddressID })[0];
                                  $rootScope.MasterProfile.Demographics.HomeAddresses.splice($rootScope.MasterProfile.Demographics.HomeAddresses.indexOf(obj), 1);
          ...
          $scope.getTempContactDetailsForEdit = function () {
              $scope.TempContactDetailsForEdit = angular.copy($rootScope.MasterProfile.Demographics.ContactDetail);
          ...
          $scope.ChangePreferredContactsPriority = function (condition) {
              ...
              if (condition == "increase" && index !== 0) {
                  $scope.PreferredContactTypesArray[index].PreferredIndex = index;
                  $scope.PreferredContactTypesArray[index - 1].PreferredIndex = index + 1;
                  $scope.pcIndex = index - 1;
              } else if (condition == "decrease" && index !== $scope.PreferredContactTypesArray.length - 1) {
                  $scope.PreferredContactTypesArray[index].PreferredIndex = index + 2;
                  $scope.PreferredContactTypesArray[index + 1].PreferredIndex = index + 1;
                  $scope.pcIndex = index + 1;
              }
                      ...
                      success: function (data) {
                          ...
                          try {
                              if (data.status == "true") {
                                  ...
                                  $rootScope.MasterProfile.Demographics.ContactDetail = data.contactDetail;
                                  $scope.TempContactDetailsForEdit = [];
                                  $scope.PreferredContactTypesArray = [];
                                  $scope.ContactDetailsEmptyError = false;
                                  FormReset($("#" + Form_Id));
                      ...
                      success: function (data) {
                          ...
                          try {
                              if (data.status == "true") {
                                  ...
                                  $rootScope.MasterProfile.Demographics.PersonalIdentification = data.personalIdentification;
                                  $rootScope.tempObject = {};
                                  $rootScope.visibilityControl = "";
                                  FormReset($("#" + Form_Id));
                                  myData = data;
                                  ...
                                  if (data.personalIdentificationid == 0) {
                                      ...
                                      messageAlertEngine.callAlertMessage("alertPersonalIdentificationSuccess", "Personal Identification Added successfully.", "success", true);
              ...
              if ($("#" + Form_Id).valid()) {
                  $.ajax({
                      ...
                      success: function (data) {
                          ...
                          try {
                              if (data.status == "true") {
                                  if ($rootScope.MasterProfile.Demographics.BirthInformation != null) {
                                  ...
                                  $rootScope.MasterProfile.Demographics.BirthInformation = data.birthInformation;
              ...
              if ($("#" + Form_Id).valid()) {
                  $.ajax({
                      ...
                      success: function (data) {
                          ...
                          try {
                              if (data.status == "true") {
                                  if ($rootScope.MasterProfile.Demographics.VisaDetail != null) {
                                  ...
                                  if (data.visaDetail.VisaInfo) {
                                      ...
                                      for (var i in $rootScope.MasterData.VisaTypes) {
                                          if (data.visaDetail.VisaInfo.VisaTypeID == $rootScope.MasterData.VisaTypes[i].VisaTypeID) {
                                              data.visaDetail.VisaInfo.VisaType = $rootScope.MasterData.VisaTypes[i];
                                              break;
                                          }
                                      }
                                      for (var i in $rootScope.MasterData.VisaStatuses) {
                                          if (data.visaDetail.VisaInfo.VisaStatusID == $rootScope.MasterData.VisaStatuses[i].VisaStatusID) {
                                              data.visaDetail.VisaInfo.VisaStatus = $rootScope.MasterData.VisaStatuses[i];
                                              break;
                                          }
                                      }
                                  ...
                                  $rootScope.MasterProfile.Demographics.VisaDetail = data.visaDetail;
                                  $rootScope.tempObject = {};
                                  $rootScope.visibilityControl = "";
                                  myData = data;
          ...
          $scope.getLanguagesAndTempData = function () {
              $scope.TempLanguageForEdit = angular.copy($rootScope.MasterProfile.Demographics.LanguageInfo);
              ...
              if ($("#" + Form_Id).valid()) {
                  $.ajax({
                      ...
                      success: function (data) {
                          ...
                          try {
                              if (data.status == "true") {
                                  if ($rootScope.MasterProfile.Demographics.LanguageInfo != null) {
                                      $scope.LanguageInfoPendingRequest = true;
                                  }
                                  $rootScope.MasterProfile.Demographics.LanguageInfo = data.languageInfo;
                                  $scope.TempLanguageForEdit = [];
                                  FormReset($("#" + Form_Id));
                                  $rootScope.visibilityControl = "";
