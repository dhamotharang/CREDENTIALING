...
define(['Util/MasterProfileApp'], function (app) {
    'use strict';
    app.register.controller('DocumentRepositoryController', ['$scope', '$rootScope', '$timeout', '$http', 'httpq', 'messageAlertEngine',
     function ($scope, $rootScope, $timeout, $http, httpq, messageAlertEngine) {
         ...
         $scope.CCMLicenses = null;
         $scope.createLicenseArray = function () {
             $scope.LicenseTypes.push({
                 LicenseTypeID: 1,
             ...
             $scope.LicenseTypes.push({
                 LicenseTypeID: 2,
                 LicenseTypeName: "Other Legal Name Document",
                 Licenses: [],
                 LicenseHistories: []
             });
             $scope.LicenseTypes.push({
                 LicenseTypeID: 3,
                 LicenseTypeName: "Personal Identification Document",
                 Licenses: [],
                 LicenseHistories: []
             });
             $scope.LicenseTypes.push({
                 LicenseTypeID: 4,
                 LicenseTypeName: "Birth Document",
                 Licenses: [],
                 LicenseHistories: []
             });
             $scope.LicenseTypes.push({
                 LicenseTypeID: 5,
                 LicenseTypeName: "CV Document",
                 Licenses: [],
                 LicenseHistories: []
             });
             $scope.LicenseTypes.push({
                 LicenseTypeID: 6,
                 LicenseTypeName: "Citizenship Document",
                 Licenses: [],
                 LicenseHistories: []
             });
             $scope.LicenseTypes.push({
                 LicenseTypeID: 7,
                 LicenseTypeName: "Federal DEA Document",
                 Licenses: [],
                 LicenseHistories: []
             });
             $scope.LicenseTypes.push({
                 LicenseTypeID: 8,
                 LicenseTypeName: "Medicare Document",
                 Licenses: [],
                 LicenseHistories: []
             });
             $scope.LicenseTypes.push({
                 LicenseTypeID: 9,
                 LicenseTypeName: "Medicaid Document",
                 Licenses: [],
                 LicenseHistories: []
             });
             $scope.LicenseTypes.push({
                 LicenseTypeID: 10,
                 LicenseTypeName: "CDSC Document",
                 Licenses: [],
                 LicenseHistories: []
             });
             $scope.LicenseTypes.push({
                 LicenseTypeID: 11,
                 LicenseTypeName: "Education Document",
                 Licenses: [],
                 LicenseHistories: []
             });
             $scope.LicenseTypes.push({
                 LicenseTypeID: 12,
                 LicenseTypeName: "ECFMG Document",
                 Licenses: [],
                 LicenseHistories: []
             });
             $scope.LicenseTypes.push({
                 LicenseTypeID: 13,
                 LicenseTypeName: "Program Document",
                 Licenses: [],
                 LicenseHistories: []
             });
             $scope.LicenseTypes.push({
                 LicenseTypeID: 14,
                 LicenseTypeName: "CME Certifications",
                 Licenses: [],
                 LicenseHistories: []
             });
             $scope.LicenseTypes.push({
                 LicenseTypeID: 15,
                 LicenseTypeName: "Specialty Board Certificates",
                 Licenses: [],
                 LicenseHistories: []
             });
             $scope.LicenseTypes.push({
                 LicenseTypeID: 16,
                 LicenseTypeName: "Hospital Privilege Document",
                 Licenses: [],
                 LicenseHistories: []
             });
             $scope.LicenseTypes.push({
                 LicenseTypeID: 17,
                 LicenseTypeName: "Professional Liability Document",
                 Licenses: [],
                 LicenseHistories: []
             });
             $scope.LicenseTypes.push({
                 LicenseTypeID: 18,
                 LicenseTypeName: "WorkExperience Document",
                 Licenses: [],
                 LicenseHistories: []
             });
             $scope.LicenseTypes.push({
                 LicenseTypeID: 19,
                 LicenseTypeName: "Contract",
                 Licenses: [],
                 LicenseHistories: []
             });
             $scope.LicenseTypes.push({
                 LicenseTypeID: 20,
                 LicenseTypeName: "Other",
                 Licenses: [],
                 LicenseHistories: []
             });
         }
         $scope.FormatStateLicense = function (Docs) {
             ...
             for (var i = 0; i < Docs.length; i++) {
                 if (Docs[i].StateLicenseDocumentPath != null) {
                     $scope.LicenseTypes[0].Licenses.push({
                         LicenseID: Docs[i].StateLicenseInformationID,
                         LicenseName: "ML" + (i + 1),
                         LicenseDocPath: Docs[i].StateLicenseDocumentPath,
                         ModifiedDate: Docs[i].LastModifiedDate,
                     ...
                     if (Docs[i].StateLicenseInfoHistory != null) {
                         for (var j = 0; j < Docs[i].StateLicenseInfoHistory.length; j++) {
                             if (Docs[i].StateLicenseInfoHistory[j] != null) {
                                 $scope.LicenseTypes[0].LicenseHistories.push({
                                     LicenseID: Docs[i].StateLicenseInfoHistory[j].StatelicenseInfoHistoryID,
                                     LicenseName: "ML" + (j + 1),
                                     LicenseDocPath: Docs[i].StateLicenseInfoHistory[j].StatelicenseDocumentPath,
                                     removeDate: Docs[i].StateLicenseInfoHistory[j].LastModifiedDate
                                 });
                             }
                         }
                     }
         ...
         $scope.FormatOtherLegalNamesDoc = function (Docs) {
             ...
             for (var i = 0; i < Docs.length; i++) {
                 if (Docs[i].DocumentPath != null) {
                     $scope.LicenseTypes[1].Licenses.push({
                         LicenseID: Docs[i].OtherLegalNameID,
                         LicenseName: "OLN" + (i + 1),
                         LicenseDocPath: Docs[i].DocumentPath,
                         ModifiedDate: Docs[i].LastModifiedDate,
                         Description: "Other Legal Name"
                     });
                     if (Docs[i].OtherLegalNameHistory != null) {
                         $scope.LicenseTypes[1].LicenseHistories.push({
                             LicenseID: Docs[i].OtherLegalNameHistory[j].OtherLegalNameHistoryID,
                             LicenseName: "OLN" + (j + 1),
                             LicenseDocPath: Docs[i].OtherLegalNameHistory[j].DocumentPath,
                             removeDate: Docs[i].OtherLegalNameHistory[j].LastModifiedDate
                         });
                     }
                 }
             }
         ...
         $scope.FormatPersonalIdentificationDoc = function (Docs) {
             ...
             if (Docs.SSNCertificatePath != null) {
                 $scope.LicenseTypes[2].Licenses.push({
                     LicenseID: Docs.PersonalIdentificationID,
                     LicenseName: "SSN",
                     LicenseDocPath: Docs.SSNCertificatePath,
                     ModifiedDate: Docs.LastModifiedDate,
             ...
             if (Docs.DLCertificatePath != null) {
                 $scope.LicenseTypes[2].Licenses.push({
                     LicenseID: Docs.PersonalIdentificationID,
                     LicenseName: "DL",
                     LicenseDocPath: Docs.DLCertificatePath,
                     ModifiedDate: Docs.LastModifiedDate,
         ...
         $scope.FormatBirthInformationDoc = function (Docs) {
             ...
             if (Docs.BirthCertificatePath != null) {
                 $scope.LicenseTypes[3].Licenses.push({
                     LicenseID: Docs.BirthInformationID,
                     LicenseName: "Birth Certificate",
                     LicenseDocPath: Docs.BirthCertificatePath,
                     ModifiedDate: Docs.LastModifiedDate,
                     Description: "Birth Certificate"
                 });
                 $scope.LicenseTypes[3].LicenseHistories.push({
                     LicenseID: 1,
                     LicenseName: "Birth Certificate",
                     LicenseDocPath: Docs.BirthCertificatePath,
                     removeDate: Docs.LastModifiedDate
                 });
             }
         ...
         $scope.FormatCVInformationDoc = function (Docs) {
             ...
             if (Docs.CVDocumentPath != null) {
                 $scope.LicenseTypes[4].Licenses.push({
                     LicenseID: Docs.CVInformationID,
                     LicenseName: "CV",
                     LicenseDocPath: Docs.CVDocumentPath,
                     ModifiedDate: Docs.LastModifiedDate,
         ...
         $scope.FormatVisaInfoDoc = function (Docs) {
             ...
             if (Docs.VisaInfo != null) {
                 if (Docs.VisaInfo.VisaCertificatePath != null) {
                     $scope.LicenseTypes[5].Licenses.push({
                         LicenseID: Docs.VisaInfo.VisaInfoID,
                         LicenseName: "VISA",
                         LicenseDocPath: Docs.VisaInfo.VisaCertificatePath,
                         ModifiedDate: Docs.LastModifiedDate,
                         Description: "Visa"
                     });
                 }
                 if (Docs.VisaInfo.GreenCardCertificatePath != null) {
                     $scope.LicenseTypes[5].Licenses.push({
                         LicenseID: Docs.VisaInfo.VisaInfoID,
                         LicenseName: "GreenCard",
                         LicenseDocPath: Docs.VisaInfo.GreenCardCertificatePath,
                         ModifiedDate: Docs.LastModifiedDate,
                 ...
                 if (Docs.VisaInfo.NationalIDCertificatePath != null) {
                     $scope.LicenseTypes[5].Licenses.push({
                         LicenseID: Docs.VisaInfo.VisaInfoID,
                         LicenseName: "National Identification",
                         LicenseDocPath: Docs.VisaInfo.NationalIDCertificatePath,
                         ModifiedDate: Docs.LastModifiedDate,
                         Description: "National Identification Certificate"
                     });
                 }
         ...
         $scope.FormatFederalDEAInformationDoc = function (Docs) {
             ...
             for (var i = 0; i < Docs.length; i++) {
                 if (Docs[i].DEALicenceCertPath != null) {
                     $scope.LicenseTypes[6].Licenses.push({
                         LicenseID: Docs[i].FederalDEAInformationID,
                         LicenseName: "DEA" + (i + 1),
                         LicenseDocPath: Docs[i].DEALicenceCertPath,
                         ModifiedDate: Docs[i].LastModifiedDate,
                     ...
                     if (Docs[i].FederalDEAInfoHistory != null) {
                         for (var j = 0; j < Docs[i].FederalDEAInfoHistory.length; j++) {
                             $scope.LicenseTypes[6].LicenseHistories.push({
                                 LicenseID: Docs[i].FederalDEAInfoHistory[j].FederalDEAInfoHistoryID,
                                 LicenseName: "DEA" + (j + 1),
                                 LicenseDocPath: Docs[i].FederalDEAInfoHistory[j].FederalDEADocumentPath,
                                 removeDate: Docs[i].FederalDEAInfoHistory[j].LastModifiedDate
                             });
                         }
                     }
                 }
         ...
         $scope.FormatMedicareInformationDoc = function (Docs) {
             ...
             for (var i = 0; i < Docs.length; i++) {
                 if (Docs[i].CertificatePath != null) {
                     $scope.LicenseTypes[7].Licenses.push({
                         LicenseID: Docs[i].MedicareInformationID,
                         LicenseName: "Medicare" + (i + 1),
                         LicenseDocPath: Docs[i].CertificatePath,
                         ModifiedDate: Docs[i].LastModifiedDate,
                         Description: "Medicare"
                     });
                     if (Docs[i].MedicareInformationHistory != null) {
                         $scope.LicenseTypes[7].LicenseHistories.push({
                             LicenseID: Docs[i].MedicareInformationHistory.MedicareInformationHistoryID,
                             LicenseName: "Medicare" + (j + 1),
                             LicenseDocPath: Docs[i].MedicareInformationHistory.CertificatePath,
                             removeDate: Docs[i].MedicareInformationHistory.LastModifiedDate
                         });
                     }
                 }
             }
         ...
         $scope.FormatMedicaidInformationDoc = function (Docs) {
             ...
             for (var i = 0; i < Docs.length; i++) {
                 if (Docs[i].CertificatePath != null) {
                     $scope.LicenseTypes[8].Licenses.push({
                         LicenseID: Docs[i].MedicaidInformationID,
                         LicenseName: "Medicaid" + (i + 1),
                         LicenseDocPath: Docs[i].CertificatePath,
                         ModifiedDate: Docs[i].LastModifiedDate,
                         Description: "Medicaid"
                     });
                     if (Docs[i].MedicaidInformationHistory != null) {
                         $scope.LicenseTypes[8].LicenseHistories.push({
                             LicenseID: Docs[i].MedicaidInformationHistory.MedicaidInformationHistoryID,
                             LicenseName: "Medicade" + (j + 1),
                             LicenseDocPath: Docs[i].MedicaidInformationHistory.CertificatePath,
                             removeDate: Docs[i].MedicaidInformationHistory.LastModifiedDate
                         });
                     }
                 }
             }
         ...
         $scope.FormatCDSCInformationDoc = function (Docs) {
             ...
             for (var i = 0; i < Docs.length; i++) {
                 if (Docs[i].CDSCCerificatePath != null) {
                     $scope.LicenseTypes[9].Licenses.push({
                         LicenseID: Docs[i].CDSCInformationID,
                         LicenseName: "CDS" + (i + 1),
                         LicenseDocPath: Docs[i].CDSCCerificatePath,
                         ModifiedDate: Docs[i].LastModifiedDate,
                         Description: "Central Drug Standard Control"
                     });
                     if (Docs[i].CDSCInfoHistory != null) {
                         for (var j = 0; j < Docs[i].CDSCInfoHistory.length; j++) {
                             $scope.LicenseTypes[9].LicenseHistories.push({
                                 LicenseID: Docs[i].CDSCInfoHistory[j].CDSCInfoHistoryID,
                                 LicenseName: "CDS" + (j + 1),
                                 LicenseDocPath: Docs[i].CDSCInfoHistory[j].CDSCCerificatePath,
                                 removeDate: Docs[i].CDSCInfoHistory[j].LastModifiedDate
                             });
                         }
                     }
                 }
                 ...
                 if (Docs[i].CertificatePath != null) {
                     if (Docs[i].CertificatePath != null) {
                         if (Docs[i].QualificationType == "UnderGraduate") {
                             $scope.LicenseTypes[10].Licenses.push({
                                 LicenseID: Docs[i].EducationDetailID,
                                 LicenseName: "UG" + ($scope.countUG + 1),
                                 LicenseDocPath: Docs[i].CertificatePath,
                                 ModifiedDate: Docs[i].LastModifiedDate,
                             ...
                             if (Docs[i].EducationDetailHistory != null) {
                                 $scope.LicenseTypes[10].LicenseHistories.push({
                                     LicenseID: Docs[i].EducationDetailHistory.EducationDetailHistoryID,
                                     LicenseName: "UG" + ($scope.countUG + 1),
                                     LicenseDocPath: Docs[i].EducationDetailHistory.CertificatePath,
                                     removeDate: Docs[i].EducationDetailHistory.LastModifiedDate
                                 });
                             }
                         } else if (Docs[i].QualificationType == "Graduate") {
                             $scope.LicenseTypes[10].Licenses.push({
                                 LicenseID: Docs[i].EducationDetailID,
                                 LicenseName: "Grad" + ($scope.countG + 1),
                                 LicenseDocPath: Docs[i].CertificatePath,
                                 ModifiedDate: Docs[i].LastModifiedDate,
         ...
         $scope.FormatECFMGDetailDoc = function (Docs) {
             ...
             if (Docs.ECFMGCertPath != null) {
                 $scope.LicenseTypes[11].Licenses.push({
                     LicenseID: Docs.ECFMGDetailID,
                     LicenseName: "ECFMG",
                     LicenseDocPath: Docs.ECFMGCertPath,
                     ModifiedDate: Docs.LastModifiedDate,
                     Description: "Education Commission for Foreign Medical Graduates"
                 });
                 $scope.LicenseTypes[11].LicenseHistories.push({
                     LicenseID: 2,
                     LicenseName: "ECFMG",
                     LicenseDocPath: Docs.ECFMGCertPath,
                     removeDate: Docs.LastModifiedDate
             ...
             for (var i = 0; i < Docs.length; i++) {
                 if (Docs[i].DocumentPath != null) {
                     if (Docs[i].ProgramType == "Internship") {
                         $scope.LicenseTypes[12].Licenses.push({
                             LicenseID: Docs[i].ProgramDetailID,
                             LicenseName: "Intern" + ($scope.countIntern + 1),
                             LicenseDocPath: Docs[i].DocumentPath,
                             ModifiedDate: Docs[i].LastModifiedDate,
                         ...
                         if (Docs.ProgramDetailHistory != null) {
                             $scope.LicenseTypes[12].LicenseHistories.push({
                                 LicenseID: Docs[i].ProgramDetailHistory.ProgramDetailHistoryID,
                                 LicenseName: "Intern" + ($scope.countIntern + 1),
                                 LicenseDocPath: Docs[i].ProgramDetailHistory.DocumentPath,
                                 removeDate: Docs[i].ProgramDetailHistory.LastModifiedDate
                             });
                         }
                     } else if (Docs[i].ProgramType == "Fellowship") {
                         $scope.LicenseTypes[12].Licenses.push({
                             LicenseID: Docs[i].ProgramDetailID,
                             LicenseName: "Fell" + ($scope.countFell + 1),
                             LicenseDocPath: Docs[i].DocumentPath,
                             ModifiedDate: Docs[i].LastModifiedDate,
                         ...
                         $scope.LicenseTypes[12].Licenses.push({
                             LicenseID: Docs[i].ProgramDetailID,
                             LicenseName: "Res" + ($scope.countRes + 1),
                             LicenseDocPath: Docs[i].DocumentPath,
                             ModifiedDate: Docs[i].LastModifiedDate,
                         ...
                         $scope.LicenseTypes[12].Licenses.push({
                             LicenseID: Docs[i].ProgramDetailID,
                             LicenseName: "Other" + ($scope.countOther + 1),
                             LicenseDocPath: Docs[i].DocumentPath,
                             ModifiedDate: Docs[i].LastModifiedDate,
                             Description: "Other"
                         });
         ...
         $scope.FormatCMECertificationsDoc = function (Docs) {
             ...
             for (var i = 0; i < Docs.length; i++) {
                 if (Docs[i].CertificatePath != null) {
                     $scope.LicenseTypes[13].Licenses.push({
                         LicenseID: Docs[i].CMECertificationID,
                         LicenseName: "CME" + (i + 1),
                         LicenseDocPath: Docs[i].CertificatePath,
                         ModifiedDate: Docs[i].LastModifiedDate,
                     ...
                     if (Docs[i].CMECertificationHistory != null) {
                         $scope.LicenseTypes[13].LicenseHistories.push({
                             LicenseID: Docs[i].CMECertificationHistory.CMECertificationHistoryID,
                             LicenseName: "CME" + (j + 1),
                             LicenseDocPath: Docs[i].CMECertificationHistory.CertificatePath,
                             removeDate: Docs[i].CMECertificationHistory.LastModifiedDate
                         });
                     }
                 }
             }
         ...
         $scope.FormatSpecialtyBoardCertifiedDetailDoc = function (Docs) {
             ...
             for (var i = 0; i < Docs.length; i++) {
                 if (Docs[i].SpecialtyBoardCertifiedDetail != null && Docs[i].SpecialtyBoardCertifiedDetail.BoardCertificatePath != null) {
                     $scope.LicenseTypes[14].Licenses.push({
                         LicenseID: Docs[i].SpecialtyDetailID,
                         LicenseName: "Board" + (i + 1),
                         LicenseDocPath: Docs[i].SpecialtyBoardCertifiedDetail.BoardCertificatePath,
                         ModifiedDate: Docs[i].LastModifiedDate,
                         Description: "Specialty Board Certificate"
                     });
                     if (Docs[i].SpecialtyBoardCertifiedDetail.SpecialtyBoardCertifiedDetailHistory != null) {
                         for (var j = 0; j < Docs[i].SpecialtyBoardCertifiedDetail.SpecialtyBoardCertifiedDetailHistory.length; j++) {
                             $scope.LicenseTypes[14].LicenseHistories.push({
                                 LicenseID: Docs[i].SpecialtyBoardCertifiedDetail.SpecialtyBoardCertifiedDetailHistory[j].SpecialtyBoardCertifiedDetailHistoryID,
                                 LicenseName: "Board" + (j + 1),
                                 LicenseDocPath: Docs[i].SpecialtyBoardCertifiedDetail.SpecialtyBoardCertifiedDetailHistory[j].BoardCertificatePath,
                                 removeDate: Docs[i].SpecialtyBoardCertifiedDetail.SpecialtyBoardCertifiedDetailHistory[j].LastModifiedDate
                             });
                         }
                     }
                 }
         ...
         $scope.FormatHospitalPrivilegeDetailDoc = function (Docs) {
             ...
             for (var i = 0; i < Docs.length; i++) {
                 if (Docs[i].HospitalPrevilegeLetterPath != null && Docs[i].Status != "Inactive") {
                     $scope.LicenseTypes[15].Licenses.push({
                         LicenseID: Docs[i].HospitalPrivilegeDetailID,
                         LicenseName: "HPL" + (count),
                         LicenseDocPath: Docs[i].HospitalPrevilegeLetterPath,
                         ModifiedDate: Docs[i].LastModifiedDate,
                         Description: "Hospital Privilege Document"
                     });
                     if (Docs[i].HospitalPrivilegeDetailHistory != null) {
                         for (var j = 0; j < Docs[i].HospitalPrivilegeDetailHistory.length; j++) {
                             $scope.LicenseTypes[15].LicenseHistories.push({
                                 LicenseID: Docs[i].HospitalPrivilegeDetailHistory[j].HospitalPrivilegeDetailHistoryID,
                                 LicenseName: "HPL" + (j + 1),
                                 LicenseDocPath: Docs[i].HospitalPrivilegeDetailHistory[j].HospitalPrevilegeLetterPath,
                                 removeDate: Docs[i].HospitalPrivilegeDetailHistory[j].LastModifiedDate
                             });
                         }
                     }
                     count++;
         ...
         $scope.FormatProfessionalLiabilityInfoDoc = function (Docs) {
             ...
             for (var i = 0; i < Docs.length; i++) {
                 if (Docs[i].InsuranceCertificatePath != null) {
                     $scope.LicenseTypes[16].Licenses.push({
                         LicenseID: Docs[i].ProfessionalLiabilityInfoID,
                         LicenseName: "LIC" + (i + 1),
                         LicenseDocPath: Docs[i].InsuranceCertificatePath,
                         ModifiedDate: Docs[i].LastModifiedDate,
                         Description: "Professional Liability Document"
                     });
                     if (Docs[i].ProfessionalLiabilityInfoHistory != null) {
                         for (var j = 0; j < Docs[i].ProfessionalLiabilityInfoHistory.length; j++) {
                             $scope.LicenseTypes[16].LicenseHistories.push({
                                 LicenseID: Docs[i].ProfessionalLiabilityInfoHistory[j].ProfessionalLiabilityInfoHistoryID,
                                 LicenseName: "LIC" + (j + 1),
                                 LicenseDocPath: Docs[i].ProfessionalLiabilityInfoHistory[j].InsuranceCertificatePath,
                                 removeDate: Docs[i].ProfessionalLiabilityInfoHistory[j].LastModifiedDate
                             });
                         }
                     }
                 }
         ...
         $scope.FormatProfessionalWorkExperienceDoc = function (Docs) {
             ...
             for (var i = 0; i < Docs.length; i++) {
                 if (Docs[i].WorkExperienceDocPath != null) {
                     $scope.LicenseTypes[17].Licenses.push({
                         LicenseID: Docs[i].ProfessionalWorkExperienceID,
                         LicenseName: "Work Exp" + (i + 1),
                         LicenseDocPath: Docs[i].WorkExperienceDocPath,
                         ModifiedDate: Docs[i].LastModifiedDate,
                         Description: "Work Experience Document"
                     });
                     if (Docs[i].ProfessionalWorkExperienceHistory != null) {
                         $scope.LicenseTypes[17].LicenseHistories.push({
                             LicenseID: Docs[i].ProfessionalWorkExperienceHistory.ProfessionalWorkExperienceHistoryID,
                             LicenseName: "Work Exp" + (j + 1),
                             LicenseDocPath: Docs[i].ProfessionalWorkExperienceHistory.WorkExperienceDocPath,
                             removeDate: Docs[i].ProfessionalWorkExperienceHistory.LastModifiedDate
                         });
                     }
                 }
             }
         ...
         $scope.FormatContractInfoeDoc = function (Docs) {
             ...
             for (var i = 0; i < Docs.length; i++) {
                 if (Docs[i].ContractFilePath != null) {
                     $scope.LicenseTypes[18].Licenses.push({
                         LicenseID: Docs[i].ContractInfoID,
                         LicenseName: "Contract Document",
                         LicenseDocPath: Docs[i].ContractFilePath,
                         ModifiedDate: Docs[i].LastModifiedDate,
         ...
         $scope.FormatOtherDocument = function (Docs) {
             ...
             for (var i = 0; i < Docs.length; i++) {
                 if (Docs[i].DocumentPath != null) {
                     $scope.LicenseTypes[19].Licenses.push({
                         LicenseID: Docs[i].OtherDocumentID,
                         LicenseName: Docs[i].Title,
                         LicenseDocPath: Docs[i].DocumentPath,
                         ModifiedDate: Docs[i].LastModifiedDate,
                         Private: Docs[i].IsPrivate,
         ...
         $scope.FormatProfileVerificationInfo = function (Docs) {
                         ...
                         if (Docs[i].ProfileVerificationDetails[j].VerificationResult != null && Docs[i].ProfileVerificationDetails[j].ProfileVerificationParameter != null) {
                             if (Docs[i].ProfileVerificationDetails[j].VerificationResult.VerificationDocumentPath != null) {
                                 if (Docs[i].ProfileVerificationDetails[j].ProfileVerificationParameter.Code == "MOPT" || Docs[i].ProfileVerificationDetails[j].ProfileVerificationParameter.Code == "OIG") {
                                     $scope.SLicenses.push({
                                         LicenseID: Docs[i].ProfileVerificationDetails[j].ProfileVerificationDetailId,
                                         LicenseName: "PSV" + (scount),
                                         Title: Docs[i].ProfileVerificationDetails[j].ProfileVerificationParameter.Title,
                                         LicenseDocPath: Docs[i].ProfileVerificationDetails[j].VerificationResult.VerificationDocumentPath,
                                         VerificationDate: Docs[i].ProfileVerificationDetails[j].VerificationDate
                                     });
                                     scount++;
                                 } else {
                                     $scope.Licenses.push({
                                         LicenseID: Docs[i].ProfileVerificationDetails[j].ProfileVerificationDetailId,
                                         LicenseName: "PSV" + (count),
                                         Title: Docs[i].ProfileVerificationDetails[j].ProfileVerificationParameter.Title,
                                         LicenseDocPath: Docs[i].ProfileVerificationDetails[j].VerificationResult.VerificationDocumentPath,
                                         VerificationDate: Docs[i].ProfileVerificationDetails[j].VerificationDate
                                     });
             ...
             $scope.MPSVLicenses = {
                 LicenseTypeID: 21,
                 LicenseTypeName: "OIG/Medicare",
                 Licenses: $scope.SLicenses
             };
             $scope.PSVLicenses = {
                 LicenseTypeID: 22,
                 LicenseTypeName: "PSV Document",
                 Licenses: $scope.Licenses
             };
             //}
         }
         $scope.FormatCredentialLog = function (Docs) {
             $scope.Licenses = [];
             var count = 1;
             if (Docs.length > 0) {
                 for (var i = 0; i < Docs.length; i++) {
                     if (Docs != null) {
                         for (var j = 0; j < Docs.length; j++) {
                             if (Docs[j].CredentialingAppointmentDetail != null) {
                                 if (Docs[j].CredentialingAppointmentDetail.Status == "Active") {
                                     if (Docs[j].CredentialingAppointmentDetail != null) {
                                         if (Docs[j].CredentialingAppointmentDetail.FileUploadPath != null) {
                                             $scope.Licenses.push({
                                                 LicenseID: Docs[j].CredentialingAppointmentDetail.CredentialingAppointmentDetailID,
                                                 LicenseName: "CCM" + (count),
                                                 LicenseDocPath: Docs[j].CredentialingAppointmentDetail.FileUploadPath,
                                                 VerificationDate: Docs[j].CredentialingAppointmentDetail.LastModifiedDate
                                             });
                                             count++;
                                         }
                                     }
         ...
         $scope.ViewLicenseList = function (licenseType, condition) {
             if (licenseType.LicenseTypeName == $scope.SelectedLicenseType.LicenseTypeName) {
                 $scope.SelectedLicenseType = {};
                 $scope.SelectedLicense = {};
             } else {
         ...
         $scope.ViewLicense = function (license) {
             ...
             $scope.IsAddNewDocument = false;
             $scope.path = rootDir + "/Document/View?path=" + license.LicenseDocPath;
         ...
         $scope.EditDocument = function (licenseType, license) {
             ...
             $scope.isError = false;
             //if ($scope.TempObject.IsPrivate) {
             //    $scope.TempObject.IsPrivate = 1;
             //    angular.element('#Private').checked = true;
             //} else {
             //    $scope.TempObject.FilePath = 0;
             //}
         ...
         $scope.cancelDocumentPreview = function () {
             $scope.SelectedLicense = {};
             $scope.isError = false;
         }
         $scope.errormessage = false;
         ...
         $scope.saveOtherDocument = function (Form_Div_Id) {
             ...
             $scope.isError = false;
             if ($form.valid() && !$scope.errormessage) {
                 $.ajax({
                     ...
                     success: function (data) {
                         try {
                             if (data.status == "true") {
                                 if (data.otherDocument.DocumentPath != null) {
                                     $scope.IsAddNewDocument = false;
         ...
         $scope.check = function (title) {
             ...
             //                count = 1;
             //            }
             if (title != "" && $scope.TempObject.FilePath != "") {
                 status = true;
                 //            }
                 //        }
                 //        return status;
         ...
         $scope.UpdateDocumentArray = function (obj) {
             ...
             //    if ($scope.LicenseTypes[i].LicenseTypeID == 20) {
             $scope.LicenseTypes[19].Licenses.push({
                 LicenseID: obj.OtherDocumentID,
                 LicenseName: obj.Title,
                 LicenseDocPath: obj.DocumentPath,
                 ModifiedDate: $scope.ConvertDateFormat(obj.LastModifiedDate),
         ...
         $scope.updateOtherDocument = function (Form_Div_Id) {
             ...
             if ($form.valid() || status) {
                 $.ajax({
                     url: rootDir + '/Profile/DocumentRepository/UpdateOtherDocumentAsync?profileId=' + profileId,
                     type: 'POST',
                     data: new FormData($form[0]),
                     async: false,
                     cache: false,
         ...
         $scope.UpdateOldDocument = function (obj) {
             //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
             //    if ($scope.LicenseTypes[i].LicenseTypeID == 20) {
             for (var j = 0; j < $scope.LicenseTypes[19].Licenses.length; j++) {
                 if ($scope.LicenseTypes[19].Licenses[j].LicenseID == obj.OtherDocumentID) {
                     $scope.LicenseTypes[19].Licenses[j].LicenseName = obj.Title;
                     $scope.LicenseTypes[19].Licenses[j].LicenseDocPath = obj.DocumentPath;
         ...
         $scope.$on('UpdatePersonalIdentification', function (event, data) {
             var count01 = 0;
             var count02 = 0;
             if (data.personalIdentification != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 ...
                 if (count02 == 0) {
                     if (data.personalIdentification.SSNCertificatePath != null) {
                         $scope.LicenseTypes[2].Licenses.push({
                             LicenseID: data.personalIdentification.PersonalIdentificationID,
                             LicenseName: "SSN",
                             LicenseDocPath: data.personalIdentification.SSNCertificatePath,
                             ModifiedDate: $scope.ConvertDateFormat(data.personalIdentification.LastModifiedDate),
                             Description: "Social Security Number"
                         });
                     }
                     if (data.personalIdentification.DLCertificatePath != null) {
                         $scope.LicenseTypes[2].Licenses.push({
                             LicenseID: data.personalIdentification.PersonalIdentificationID,
                             LicenseName: "DL",
                             LicenseDocPath: data.personalIdentification.DLCertificatePath,
                             ModifiedDate: $scope.ConvertDateFormat(data.personalIdentification.LastModifiedDate),
                             Description: "Driver License"
                         });
                     }
         ...
         $scope.$on('UpdateStateLicenses', function (event, data) {
             var count01 = 0;
             var count02 = 0;
             if (data.stateLicense != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 ...
                 if (count02 == 0) {
                     if (data.stateLicense.StateLicenseDocumentPath != null) {
                         $scope.LicenseTypes[0].Licenses.push({
                             LicenseID: data.stateLicense.StateLicenseInformationID,
                             LicenseName: "ML" + ($scope.LicenseTypes[0].Licenses.length + 1),
                             LicenseDocPath: data.stateLicense.StateLicenseDocumentPath,
                             ModifiedDate: $scope.ConvertDateFormat(data.stateLicense.LastModifiedDate),
                             Description: "State License"
                         });
                     }
                 }
         ...
         $scope.$on('UpdateOtherLegalNames', function (event, data) {
             var count01 = 0;
             var count02 = 0;
             if (data.otherLegalName != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 ...
                 if (count02 == 0) {
                     if (data.otherLegalName.DocumentPath != null) {
                         $scope.LicenseTypes[1].Licenses.push({
                             LicenseID: data.otherLegalName.OtherLegalNameID,
                             LicenseName: "OLN" + ($scope.LicenseTypes[1].Licenses.length + 1),
                             LicenseDocPath: data.otherLegalName.DocumentPath,
                             ModifiedDate: $scope.ConvertDateFormat(data.otherLegalName.LastModifiedDate),
                             Description: "Other Legal Name"
                         });
                     }
                 }
         ...
         $scope.$on('UpdateBirthInformation', function (event, data) {
             var count01 = 0;
             var count02 = 0;
             if (data.birthInformation != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 ...
                 if (count02 == 0) {
                     if (data.birthInformation.BirthCertificatePath != null) {
                         $scope.LicenseTypes[3].Licenses.push({
                             LicenseID: data.birthInformation.BirthInformationID,
                             LicenseName: "Birth Certificate",
                             LicenseDocPath: data.birthInformation.BirthCertificatePath,
                             ModifiedDate: $scope.ConvertDateFormat(data.birthInformation.LastModifiedDate),
                             Description: "Birth Certificate"
                         });
                     }
                 }
         ...
         $scope.$on('UpdateVisaInfo', function (event, data) {
             var count01 = 0;
             var count02 = 0;
             if (data.visaDetail != null && data.visaDetail.VisaInfo != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 ...
                 for (var j = 0; j < $scope.LicenseTypes[5].Licenses.length; j++) {
                     if ($scope.LicenseTypes[5].Licenses[j].LicenseID == data.visaDetail.VisaInfo.VisaInfoID) {
                         ...
                         } else if ($scope.LicenseTypes[5].Licenses[j].LicenseName == "National Identification") {
                 ...
                 if (count02 == 0) {
                     if (data.visaDetail.VisaInfo != null) {
                         if (data.visaDetail.VisaInfo.VisaCertificatePath != null) {
                             $scope.LicenseTypes[5].Licenses.push({
                                 LicenseID: data.visaDetail.VisaInfo.VisaInfoID,
                                 LicenseName: "VISA",
                                 LicenseDocPath: data.visaDetail.VisaInfo.VisaCertificatePath,
                                 ModifiedDate: $scope.ConvertDateFormat(data.visaDetail.VisaInfo.LastModifiedDate),
                                 Description: "Visa"
                             });
                         }
                         if (data.visaDetail.VisaInfo.GreenCardCertificatePath != null) {
                             $scope.LicenseTypes[5].Licenses.push({
                                 LicenseID: data.visaDetail.VisaInfo.VisaInfoID,
                                 LicenseName: "GreenCard",
                                 LicenseDocPath: data.visaDetail.VisaInfo.GreenCardCertificatePath,
                                 ModifiedDate: $scope.ConvertDateFormat(data.visaDetail.VisaInfo.LastModifiedDate),
                                 Description: "Green Card"
                             });
                         }
                         if (data.visaDetail.VisaInfo.NationalIDCertificatePath != null) {
                             $scope.LicenseTypes[5].Licenses.push({
                                 LicenseID: data.visaDetail.VisaInfo.VisaInfoID,
                                 LicenseName: "National Identification",
                                 LicenseDocPath: data.visaDetail.VisaInfo.NationalIDCertificatePath,
                                 ModifiedDate: $scope.ConvertDateFormat(data.visaDetail.VisaInfo.LastModifiedDate),
                                 Description: "National Identification Certificate"
                             });
                         }
         ...
         $scope.$on('UpdateFederalDEAInformation', function (event, data) {
             var count01 = 0;
             var count02 = 0;
             if (data.federalDea != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 ...
                 if (count02 == 0) {
                     if (data.federalDea.DEALicenceCertPath != null) {
                         $scope.LicenseTypes[6].Licenses.push({
                             LicenseID: data.federalDea.FederalDEAInformationID,
                             LicenseName: "DEA" + ($scope.LicenseTypes[6].Licenses.length + 1),
                             LicenseDocPath: data.federalDea.DEALicenceCertPath,
                             ModifiedDate: $scope.ConvertDateFormat(data.federalDea.LastModifiedDate),
                             Description: "Drug Enforcement Administration"
                         });
                     }
                 }
         ...
         $scope.$on('UpdateMedicareInformation', function (event, data) {
             var count01 = 0;
             var count02 = 0;
             if (data.MedicareInformation != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 ...
                 if (count02 == 0) {
                     if (data.MedicareInformation.CertificatePath != null) {
                         $scope.LicenseTypes[7].Licenses.push({
                             LicenseID: data.MedicareInformation.MedicareInformationID,
                             LicenseName: "Medicare" + ($scope.LicenseTypes[7].Licenses.length + 1),
                             LicenseDocPath: data.MedicareInformation.CertificatePath,
                             ModifiedDate: $scope.ConvertDateFormat(data.MedicareInformation.LastModifiedDate),
                             Description: "Medicare"
                         });
                     }
                 }
         ...
         $scope.$on('UpdateMedicaidInformation', function (event, data) {
             var count01 = 0;
             var count02 = 0;
             if (data.MedicaidInformation != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 ...
                 if (count02 == 0) {
                     if (data.MedicaidInformation.CertificatePath != null) {
                         $scope.LicenseTypes[8].Licenses.push({
                             LicenseID: data.MedicaidInformation.MedicaidInformationID,
                             LicenseName: "Medicaid" + ($scope.LicenseTypes[8].Licenses.length + 1),
                             LicenseDocPath: data.MedicaidInformation.CertificatePath,
                             ModifiedDate: $scope.ConvertDateFormat(data.MedicaidInformation.LastModifiedDate),
                             Description: "Medicaid"
                         });
                     }
                 }
         ...
         $scope.$on('UpdateCDSCInformation', function (event, data) {
             var count01 = 0;
             var count02 = 0;
             if (data.CDSCInformation != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 ...
                 if (count02 == 0) {
                     if (data.CDSCInformation.CDSCCerificatePath != null) {
                         $scope.LicenseTypes[9].Licenses.push({
                             LicenseID: data.CDSCInformation.CDSCInformationID,
                             LicenseName: "CDS" + ($scope.LicenseTypes[9].Licenses.length + 1),
                             LicenseDocPath: data.CDSCInformation.CDSCCerificatePath,
                             ModifiedDate: $scope.ConvertDateFormat(data.CDSCInformation.LastModifiedDate),
                             Description: "Central Drug Standard Control"
                         });
                     }
                 }
         ...
         $scope.$on('UpdateEducationDetailDoc', function (event, data) {
             var count01 = 0;
             var count02 = 0;
             if (data.educationDetails != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 ...
                 if (count02 == 0) {
                     if (data.educationDetails.CertificatePath != null) {
                         if (data.educationDetails.QualificationType == "UnderGraduate") {
                             $scope.LicenseTypes[10].Licenses.push({
                                 LicenseID: data.educationDetails.EducationDetailID,
                                 LicenseName: "UG" + ($scope.countUG + 1),
                                 LicenseDocPath: data.educationDetails.CertificatePath,
                                 ModifiedDate: $scope.ConvertDateFormat(data.educationDetails.LastModifiedDate),
                                 Description: "Under Graduate"
                             });
                             $scope.countUG++;
         ...
         $scope.$on('UpdateECFMGDetailDoc', function (event, data) {
             var count01 = 0;
             var count02 = 0;
             if (data.ecfmgDetails != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 ...
                 if (count02 == 0) {
                     if (data.ecfmgDetails.ECFMGCertPath != null) {
                         $scope.LicenseTypes[11].Licenses.push({
                             LicenseID: data.ecfmgDetails.ECFMGDetailID,
                             LicenseName: "ECFMG",
                             LicenseDocPath: data.ecfmgDetails.ECFMGCertPath,
                             ModifiedDate: $scope.ConvertDateFormat(data.ecfmgDetails.LastModifiedDate),
                             Description: "Education Commission for Foreign Medical Graduates"
                         });
                     }
                 }
         ...
         $scope.$on('UpdateProgramDetailsDoc', function (event, data) {
             var count01 = 0;
             var count02 = 0;
             if (data.programDetails != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 ...
                 if (count02 == 0) {
                     if (data.programDetails.DocumentPath != null) {
                         if (data.programDetails.ProgramType == "Internship") {
                             $scope.LicenseTypes[12].Licenses.push({
                                 LicenseID: data.programDetails.ProgramDetailID,
                                 LicenseName: "Intern" + ($scope.countIntern + 1),
                                 LicenseDocPath: data.programDetails.DocumentPath,
                                 ModifiedDate: $scope.ConvertDateFormat(data.programDetails.LastModifiedDate),
                                 Description: "Internship"
                             });
                             $scope.countIntern++;
         ...
         $scope.$on('UpdateCMECertificationsDoc', function (event, data) {
             var count01 = 0;
             var count02 = 0;
             if (data.CMEDetails != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 ...
                 if (count02 == 0) {
                     if (data.CMEDetails.CertificatePath != null) {
                         $scope.LicenseTypes[13].Licenses.push({
                             LicenseID: data.CMEDetails.CMECertificationID,
                             LicenseName: "CME" + ($scope.LicenseTypes[13].Licenses.length + 1),
                             LicenseDocPath: data.CMEDetails.CertificatePath,
                             ModifiedDate: $scope.ConvertDateFormat(data.CMEDetails.LastModifiedDate),
                             Description: "Continuing Medical Education"
                         });
                     }
                 }
         ...
         $scope.$on('UpdateSpecialtyBoardCertifiedDetailDoc', function (event, data) {
             var count01 = 0;
             var count02 = 0;
             if (data.specialty != null && data.specialty.SpecialtyBoardCertifiedDetail != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 //    if ($scope.LicenseTypes[i].LicenseTypeID == 15) {
                 for (var j = 0; j < $scope.LicenseTypes[14].Licenses.length; j++) {
                     if ($scope.LicenseTypes[14].Licenses[j].LicenseID == data.specialty.SpecialtyBoardCertifiedDetail.SpecialtyBoardCertifiedDetailID) {
                 ...
                 if (count02 == 0) {
                     if (data.specialty.SpecialtyBoardCertifiedDetail.BoardCertificatePath != null) {
                         $scope.LicenseTypes[14].Licenses.push({
                             LicenseID: data.specialty.SpecialtyBoardCertifiedDetail.SpecialtyBoardCertifiedDetailID,
                             LicenseName: "Board" + ($scope.LicenseTypes[14].Licenses.length + 1),
                             LicenseDocPath: data.specialty.SpecialtyBoardCertifiedDetail.BoardCertificatePath,
                             ModifiedDate: $scope.ConvertDateFormat(data.specialty.SpecialtyBoardCertifiedDetail.LastModifiedDate),
                             Description: "Specialty Board Certificate"
                         });
                     }
                 }
         ...
         $scope.$on('UpdateHospitalPrivilegeDetailDoc', function (event, data) {
             var count01 = 0;
             var count02 = 0;
             if (data.hospitalPrivilegeDetail != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 ...
                 if (count02 == 0) {
                     if (data.hospitalPrivilegeDetail.HospitalPrevilegeLetterPath != null) {
                         $scope.LicenseTypes[15].Licenses.push({
                             LicenseID: data.hospitalPrivilegeDetail.HospitalPrivilegeDetailID,
                             LicenseName: "HPL" + ($scope.LicenseTypes[15].Licenses.length + 1),
                             LicenseDocPath: data.hospitalPrivilegeDetail.HospitalPrevilegeLetterPath,
                             ModifiedDate: $scope.ConvertDateFormat(data.hospitalPrivilegeDetail.LastModifiedDate),
                             Description: "Hospital Privilege Document"
                         });
                     }
                 }
         ...
         $scope.$on('UpdateProfessionalLiabilityInfoDoc', function (event, data) {
             var count01 = 0;
             var count02 = 0;
             if (data.professionalLiability != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 ...
                 if (count02 == 0) {
                     if (data.professionalLiability.InsuranceCertificatePath != null) {
                         $scope.LicenseTypes[16].Licenses.push({
                             LicenseID: data.professionalLiability.ProfessionalLiabilityInfoID,
                             LicenseName: "LIC" + ($scope.LicenseTypes[16].Licenses.length + 1),
                             LicenseDocPath: data.professionalLiability.InsuranceCertificatePath,
                             ModifiedDate: $scope.ConvertDateFormat(data.professionalLiability.LastModifiedDate),
                             Description: "Professional Liability Document"
                         });
                     }
                 }
         ...
         $scope.$on('UpdateProfessionalWorkExperienceDoc', function (event, data) {
             var count01 = 0;
             var count02 = 0;
             if (data.professionalWorkExperience != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 ...
                 if (count02 == 0) {
                     if (data.professionalWorkExperience.WorkExperienceDocPath != null) {
                         $scope.LicenseTypes[17].Licenses.push({
                             LicenseID: data.professionalWorkExperience.ProfessionalWorkExperienceID,
                             LicenseName: "Work Exp" + ($scope.LicenseTypes[17].Licenses.length + 1),
                             LicenseDocPath: data.professionalWorkExperience.WorkExperienceDocPath,
                             ModifiedDate: $scope.ConvertDateFormat(data.professionalWorkExperience.LastModifiedDate),
                             Description: "Work Experience Document"
                         });
                     }
                 }
         ...
         $scope.$on('UpdateContractInfoeDoc', function (event, data) {
             var count01 = 0;
             var count02 = 0;
             if (data.contractInformation != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 ...
                 if (count02 == 0) {
                     if (data.contractInformation.ContractFilePath != null) {
                         $scope.LicenseTypes[18].Licenses.push({
                             LicenseID: data.contractInformation.ContractInfoID,
                             LicenseName: "Contract Document",
                             LicenseDocPath: data.contractInformation.ContractFilePath,
                             ModifiedDate: $scope.ConvertDateFormat(data.contractInformation.LastModifiedDate),
                             Description: "Contract Document"
                         });
                     }
                 }
         ...
         $scope.$on('RemoveStateLicenses', function (event, data) {
             ...
             if (data.stateLicense != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 ...
                 for (var j = 0; j < $scope.LicenseTypes[0].Licenses.length; j++) {
                     ...
                     if (count == 1 && j < $scope.LicenseTypes[0].Licenses.length) {
         ...
         $scope.$on('RemoveOtherLegalNames', function (event, data) {
             ...
             if (data.otherLegalName != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 ...
                 for (var j = 0; j < $scope.LicenseTypes[1].Licenses.length; j++) {
                     ...
                     if (count == 1 && j < $scope.LicenseTypes[1].Licenses.length) {
         ...
         $scope.$on('RemoveFederalDEAInformation', function (event, data) {
             ...
             if (data.federalDea != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 ...
                 for (var j = 0; j < $scope.LicenseTypes[6].Licenses.length; j++) {
                     ...
                     if (count == 1 && j < $scope.LicenseTypes[6].Licenses.length) {
         ...
         $scope.$on('RemoveMedicareInformation', function (event, data) {
             var count = 0;
             if (data.MedicareInfo != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 //    if ($scope.LicenseTypes[i].LicenseTypeID == 8) {
                 for (var j = 0; j < $scope.LicenseTypes[7].Licenses.length; j++) {
                     ...
                     if (count == 1 && j < $scope.LicenseTypes[7].Licenses.length) {
         ...
         $scope.$on('RemoveMedicaidInformation', function (event, data) {
             var count = 0;
             if (data.MedicaidInfo != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 //    if ($scope.LicenseTypes[i].LicenseTypeID == 9) {
                 for (var j = 0; j < $scope.LicenseTypes[8].Licenses.length; j++) {
                     ...
                     if (count == 1 && j < $scope.LicenseTypes[8].Licenses.length) {
         ...
         $scope.$on('RemoveCDSCInformation', function (event, data) {
             ...
             if (data.cDSCInformation != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 ...
                 for (var j = 0; j < $scope.LicenseTypes[9].Licenses.length; j++) {
                     ...
                     if (count == 1 && j < $scope.LicenseTypes[9].Licenses.length) {
         ...
         $scope.$on('RemoveEducationDetailDoc', function (event, data) {
             var num = 0;
             if (data.educationDetailViewModel != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 //    if ($scope.LicenseTypes[i].LicenseTypeID == 11) {
                 for (var j = 0; j < $scope.LicenseTypes[10].Licenses.length; j++) {
                     //if (licenseName[0] == "u") {
                     ...
                     if ($scope.LicenseTypes[10].Licenses[j].LicenseID == data.educationDetailViewModel.EducationDetailID) {
                         ...
                         //    $scope.LicenseTypes.splice($scope.LicenseTypes.indexOf($scope.LicenseTypes[i]), 1);
                         //} else {
                         if ($scope.LicenseTypes[10].Licenses[j].LicenseName[0] == "U") {
                             $scope.countUG--;
                             $scope.isUG = true;
                         } else if ($scope.LicenseTypes[10].Licenses[j].LicenseName[0] == "G") {
                             $scope.countG--;
                             $scope.isG = true;
                         }
                     ...
                     if ($scope.isUG && j < $scope.LicenseTypes[10].Licenses.length) {
                         if ($scope.LicenseTypes[10].Licenses[j].LicenseName[0] == "U") {
                             num = $scope.LicenseTypes[10].Licenses[j].LicenseName[$scope.LicenseTypes[10].Licenses[j].LicenseName.length - 1] - 1;
                             $scope.LicenseTypes[10].Licenses[j].LicenseName = "UG" + num;
                         }
                     } else if ($scope.isG && j < $scope.LicenseTypes[10].Licenses.length) {
                         if ($scope.LicenseTypes[10].Licenses[j].LicenseName[0] == "G") {
                             num = $scope.LicenseTypes[10].Licenses[j].LicenseName[$scope.LicenseTypes[10].Licenses[j].LicenseName.length - 1] - 1;
                             $scope.LicenseTypes[10].Licenses[j].LicenseName = "Grad" + num;
                         }
                     }
                 }
                 //    }
         ...
         $scope.isTntern = false;
         $scope.isFell = false;
         $scope.isRes = false;
         $scope.isOther = false;
         $scope.$on('RemoveProgramDetailsDoc', function (event, data) {
             if (data.residencyInternshipViewModel != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 //    if ($scope.LicenseTypes[i].LicenseTypeID == 13) {
                 for (var j = 0; j < $scope.LicenseTypes[12].Licenses.length; j++) {
                     if ($scope.LicenseTypes[12].Licenses[j].LicenseID == data.residencyInternshipViewModel.ProgramDetailID) {
                         ...
                         //    $scope.LicenseTypes.splice($scope.LicenseTypes.indexOf($scope.LicenseTypes[i]), 1);
                         //} else {
                         //for (var k = 0; k < $scope.countIntern; k++) {
                         //    intern = "Intern" + (k + 1);
                         if ($scope.LicenseTypes[12].Licenses[j].LicenseName[0] == "I") {
                             $scope.countIntern--;
                             $scope.isTntern = true;
                         }
                         //}
                         //for (var k = 0; k < $scope.countFell; k++) {
                         //    fell = "Fell" + (k + 1);
                         if ($scope.LicenseTypes[12].Licenses[j].LicenseName[0] == "F") {
                             $scope.countFell--;
                             $scope.isFell = true;
                         }
                         //}
                         //for (var k = 0; k < $scope.countRes; k++) {
                         //    res = "Res" + (k + 1);
                         if ($scope.LicenseTypes[12].Licenses[j].LicenseName[0] == "R") {
                             $scope.countRes--;
                             $scope.isRes = true;
                         }
                         //}
                         //for (var k = 0; k < $scope.countOther; k++) {
                         //    other = "Other" + (k + 1);
                         if ($scope.LicenseTypes[12].Licenses[j].LicenseName[0] == "O") {
                             $scope.countOther--;
                             $scope.isOther = true;
                         }
                         //}
                     ...
                     if ($scope.isTntern && j < $scope.LicenseTypes[12].Licenses.length) {
                         if ($scope.LicenseTypes[12].Licenses[j].LicenseName[12] == "I") {
                             num = $scope.LicenseTypes[12].Licenses[j].LicenseName[$scope.LicenseTypes[12].Licenses[j].LicenseName.length - 1] - 1;
                             $scope.LicenseTypes[12].Licenses[j].LicenseName = "Intern" + num;
                         }
                     } else if ($scope.countFell && j < $scope.LicenseTypes[12].Licenses.length) {
                         if ($scope.LicenseTypes[12].Licenses[j].LicenseName == "F") {
                             num = $scope.LicenseTypes[12].Licenses[j].LicenseName[$scope.LicenseTypes[12].Licenses[j].LicenseName.length - 1] - 1;
                             $scope.LicenseTypes[12].Licenses[j].LicenseName = "Fell" + num;
                         }
                     } else if ($scope.isRes && j < $scope.LicenseTypes[12].Licenses.length) {
                         if ($scope.LicenseTypes[12].Licenses[j].LicenseName == "R") {
                             num = $scope.LicenseTypes[12].Licenses[j].LicenseName[$scope.LicenseTypes[12].Licenses[j].LicenseName.length - 1] - 1;
                             $scope.LicenseTypes[12].Licenses[j].LicenseName = "Res" + num;
                         }
                     } else if ($scope.isOther && j < $scope.LicenseTypes[12].Licenses.length) {
                         if ($scope.LicenseTypes[12].Licenses[j].LicenseName == "O") {
                             num = $scope.LicenseTypes[10].Licenses[j].LicenseName[$scope.LicenseTypes[12].Licenses[j].LicenseName.length - 1] - 1;
                             $scope.LicenseTypes[12].Licenses[j].LicenseName = "Other" + num;
                         }
                     }
                 }
                 //    }
         ...
         $scope.$on('RemoveCMECertificationsDoc', function (event, data) {
             var count = 0;
             if (data.certificationCMEViewModel != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 //    if ($scope.LicenseTypes[i].LicenseTypeID == 14) {
                 for (var j = 0; j < $scope.LicenseTypes[13].Licenses.length; j++) {
                     ...
                     if (count == 1 && j < $scope.LicenseTypes[13].Licenses.length) {
         ...
         $scope.$on('RemoveSpecialtyBoardCertifiedDetailDoc', function (event, data) {
             var count = 0;
             if (data.specialty != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 //    if ($scope.LicenseTypes[i].LicenseTypeID == 15) {
                 for (var j = 0; j < $scope.LicenseTypes[14].Licenses.length; j++) {
                     ...
                     if (count == 1 && j < $scope.LicenseTypes[14].Licenses.length) {
         ...
         $scope.$on('RemoveHospitalPrivilegeDetailDoc', function (event, data) {
             var count = 0;
             if (data.hospitalPrivilege != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 //for (var i = 0; i < $scope.LicenseTypes.length; i++) {
                 //    if ($scope.LicenseTypes[i].LicenseTypeID == 16) {
                 for (var j = 0; j < $scope.LicenseTypes[15].Licenses.length; j++) {
                     ...
                     if (count == 1 && j < $scope.LicenseTypes[15].Licenses.length) {
         ...
         $scope.$on('RemoveProfessionalLiabilityInfoDoc', function (event, data) {
             ...
             if (data.professionalLiability != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 ...
                 for (var j = 0; j < $scope.LicenseTypes[16].Licenses.length; j++) {
                     ...
                     if (count == 1 && j < $scope.LicenseTypes[16].Licenses.length) {
         ...
         $scope.$on('RemoveProfessionalWorkExperienceDoc', function (event, data) {
             ...
             if (data.professionalWorkExperience != null && $scope.LicenseTypes != null && $scope.LicenseTypes.length != 0) {
                 ...
                 for (var j = 0; j < $scope.LicenseTypes[17].Licenses.length; j++) {
                     ...
                     if (count == 1 && j < $scope.LicenseTypes[17].Licenses.length) {
         ...
         $scope.formatData = function (data) {
             ...
             if (data.credentialLog != null) {
                 $scope.FormatCredentialLog(data.credentialLog);
             }
         }

         $scope.createLicenseArray();
         $scope.formatData(angular.copy($rootScope.MasterProfile.DocumentRepository));
         $scope.SelectedLicense = {};
         
         //$rootScope.$broadcast("DocumentRepository");
     }
    ]);
});