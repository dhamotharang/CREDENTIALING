...
define(['Util/MasterProfileApp'], function (app) {
    'use strict';
    app.register.controller('ProfileDashboardController', ['$scope', '$rootScope', '$http', 'httpq', 'masterDataService', 'messageAlertEngine', '$filter', 'ProviderLicenseService',
      function ($scope, $rootScope, $http, httpq, masterDataService, messageAlertEngine, $filter, ProviderLicenseService) {
