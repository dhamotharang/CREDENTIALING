...
define(['Util/MasterProfileApp'], function (app) {
    'use strict';
    app.register.controller('DocumentationCheckListController', ['$scope', '$http', 'httpq', '$rootScope', '$timeout', 'ProfileSubData',
        function ($scope, $http, httpq, $rootScope, $timeout, ProfileSubData) {
            ...
            $(function () {
                ...
                $scope.sections = [{
                    ...
                    docs: [{
                        ...
                        title: "Florida Home Address",
                        value: false
                    }, {
                        title: "Social Security Card",
                        value: true
                    }, {
                        title: "Visa or Passport",
                        value: true
                    }],
                    length: 5
                }, {
                    ...
                    docs: [{
                        title: "ACLS/BLS/CPR PALS(Must be current)",
                        value: false
                    }, {
                        title: "Board Certificate",
                        value: true
                    }, {
                        title: "CDS Certificate",
                        value: true
                    }, {
                        title: "DEA Certificate",
                        value: true
                    }, {
                        title: "State Medical License(Florida and any additional states)",
                        value: true
                    }],
                    length: 6
                }, {
                    ...
                    docs: [{
                        title: "CME Certificates(Last 24 Months)",
                        value: true
                    }, {
                        title: "ECFMG",
                        value: true
                    }, {
                        title: "Fellowship(ALL)",
                        value: true
                    }, {
                        title: "Graduate Medical School",
                        value: true
                    }, {
                        title: "Internship(ALL)",
                        value: true
                    }, {
                        title: "Residency(ALL)",
                        value: true
                    }, {
                        title: "Undergraduate(BS,MS,AS,AA)",
                        value: true
                    }],
                    length: 8
                }, {
                    name: 'Work History',
                    docs: [{
                        title: "CV Must include current employer(Access Health Care Physicians LLC) all entries must include MM/YYYY-MM/YYYY Start/End",
                        value: true
                    }, {
                        title: "Work Gap Explanation must include explanation of any gap in employment for a period of 3 months.Must contain MM/YYYY-MM/YYYY Start and End dates",
                        value: true
                    }],
                    length: 3
                }, {
                    ...
                    docs: [{
                        title: "Hospital Privilege Letters for all current facilities",
                        value: true
                    }, {
                        title: "Last Flu Shot(Last 12 months)",
                        value: false
                    }, {
                        title: "PPD Results(Last 12 months)",
                        value: false
                    }],
                    length: 4
                }, ];
                $scope.mydata = angular.copy(ProfileSubData.Result);
