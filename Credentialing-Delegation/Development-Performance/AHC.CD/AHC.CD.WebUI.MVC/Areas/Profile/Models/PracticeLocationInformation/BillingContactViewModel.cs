    ...
    public class BillingContactViewModel
    {
      ...
      //  [RegularExpression(RegularExpression.FOR_ALPHABETS_SPACE_COMMA_HYPHEN, ErrorMessage = ValidationErrorMessage.CHARACTERS_ONLY_ALPHABETS_SPACE_COMMA_HYPHEN)]
       ...
       // [Required]
        ...
        [RegularExpression(RegularExpression.FOR_NUMBERS_SPACES_HYPHEN_FRWD_SLASH, ErrorMessage = "Please enter only numbers in Telephone number. ")]
        ...
        [Display(Name = "FAX")]
        [RegularExpression(RegularExpression.FOR_NUMBERS_SPACES_HYPHEN_FRWD_SLASH, ErrorMessage = "Please enter only numbers in Fax number. ")]
