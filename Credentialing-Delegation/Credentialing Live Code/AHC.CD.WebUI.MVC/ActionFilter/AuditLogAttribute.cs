...
namespace AHC.CD.WebUI.MVC.ActionFilter
{
    ...
    {   
        public override void OnActionExecuted(ActionExecutedContext filterContext)
        {
            ...
            auditMessage.QueryString=filterContext.HttpContext.Request.QueryString.ToString();
            auditMessage.URL = filterContext.HttpContext.Request.RawUrl;
            auditMessage.Category="Information";
