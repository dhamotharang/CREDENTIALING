...
namespace AHC.CD.Business.Profiles
{
    public interface IPracticeLocationManager
    {
        ...
        Task RemovePracticeLocationAsync(int profileId, PracticeLocationDetail practiceLocationDetail,string UserAuthID);
        ...
        Task RemovePracticeProviderAsync(int practiceLocationDetailID, PracticeProvider practiceProvider);
        ...
        Task<Facility> GetPracticeLocationFacilityByID(int locationID);
    }
}
