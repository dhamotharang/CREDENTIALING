...
function ($scope, $rootScope, $http, $filter, masterDataService, locationService, messageAlertEngine, profileUpdates, $timeout) {
    ...
    $rootScope.printData = function (id,title) {
        ...
        mywindow.document.write('<style>.ng-hide:not(.ng-hide-animate) {display: none !important;} @page{size: auto;margin-bottom: 5mm;}@media print {thead {display: table-header-group;}}</style>');
        mywindow.document.write('<style>th{text-align: center; background-color:"Blue";}</style>');
