    ...
    internal class MasterDataDBInitializer
    {
        public async Task Seed()
        {
            try
            {
                ...
                // Read the CSV file
                StreamReader reader = new StreamReader(@"D:\Cred Axis\Credentialing-Delegation\Development\AHC.CD\AHC.CD.WebUI.MVC\App_Data\MasterData\HospitalContactInfoMaster.csv");
